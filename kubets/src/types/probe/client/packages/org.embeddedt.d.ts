...
import { $ChunkGeneratorStructureState } from "packages/net/minecraft/world/level/chunk/$ChunkGeneratorStructureState"
...
import { $MeshAppender$Context } from "packages/org/embeddedt/embeddium/api/$MeshAppender$Context"
...
import { $ModelBakery$BakedCacheKey$$Type } from "packages/net/minecraft/client/resources/model/$ModelBakery$BakedCacheKey"
import { $Map$$Type } from "packages/java/util/$Map"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $CTMModelBakeryAccessor$$Type = ($CTMModelBakeryAccessor | (() => $Map$$Type<$ModelBakery$BakedCacheKey$$Type, $BakedModel$$Type>));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $CTMModelBakeryAccessor_ = $CTMModelBakeryAccessor$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SectionInfoBuilder_ = $SectionInfoBuilder$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $EventHandlerRegistrar$$Type<T extends $EmbeddiumEvent> = ($EventHandlerRegistrar<T>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $EventHandlerRegistrar_<T extends $EmbeddiumEvent> = $EventHandlerRegistrar$$Type<T>;
}
}
...
import { $SafeBlockGetter$$Type } from "packages/org/embeddedt/modernfix/chunk/$SafeBlockGetter"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $ISafeBlockGetter$$Type = ($ISafeBlockGetter | (() => $SafeBlockGetter$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $EventHandlerRegistrar$Handler$$Type<T extends $EmbeddiumEvent> = ($EventHandlerRegistrar$Handler<T> | ((arg0: T) => void));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $EventHandlerRegistrar$Handler_<T extends $EmbeddiumEvent> = $EventHandlerRegistrar$Handler$$Type<T>;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $ModifyCloudRenderingEvent_ = $ModifyCloudRenderingEvent$$Type;
}
}

declare module "packages/org/embeddedt/modernfix/duck/$IServerLevel" {
import { $StrongholdLocationCache$$Type } from "packages/org/embeddedt/modernfix/world/$StrongholdLocationCache"
