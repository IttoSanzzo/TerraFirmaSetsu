...
export type $SimpleCraftingRecipeSerializer$$Type<T extends $CraftingRecipe> = ($SimpleCraftingRecipeSerializer<T>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SimpleCraftingRecipeSerializer_<T extends $CraftingRecipe> = $SimpleCraftingRecipeSerializer$$Type<T>;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SmithingTransformRecipe_ = $SmithingTransformRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $RepairItemRecipe_ = $RepairItemRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SmithingTrimRecipe$Serializer_ = $SmithingTrimRecipe$Serializer$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $DecoratedPotRecipe_ = $DecoratedPotRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $FireworkRocketRecipe_ = $FireworkRocketRecipe$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SimpleCraftingRecipeSerializer$Factory$$Type<T extends $CraftingRecipe> = ($SimpleCraftingRecipeSerializer$Factory<T> | ((arg0: $ResourceLocation, arg1: $CraftingBookCategory) => T));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SimpleCraftingRecipeSerializer$Factory_<T extends $CraftingRecipe> = $SimpleCraftingRecipeSerializer$Factory$$Type<T>;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $ShapedRecipe$Serializer_ = $ShapedRecipe$Serializer$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $ShulkerBoxColoring_ = $ShulkerBoxColoring$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $BlastingRecipe_ = $BlastingRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SuspiciousStewRecipe_ = $SuspiciousStewRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SmeltingRecipe_ = $SmeltingRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $ShapedRecipe_ = $ShapedRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $CustomRecipe_ = $CustomRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $BannerDuplicateRecipe_ = $BannerDuplicateRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SmithingRecipe_ = $SmithingRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SmokingRecipe_ = $SmokingRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SmithingTransformRecipe$Serializer_ = $SmithingTransformRecipe$Serializer$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $ArmorDyeRecipe_ = $ArmorDyeRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $TippedArrowRecipe_ = $TippedArrowRecipe$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SingleItemRecipe$Serializer$$Type<T extends $SingleItemRecipe> = ($SingleItemRecipe$Serializer<T>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SingleItemRecipe$Serializer_<T extends $SingleItemRecipe> = $SingleItemRecipe$Serializer$$Type<T>;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $Recipe$$Type<C extends $Container> = ($Recipe<C>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $Recipe_<C extends $Container> = $Recipe$$Type<C>;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $FireworkStarFadeRecipe_ = $FireworkStarFadeRecipe$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SimpleCookingSerializer$$Type<T extends $AbstractCookingRecipe> = ($SimpleCookingSerializer<T>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
declare module "packages/net/minecraft/world/item/crafting/$RecipeType" {
...
import { $SmeltingRecipe } from "packages/net/minecraft/world/item/crafting/$SmeltingRecipe"
import { $ResourceLocation$$Type } from "packages/net/minecraft/resources/$ResourceLocation"
import { $SmokingRecipe } from "packages/net/minecraft/world/item/crafting/$SmokingRecipe"
import { $Recipe, $Recipe$$Type } from "packages/net/minecraft/world/item/crafting/$Recipe"
import { $BlastingRecipe } from "packages/net/minecraft/world/item/crafting/$BlastingRecipe"

export interface $RecipeType<T extends $Recipe<any>> {
...
export abstract class $RecipeType$$Static<T extends $Recipe<any>> implements $RecipeType<T> {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $RecipeType$$Type<T extends $Recipe<any>> = ($RecipeType<T> | Special.RecipeType);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $RecipeType_<T extends $Recipe<any>> = $RecipeType$$Type<T>;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $ShieldDecorationRecipe_ = $ShieldDecorationRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $ShapelessRecipe_ = $ShapelessRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $MapCloningRecipe_ = $MapCloningRecipe$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $RecipeManager$CachedCheck$$Type<C extends $Container, T extends $Recipe<C>> = ($RecipeManager$CachedCheck<C, T> | ((arg0: C, arg1: $Level) => $Optional$$Type<T>));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $RecipeManager$CachedCheck_<C extends $Container, T extends $Recipe<C>> = $RecipeManager$CachedCheck$$Type<C, T>;
}
}

declare module "packages/net/minecraft/world/item/crafting/$RecipeSerializer" {
import { $JsonObject$$Type } from "packages/com/google/gson/$JsonObject"
import { $MapCloningRecipe } from "packages/net/minecraft/world/item/crafting/$MapCloningRecipe"
import { $SmithingTrimRecipe } from "packages/net/minecraft/world/item/crafting/$SmithingTrimRecipe"
import { $StonecutterRecipe } from "packages/net/minecraft/world/item/crafting/$StonecutterRecipe"
import { $MapExtendingRecipe } from "packages/net/minecraft/world/item/crafting/$MapExtendingRecipe"
import { $ShapelessRecipe } from "packages/net/minecraft/world/item/crafting/$ShapelessRecipe"
import { $IForgeRecipeSerializer } from "packages/net/minecraftforge/common/extensions/$IForgeRecipeSerializer"
import { $ResourceLocation$$Type } from "packages/net/minecraft/resources/$ResourceLocation"
import { $SmokingRecipe } from "packages/net/minecraft/world/item/crafting/$SmokingRecipe"
import { $Recipe, $Recipe$$Type } from "packages/net/minecraft/world/item/crafting/$Recipe"
import { $BlastingRecipe } from "packages/net/minecraft/world/item/crafting/$BlastingRecipe"
import { $SmeltingRecipe } from "packages/net/minecraft/world/item/crafting/$SmeltingRecipe"
import { $BannerDuplicateRecipe } from "packages/net/minecraft/world/item/crafting/$BannerDuplicateRecipe"
import { $DecoratedPotRecipe } from "packages/net/minecraft/world/item/crafting/$DecoratedPotRecipe"
import { $FireworkRocketRecipe } from "packages/net/minecraft/world/item/crafting/$FireworkRocketRecipe"
import { $SuspiciousStewRecipe } from "packages/net/minecraft/world/item/crafting/$SuspiciousStewRecipe"
import { $ShapedRecipe } from "packages/net/minecraft/world/item/crafting/$ShapedRecipe"
import { $FireworkStarRecipe } from "packages/net/minecraft/world/item/crafting/$FireworkStarRecipe"
import { $ICondition$IContext$$Type } from "packages/net/minecraftforge/common/crafting/conditions/$ICondition$IContext"
import { $TippedArrowRecipe } from "packages/net/minecraft/world/item/crafting/$TippedArrowRecipe"
import { $FireworkStarFadeRecipe } from "packages/net/minecraft/world/item/crafting/$FireworkStarFadeRecipe"
import { $SmithingTransformRecipe } from "packages/net/minecraft/world/item/crafting/$SmithingTransformRecipe"
import { $RepairItemRecipe } from "packages/net/minecraft/world/item/crafting/$RepairItemRecipe"
import { $ShieldDecorationRecipe } from "packages/net/minecraft/world/item/crafting/$ShieldDecorationRecipe"
import { $CampfireCookingRecipe } from "packages/net/minecraft/world/item/crafting/$CampfireCookingRecipe"
import { $ShulkerBoxColoring } from "packages/net/minecraft/world/item/crafting/$ShulkerBoxColoring"
import { $ArmorDyeRecipe } from "packages/net/minecraft/world/item/crafting/$ArmorDyeRecipe"
import { $BookCloningRecipe } from "packages/net/minecraft/world/item/crafting/$BookCloningRecipe"
import { $FriendlyByteBuf$$Type } from "packages/net/minecraft/network/$FriendlyByteBuf"

export interface $RecipeSerializer<T extends $Recipe<any>> extends $IForgeRecipeSerializer<T> {
...
export abstract class $RecipeSerializer$$Static<T extends $Recipe<any>> implements $RecipeSerializer<T> {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $RecipeSerializer$$Type<T extends $Recipe<any>> = ($RecipeSerializer<T> | Special.RecipeSerializer);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $AbstractCookingRecipe_ = $AbstractCookingRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $FireworkStarRecipe_ = $FireworkStarRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SingleItemRecipe_ = $SingleItemRecipe$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $CampfireCookingRecipe_ = $CampfireCookingRecipe$$Type;
}
}
...
import { $AbstractCookingRecipe, $AbstractCookingRecipe$$Type } from "packages/net/minecraft/world/item/crafting/$AbstractCookingRecipe"
import { $ResourceLocation } from "packages/net/minecraft/resources/$ResourceLocation"
import { $CookingBookCategory } from "packages/net/minecraft/world/item/crafting/$CookingBookCategory"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SimpleCookingSerializer$CookieBaker$$Type<T extends $AbstractCookingRecipe> = ($SimpleCookingSerializer$CookieBaker<T> | ((arg0: $ResourceLocation, arg1: string, arg2: $CookingBookCategory, arg3: $Ingredient, arg4: $ItemStack, arg5: float, arg6: integer) => T));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SimpleCookingSerializer$CookieBaker_<T extends $AbstractCookingRecipe> = $SimpleCookingSerializer$CookieBaker$$Type<T>;
}
}
