declare module "packages/net/minecraft/resources/$RegistryOps$RegistryInfoLookup" {
	...
	export type $RegistryOps$RegistryInfoLookup$$Type =
		| $RegistryOps$RegistryInfoLookup
		| ((
				arg0: $ResourceKey<$Registry<T>>
		  ) => $Optional$$Type<$RegistryOps$RegistryInfo$$Type<T>>);
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $RegistryOps$RegistryInfoLookup_ =
...
declare module "packages/net/minecraft/resources/$RegistryOps$RegistryInfo" {
	...
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $RegistryOps$RegistryInfo_<T> =
			$RegistryOps$RegistryInfo$$Type<T>;
	}
}
...
declare module "packages/net/minecraft/resources/$ResourceLocation" {
			...
			$SpecialEquality
	{
		...
		public static bySeparator(
			string0: string,
			char1: character
		): $ResourceLocation;
		public static checkSpecialEquality(
			o: any,
			o1: any,
			shallow: boolean
		): boolean;
		public compareNamespaced(
		...
		public static fromNamespaceAndPath(
			string0: string,
			string1: string
		): $ResourceLocation;
		...
		public withPath(
			unaryOperator0: $UnaryOperator$$Type<string>
		): $ResourceLocation;
	...
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $ResourceLocation$$Type =
		| $ResourceLocation
		| Special.CustomStat
		| string;
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
