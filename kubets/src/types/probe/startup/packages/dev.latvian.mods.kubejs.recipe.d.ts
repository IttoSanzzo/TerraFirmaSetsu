...
declare module "packages/dev/latvian/mods/kubejs/recipe/filter/$RecipeFilter" {
	...
	export type $RecipeFilter$$Type =
		...
		| $RecipeFilter$$Type[]
		| {
				or?: $RecipeFilter$$Type | OmniString;
				not?: $RecipeFilter$$Type | OmniString;
				id?: Special.RecipeId | OmniString;
				type?: Special.RecipeType | OmniString;
				group?: string;
				mod?: Special.Mod | OmniString;
				input?: $InputItem$$Type | OmniString;
				output?: $OutputItem$$Type | OmniString;
		  }
