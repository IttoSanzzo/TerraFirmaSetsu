...
import { $DispenseItemBehavior$$Type } from "packages/net/minecraft/core/dispenser/$DispenseItemBehavior"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $DispenserBlockAccessor$$Type = ($DispenserBlockAccessor | ((arg0: $ItemStack) => $DispenseItemBehavior$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
import { $EntityTickList$$Type } from "packages/net/minecraft/world/level/entity/$EntityTickList"
...
import { $TrackGraph } from "packages/com/simibubi/create/content/trains/graph/$TrackGraph"
import { $TrackEdge, $TrackEdge$$Type } from "packages/com/simibubi/create/content/trains/graph/$TrackEdge"
import { $Map$Entry, $Map$Entry$$Type } from "packages/java/util/$Map$Entry"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TravellingPoint$ITrackSelector$$Type = ($TravellingPoint$ITrackSelector | ((arg0: $TrackGraph, arg1: $Pair<boolean, $List<$Map$Entry<$TrackNode, $TrackEdge>>>) => $Map$Entry$$Type<$TrackNode$$Type, $TrackEdge$$Type>));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $PipeCollisionEvent$Spill_ = $PipeCollisionEvent$Spill$$Type;
}
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TravellingPoint$SteerDirection$$Type = ($TravellingPoint$SteerDirection | ("none" | "left" | "right"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SignalBlock$SignalType$$Type = ($SignalBlock$SignalType | ("entry_signal" | "cross_signal"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SimpleRegistry_<K, V> = $SimpleRegistry$$Type<K, V>;
}
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TrackShape$$Type = ($TrackShape | ("none" | "zo" | "xo" | "pd" | "nd" | "an" | "as" | "ae" | "aw" | "tn" | "ts" | "te" | "tw" | "cr_o" | "cr_d" | "cr_pdx" | "cr_pdz" | "cr_ndx" | "cr_ndz"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $BogeyStyle$SizeRenderer$$Type = ($BogeyStyle$SizeRenderer);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $BogeyStyle$SizeRenderer_ = $BogeyStyle$SizeRenderer$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $BehaviourType$$Type<T extends $BlockEntityBehaviour> = ($BehaviourType<T>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $BehaviourType_<T extends $BlockEntityBehaviour> = $BehaviourType$$Type<T>;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $ContraptionVisual$$Type<E extends $AbstractContraptionEntity> = ($ContraptionVisual<E>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $ContraptionVisual_<E extends $AbstractContraptionEntity> = $ContraptionVisual$$Type<E>;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $IBE$$Type<T extends $BlockEntity> = ($IBE<T>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $IBE_<T extends $BlockEntity> = $IBE$$Type<T>;
}
}
...
import { $TransportedItemStack } from "packages/com/simibubi/create/content/kinetics/belt/transport/$TransportedItemStack"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TransportedItemStackHandlerBehaviour$ProcessingCallback$$Type = ($TransportedItemStackHandlerBehaviour$ProcessingCallback | ((arg0: float, arg1: $Function<$TransportedItemStack, $TransportedItemStackHandlerBehaviour$TransportedResult>) => void));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
import { $ItemRequirement$$Type } from "packages/com/simibubi/create/content/schematics/requirement/$ItemRequirement"
import { $BlockState } from "packages/net/minecraft/world/level/block/state/$BlockState"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SpecialBlockEntityItemRequirement$$Type = ($SpecialBlockEntityItemRequirement | ((arg0: $BlockState) => $ItemRequirement$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SpecialBlockEntityItemRequirement_ = $SpecialBlockEntityItemRequirement$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TravellingPoint$ITurnListener$$Type = ($TravellingPoint$ITurnListener | ((arg0: double, arg1: $TrackEdge) => void));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $MountedItemStorage_ = $MountedItemStorage$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $MountedFluidStorageWrapper_ = $MountedFluidStorageWrapper$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $PipeCollisionEvent_ = $PipeCollisionEvent$$Type;
}
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SignalBlockEntity$OverlayState$$Type = ($SignalBlockEntity$OverlayState | ("render" | "skip" | "dual"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $PackagePortBlockEntity_ = $PackagePortBlockEntity$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $ConcretePowderBlockAccessor$$Type = ($ConcretePowderBlockAccessor | (() => $BlockState$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $BlockEntityConfigurationPacket$$Type<BE extends $SyncedBlockEntity> = ($BlockEntityConfigurationPacket<BE>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $BlockEntityConfigurationPacket_<BE extends $SyncedBlockEntity> = $BlockEntityConfigurationPacket$$Type<BE>;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $IMergeableBE$$Type = ($IMergeableBE | ((arg0: $BlockEntity) => void));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TravellingPoint$IEdgePointListener$$Type = ($TravellingPoint$IEdgePointListener | ((arg0: double, arg1: $Pair<$TrackEdgePoint, $Couple<$TrackNode>>) => boolean));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $MountedStorageSyncPacket$$Type = ($MountedStorageSyncPacket);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $MountedStorageSyncPacket_ = $MountedStorageSyncPacket$$Type;
}
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $NbtAccounterAccessor$$Type = ($NbtAccounterAccessor | (() => long));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TrainStatus$StatusMessage$$Type = ($TrainStatus$StatusMessage);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $TrainStatus$StatusMessage_ = $TrainStatus$StatusMessage$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $DeployerRecipeSearchEvent_ = $DeployerRecipeSearchEvent$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $MountedItemStorageWrapper_ = $MountedItemStorageWrapper$$Type;
}
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $ItemRequirement$ItemUseType$$Type = ($ItemRequirement$ItemUseType | ("consume" | "damage"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $TrackGraphMergeEvent_ = $TrackGraphMergeEvent$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $PackagePortTarget_ = $PackagePortTarget$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $Navigation$StationTest$$Type = ($Navigation$StationTest | ((arg0: double, arg1: double, arg2: $Map<$TrackEdge, $Pair<boolean, $Couple<$TrackNode>>>, arg3: $Pair<$Couple<$TrackNode>, $TrackEdge>, arg4: $GlobalStation) => boolean));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
import { $BogeyVisual$$Type } from "packages/com/simibubi/create/content/trains/bogey/$BogeyVisual"
import { $VisualizationContext } from "packages/dev/engine_room/flywheel/api/visualization/$VisualizationContext"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $BogeyVisualizer$$Type = ($BogeyVisualizer | ((arg0: $VisualizationContext, arg1: float, arg2: boolean) => $BogeyVisual$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $BogeyVisualizer_ = $BogeyVisualizer$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $LivingEntityAccessor$$Type = ($LivingEntityAccessor | ((arg0: $ItemStack, arg1: integer) => void));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $ScheduleRuntime$State$$Type = ($ScheduleRuntime$State | ("pre_transit" | "in_transit" | "post_transit"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TravellingPoint$IPortalListener$$Type = ($TravellingPoint$IPortalListener | ((arg0: $Couple<$TrackNodeLocation>) => boolean));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $FlowingFluidAccessor$$Type = ($FlowingFluidAccessor | ((arg0: $Level, arg1: $BlockPos, arg2: $BlockState) => $FluidState$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $MountedFluidStorageType$$Type<T extends $MountedFluidStorage> = ($MountedFluidStorageType<T>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $MountedFluidStorageType_<T extends $MountedFluidStorage> = $MountedFluidStorageType$$Type<T>;
}
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TrackTargetingBehaviour$RenderedTrackOverlayType$$Type = ($TrackTargetingBehaviour$RenderedTrackOverlayType | ("station" | "signal" | "dual_signal" | "observer"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SpecialBlockItemRequirement$$Type = ($SpecialBlockItemRequirement | ((arg0: $BlockState, arg1: $BlockEntity) => $ItemRequirement$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SpecialBlockItemRequirement_ = $SpecialBlockItemRequirement$$Type;
}
}
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $ActorVisual_ = $ActorVisual$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $UseOnContextAccessor$$Type = ($UseOnContextAccessor | (() => $BlockHitResult$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $BogeyVisual_ = $BogeyVisual$$Type;
}
}

declare module "packages/com/simibubi/create/content/trains/track/$TrackMaterial$TrackType$TrackBlockFactory" {
import { $TrackMaterial } from "packages/com/simibubi/create/content/trains/track/$TrackMaterial"
import { $BlockBehaviour$Properties } from "packages/net/minecraft/world/level/block/state/$BlockBehaviour$Properties"
import { $TrackBlock$$Type } from "packages/com/simibubi/create/content/trains/track/$TrackBlock"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TrackMaterial$TrackType$TrackBlockFactory$$Type = ($TrackMaterial$TrackType$TrackBlockFactory | ((arg0: $BlockBehaviour$Properties, arg1: $TrackMaterial) => $TrackBlock$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SequencerInstructions$$Type = ($SequencerInstructions | ("turn_angle" | "turn_distance" | "delay" | "await" | "end"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $CropBlockAccessor$$Type = ($CropBlockAccessor | (() => $IntegerProperty$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TransformableBlockEntity$$Type = ($TransformableBlockEntity | ((arg0: $BlockEntity, arg1: $StructureTransform) => void));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $TransformableBlockEntity_ = $TransformableBlockEntity$$Type;
}
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $BeltProcessingBehaviour$ProcessingResult$$Type = ($BeltProcessingBehaviour$ProcessingResult | ("pass" | "hold" | "remove"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SimpleRegistry$Provider$$Type<K, V> = ($SimpleRegistry$Provider<K, V> | ((arg0: K) => V));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SimpleRegistry$Provider_<K, V> = $SimpleRegistry$Provider$$Type<K, V>;
}
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $BlockLootSubProviderAccessor$$Type = ($BlockLootSubProviderAccessor);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $BlockLootSubProviderAccessor_ = $BlockLootSubProviderAccessor$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $EdgePointType$$Type<T extends $TrackEdgePoint> = ($EdgePointType<T>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $EdgePointType_<T extends $TrackEdgePoint> = $EdgePointType$$Type<T>;
}
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $DoorControl$$Type = ($DoorControl | ("all" | "north" | "east" | "south" | "west" | "none"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $IHaveBigOutline_ = $IHaveBigOutline$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $MountedItemStorageType$$Type<T extends $MountedItemStorage> = ($MountedItemStorageType<T>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $PipeCollisionEvent$Flow_ = $PipeCollisionEvent$Flow$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $IInteractionChecker$$Type = ($IInteractionChecker | ((arg0: $Player) => boolean));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
import { $FontSet$$Type } from "packages/net/minecraft/client/gui/font/$FontSet"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $FontAccessor$$Type = ($FontAccessor | (() => $Function$$Type<$ResourceLocation$$Type, $FontSet$$Type>));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SystemReportAccessor$$Type = ($SystemReportAccessor | (() => $Map$$Type<string, string>));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
import { $SubtitleOverlay$$Type } from "packages/net/minecraft/client/gui/components/$SubtitleOverlay"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $GuiAccessor$$Type = ($GuiAccessor | (() => $SubtitleOverlay$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
import { $TransportedItemStack } from "packages/com/simibubi/create/content/kinetics/belt/transport/$TransportedItemStack"
import { $TransportedItemStackHandlerBehaviour } from "packages/com/simibubi/create/content/kinetics/belt/behaviour/$TransportedItemStackHandlerBehaviour"
import { $BeltProcessingBehaviour$ProcessingResult$$Type } from "packages/com/simibubi/create/content/kinetics/belt/behaviour/$BeltProcessingBehaviour$ProcessingResult"

/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $BeltProcessingBehaviour$ProcessingCallback$$Type = ($BeltProcessingBehaviour$ProcessingCallback | ((arg0: $TransportedItemStack, arg1: $TransportedItemStackHandlerBehaviour) => $BeltProcessingBehaviour$ProcessingResult$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SuspiciousStewItemAccessor$$Type = ($SuspiciousStewItemAccessor);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $SuspiciousStewItemAccessor_ = $SuspiciousStewItemAccessor$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TrackTargetingBehaviour$$Type<T extends $TrackEdgePoint> = ($TrackTargetingBehaviour<T>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $TrackTargetingBehaviour_<T extends $TrackEdgePoint> = $TrackTargetingBehaviour$$Type<T>;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $BogeyRenderer$$Type = ($BogeyRenderer | ((arg0: $CompoundTag, arg1: float, arg2: float, arg3: $PoseStack, arg4: $MultiBufferSource, arg5: integer, arg6: integer, arg7: boolean) => void));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $IRotate$SpeedLevel$$Type = ($IRotate$SpeedLevel | ("none" | "slow" | "medium" | "fast"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $SignalBlockEntity$SignalState$$Type = ($SignalBlockEntity$SignalState | ("red" | "yellow" | "green" | "invalid"));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $TransportedItemStackHandlerBehaviour$PositionGetter$$Type = ($TransportedItemStackHandlerBehaviour$PositionGetter | ((arg0: $TransportedItemStack) => $Vec3$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $MobEffectInstanceAccessor$$Type = ($MobEffectInstanceAccessor | (() => $MobEffectInstance$$Type));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $PartialSafeNBT$$Type = ($PartialSafeNBT | ((arg0: $CompoundTag) => void));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $PartialSafeNBT_ = $PartialSafeNBT$$Type;
}
}
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $AbstractBogeyBlock$$Type<T extends $AbstractBogeyBlockEntity> = ($AbstractBogeyBlock<T>);
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $AbstractBogeyBlock_<T extends $AbstractBogeyBlockEntity> = $AbstractBogeyBlock$$Type<T>;
}
}
...
export {} // Mark the file as a module, do not remove unless there are other import/exports!
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $StateHolderAccessor$$Type<O, S> = ($StateHolderAccessor<O, S> | (() => O));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
export type $IHaveCustomOverlayIcon_ = $IHaveCustomOverlayIcon$$Type;
}
}
