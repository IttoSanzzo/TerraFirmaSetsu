declare module "packages/net/minecraft/client/multiplayer/$ClientChunkCache" {
...
public "handler$dmg000$railways$securitycraft$onDrop"(x: integer, z: integer, ci: $CallbackInfo$$Type): void
public "handler$dmg000$railways$securitycraft$onInit"(level: $ClientLevel$$Type, viewDistance: integer, ci: $CallbackInfo$$Type): void
public "handler$dmg000$railways$securitycraft$onUpdateViewRadius"(viewDistance: integer, ci: $CallbackInfo$$Type): void
...
public "handler$eae000$patchouli_onSync"(clientboundUpdateAdvancementsPacket0: $ClientboundUpdateAdvancementsPacket$$Type, callbackInfo1: $CallbackInfo$$Type): void
...
declare module "packages/net/minecraft/client/multiplayer/$ClientChunkCache$Storage" {
import { $LevelChunk, $LevelChunk$$Type } from "packages/net/minecraft/world/level/chunk/$LevelChunk"
import { $AtomicReferenceArray } from "packages/java/util/concurrent/atomic/$AtomicReferenceArray"
import { $ClientChunkCache$$Type } from "packages/net/minecraft/client/multiplayer/$ClientChunkCache"

export class $ClientChunkCache$Storage {
readonly "chunks": $AtomicReferenceArray<$LevelChunk>

constructor(clientChunkCache0: $ClientChunkCache$$Type, int1: integer)

public "getChunk"(int0: integer): $LevelChunk
public "getIndex"(int0: integer, int1: integer): integer
public "inRange"(int0: integer, int1: integer): boolean
public "replace"(int0: integer, levelChunk1: $LevelChunk$$Type, levelChunk2: $LevelChunk$$Type): $LevelChunk
public "replace"(int0: integer, levelChunk1: $LevelChunk$$Type): void
get "viewCenterX"(): integer
set "viewCenterX"(value: integer)
get "viewCenterZ"(): integer
set "viewCenterZ"(value: integer)
}
}
...
public "handler$ddo000$onCleanup"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$ddo001$onHandleLevelChunkWithLight"(clientboundLevelChunkWithLightPacket0: $ClientboundLevelChunkWithLightPacket$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ddo001$onHandleLightUpdatePacket"(clientboundLightUpdatePacket0: $ClientboundLightUpdatePacket$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ddo001$onOnBlockUpdate"(clientboundBlockUpdatePacket0: $ClientboundBlockUpdatePacket$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ddo001$onOnChunkData"(int0: integer, int1: integer, clientboundLevelChunkPacketData2: $ClientboundLevelChunkPacketData$$Type, callbackInfo3: $CallbackInfo$$Type): void
public "handler$ddo001$onOnChunkDeltaUpdate"(clientboundSectionBlocksUpdatePacket0: $ClientboundSectionBlocksUpdatePacket$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ddo001$onOnPlayerSpawnPosition"(clientboundSetDefaultSpawnPositionPacket0: $ClientboundSetDefaultSpawnPositionPacket$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ddo001$onQueueLightRemoval"(clientboundForgetLevelChunkPacket0: $ClientboundForgetLevelChunkPacket$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$dea001$onOnGameJoin"(clientboundLoginPacket0: $ClientboundLoginPacket$$Type, callbackInfo1: $CallbackInfo$$Type): void
...
public "wrapOperation$gac000$captureFeatureFlags"(featureFlagRegistry0: $FeatureFlagRegistry$$Type, iterable1: $Iterable$$Type<any>, operation2: $Operation$$Type<any>): $FeatureFlagSet
...
import { $ClientChunkCache } from "packages/net/minecraft/client/multiplayer/$ClientChunkCache"
...
public "handler$eai000$inject$onDisconnect"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$gba000$onSetBlocksDirty"(blockPos0: $BlockPos$$Type, blockState1: $BlockState$$Type, blockState2: $BlockState$$Type, callbackInfo3: $CallbackInfo$$Type): void
/** @deprecated */
...
public "handler$ddn001$onHandleDisguisedChatMessag"(component0: $Component$$Type, bound1: $ChatType$Bound$$Type, callbackInfo2: $CallbackInfo$$Type): void
public "handler$ddn001$onHandleSystemChat"(component0: $Component$$Type, boolean1: boolean, callbackInfo2: $CallbackInfo$$Type): void
...
public "handler$ebe000$clickSlot"(int0: integer, int1: integer, int2: integer, clickType3: $ClickType$$Type, player4: $Player$$Type, callbackInfo5: $CallbackInfo$$Type): void
public "handler$ebe000$clickSlotPre"(int0: integer, int1: integer, int2: integer, clickType3: $ClickType$$Type, player4: $Player$$Type, callbackInfo5: $CallbackInfo$$Type): void
public "handler$ebf000$clickCreativeStack"(itemStack0: $ItemStack$$Type, int1: integer, callbackInfo2: $CallbackInfo$$Type): void
public "handler$ebf000$pickItem"(int0: integer, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ebh000$internalOnSlotClickBegin"(int0: integer, int1: integer, int2: integer, clickType3: $ClickType$$Type, player4: $Player$$Type, callbackInfo5: $CallbackInfo$$Type): void
public "handler$ebh000$postInternalOnSlotClickBegin"(int0: integer, int1: integer, int2: integer, clickType3: $ClickType$$Type, player4: $Player$$Type, callbackInfo5: $CallbackInfo$$Type): void
