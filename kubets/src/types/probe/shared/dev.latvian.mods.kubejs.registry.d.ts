declare module "packages/dev/latvian/mods/kubejs/registry/$BuilderFactory" {
	...
	export interface $BuilderFactory {
		"createBuilder"(
			resourceLocation0: $ResourceLocation$$Type
		): $BuilderBase<any>;
	}
...
declare module "packages/dev/latvian/mods/kubejs/registry/$BuilderType" {
	...
	import {
		$BuilderBase,
		$BuilderBase$$Type,
	} from "packages/dev/latvian/mods/kubejs/registry/$BuilderBase";
	import {
		$BuilderFactory,
		$BuilderFactory$$Type,
	} from "packages/dev/latvian/mods/kubejs/registry/$BuilderFactory";

	export class $BuilderType<T> extends $Record {
		constructor(
			type: string,
			builderClass: $Class$$Type<$BuilderBase$$Type<T>>,
			factory: $BuilderFactory$$Type
		);
...
declare module "packages/dev/latvian/mods/kubejs/registry/$CustomBuilderObject" {
	...
	import {
		$RegistryInfo,
		$RegistryInfo$$Type,
	} from "packages/dev/latvian/mods/kubejs/registry/$RegistryInfo";
	import { $BuilderBase } from "packages/dev/latvian/mods/kubejs/registry/$BuilderBase";
	import { $ResourceLocation$$Type } from "packages/net/minecraft/resources/$ResourceLocation";
	...
	export class $CustomBuilderObject extends $BuilderBase<any> {
		constructor(
			...
			object: $Supplier$$Type<any>,
			registry: $RegistryInfo$$Type<any>
		);
...
declare module "packages/dev/latvian/mods/kubejs/registry/$RegistryInfo" {
	...
	import {
		$ResourceKey,
		$ResourceKey$$Type,
	} from "packages/net/minecraft/resources/$ResourceKey";
	...
	export class $RegistryInfo<T>
		implements $Iterable<$BuilderBase<T>>, $TypeWrapperFactory<T>
	{
		...
		static readonly "BLOCK_PREDICATE_TYPE": $RegistryInfo<
			$BlockPredicateType<any>
		>;
		static readonly "BLOCK_STATE_PROVIDER_TYPE": $RegistryInfo<
			$BlockStateProviderType<any>
		>;
		...
		static readonly "COMMAND_ARGUMENT_TYPE": $RegistryInfo<
			$ArgumentTypeInfo<any, any>
		>;
		static readonly "CONDITION": $RegistryInfo<$Codec<any>>;
		static readonly "CONFIGURED_CARVER": $RegistryInfo<
			$ConfiguredWorldCarver<any>
		>;
		static readonly "CONFIGURED_FEATURE": $RegistryInfo<
		...
		static readonly "FLOAT_PROVIDER_TYPE": $RegistryInfo<
			$FloatProviderType<any>
		>;
		static readonly "FLUID": $RegistryInfo<$Fluid>;
		static readonly "FOLIAGE_PLACER_TYPE": $RegistryInfo<
			$FoliagePlacerType<any>
		>;
		static readonly "FROG_VARIANT": $RegistryInfo<$FrogVariant>;
		static readonly "GAME_EVENT": $RegistryInfo<$GameEvent>;
		static readonly "HEIGHT_PROVIDER_TYPE": $RegistryInfo<
			$HeightProviderType<any>
		>;
		...
		static readonly "PLACEMENT_MODIFIER": $RegistryInfo<
			$PlacementModifierType<any>
		>;
		static readonly "PLACEMENT_MODIFIER_TYPE": $RegistryInfo<
			$PlacementModifierType<any>
		>;
		static readonly "POINT_OF_INTEREST_TYPE": $RegistryInfo<$PoiType>;
		static readonly "POSITION_SOURCE_TYPE": $RegistryInfo<
			$PositionSourceType<any>
		>;
		...
		static readonly "RULE_BLOCK_ENTITY_MODIFIER": $RegistryInfo<
			$RuleBlockEntityModifierType<any>
		>;
		...
		static readonly "STRUCTURE_PLACEMENT": $RegistryInfo<
			$StructurePlacementType<any>
		>;
		static readonly "STRUCTURE_PLACEMENT_TYPE": $RegistryInfo<
			$StructurePlacementType<any>
		>;
		static readonly "STRUCTURE_POOL_ELEMENT": $RegistryInfo<
			$StructurePoolElementType<any>
		>;
		static readonly "STRUCTURE_PROCESSOR": $RegistryInfo<
		...
		static readonly "TREE_DECORATOR_TYPE": $RegistryInfo<
			$TreeDecoratorType<any>
		>;
		...
		public addType(
			type: string,
			builderType: $Class$$Type<$BuilderBase$$Type<T>>,
			factory: $BuilderFactory$$Type
		): void;
		public addType(
			type: string,
		...
		public static of(
			key: $ResourceKey$$Type<$Registry<any>>
		): $RegistryInfo<any>;
		public static of<T>(
			key: $ResourceKey$$Type<$Registry<any>>,
			type: $Class$$Type<T>
...
declare module "packages/dev/latvian/mods/kubejs/registry/$RegistryCallback" {
	...
	export abstract class $RegistryCallback$$Static<T>
