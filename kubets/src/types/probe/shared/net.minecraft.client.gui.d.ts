...
public "keyReleased"(int0: integer, int1: integer, int2: integer): boolean
public "magicalSpecialHackyFocus"(guiEventListener0: $GuiEventListener$$Type): void
public "modify$ekk000$configuredModifyBlitBackgroundTexture"(resourceLocation0: $ResourceLocation$$Type): $ResourceLocation
public "mouseMoved"(double0: double, double1: double): void
...
public "handler$ghd000$create$xaeroPauseScreenOverride"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
...
public "keyReleased"(int0: integer, int1: integer, int2: integer): boolean
public "magicalSpecialHackyFocus"(guiEventListener0: $GuiEventListener$$Type): void
public "modify$ekl001$configuredModifyBlitBackgroundTexture"(resourceLocation0: $ResourceLocation$$Type): $ResourceLocation
public "mouseClicked"(double0: double, double1: double, int2: integer): boolean
public "mouseDragged"(double0: double, double1: double, int2: integer, double3: double, double4: double): boolean
public "mouseMoved"(double0: double, double1: double): void
public "mouseReleased"(double0: double, double1: double, int2: integer): boolean
...
public "handler$bma000$render"(italic: boolean, x: float, y: float, matrix: $Matrix4f$$Type, vertexConsumer: $VertexConsumer$$Type, red: float, green: float, blue: float, alpha: float, light: integer, ci: $CallbackInfo$$Type): void
...
public "handler$ejf000$inject$renderText"(string0: string, float1: float, float2: float, int3: integer, boolean4: boolean, matrix4f5: $Matrix4f$$Type, multiBufferSource6: $MultiBufferSource$$Type, displayMode7: $Font$DisplayMode$$Type, int8: integer, int9: integer, callbackInfoReturnable10: $CallbackInfoReturnable$$Type<any>): void
public "handler$ejf000$inject$renderText"(formattedCharSequence0: $FormattedCharSequence$$Type, float1: float, float2: float, int3: integer, boolean4: boolean, matrix4f5: $Matrix4f$$Type, multiBufferSource6: $MultiBufferSource$$Type, displayMode7: $Font$DisplayMode$$Type, int8: integer, int9: integer, callbackInfoReturnable10: $CallbackInfoReturnable$$Type<any>): void
...
public "handler$fma000$addPlayer"(info: $PlayerInfo$$Type, ci: $CallbackInfo$$Type): void
public "handler$fma000$removePlayer"(id: $UUID$$Type, ci: $CallbackInfo$$Type): void
...
public "handler$dph000$renderTooltip"(font0: $Font$$Type, itemStack1: $ItemStack$$Type, int2: integer, int3: integer, callbackInfo4: $CallbackInfo$$Type): void
public "handler$dph000$renderTooltipInternal"(font0: $Font$$Type, list1: $List$$Type<any>, int2: integer, int3: integer, clientTooltipPositioner4: $ClientTooltipPositioner$$Type, callbackInfo5: $CallbackInfo$$Type): void
...
export class $Gui implements $GuiAccessor, $GuiSubtitleOverlayAccess, $GuiAccessor$0 {
...
public "constant$znp000$apoth_extendTime"(int0: integer): integer
...
public "handler$bfh000$renderSlot"(guiGraphics0: $GuiGraphics$$Type, int1: integer, int2: integer, float3: float, player4: $Player$$Type, itemStack5: $ItemStack$$Type, int6: integer, callbackInfo7: $CallbackInfo$$Type): void
public "handler$bjb001$iris$handleHudHidingScreens"(pGui0: $GuiGraphics$$Type, pFloat1: float, ci: $CallbackInfo$$Type): void
public "handler$ekn001$renderSlot"(guiGraphics0: $GuiGraphics$$Type, int1: integer, int2: integer, float3: float, player4: $Player$$Type, itemStack5: $ItemStack$$Type, int6: integer, callbackInfo7: $CallbackInfo$$Type): void
public "handler$fgh000$changeArmorItem"(guiGraphics0: $GuiGraphics$$Type, resourceLocation1: $ResourceLocation$$Type, float2: float, callbackInfo3: $CallbackInfo$$Type): void
...
public "constant$deh000$placebo_unEscapeChatLogNewlines"(string0: string): string
...
public "redirect$ema000$renderPingIcon"(playerTabOverlay0: $PlayerTabOverlay$$Type, guiGraphics1: $GuiGraphics$$Type, int2: integer, int3: integer, int4: integer, playerInfo5: $PlayerInfo$$Type): void
...
public "handler$bfg000$renderSlot"(guiGraphics0: $GuiGraphics$$Type, slot1: $Slot$$Type, callbackInfo2: $CallbackInfo$$Type): void
public "handler$bob000$apoth_superMouseDragged"(double0: double, double1: double, int2: integer, double3: double, double4: double, callbackInfoReturnable5: $CallbackInfoReturnable$$Type<any>): void
public "handler$ekm001$renderSlot"(guiGraphics0: $GuiGraphics$$Type, slot1: $Slot$$Type, callbackInfo2: $CallbackInfo$$Type): void
public "isFocused"(): boolean
