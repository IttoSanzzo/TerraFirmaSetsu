...
public "modifyExpressionValue$fcm000$giveMinimumOffsetIfDisabled"(long0: long): long
public "modifyReturnValue$fcm000$dummyOutDisabledParameters"(list0: $List$$Type<any>): $List<any>
public "offset"(): long
public "temperature"(): $Climate$Parameter
public "weirdness"(): $Climate$Parameter
public "wrapOperation$fcm000$giveMinimumDistanceForDisabledParameters"(parameter0: $Climate$Parameter$$Type, long1: long, operation2: $Operation$$Type<any>): long
}
}
