...
export abstract class $RecipeComponent$$Static<T> implements $RecipeComponent<T> {
...
export abstract class $RecipeOptional$$Static<T> implements $RecipeOptional<T> {
...
export abstract class $RecipeComponentWithParent$$Static<T> implements $RecipeComponentWithParent<T> {
static "builder"(): $RecipeComponentBuilder
static "builder"(...key: $RecipeKey$$Type<any>[]): $RecipeComponentBuilder
}
}
