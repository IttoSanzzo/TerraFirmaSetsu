...
public "handler$ebg000$addStackPost"(itemStack0: $ItemStack$$Type, callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>): void
public "handler$ebg000$addStackPre"(itemStack0: $ItemStack$$Type, callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>): void
public "handler$ebg000$getEmptySlot"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "handler$ebg000$setPickedItemPost"(itemStack0: $ItemStack$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ebg000$setPickedItemPre"(itemStack0: $ItemStack$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$eno000$fireDropEvent"(ci: $CallbackInfo$$Type, var1: $Iterator$$Type<any>, list: $List$$Type<any>, i: integer): void
public "handler$eno000$restoreNotDropped"(ci: $CallbackInfo$$Type, var1: $Iterator$$Type<any>, list: $List$$Type<any>, i: integer): void
...
public "handler$ddi004$tick"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$djh000$addModDataVersions"(compound: $CompoundTag$$Type, ci: $CallbackInfo$$Type): void
public "handler$gao000$getDimensions"(pose0: $Pose$$Type, callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>): void
public "handler$gao000$getStandingEyeHeight"(pose0: $Pose$$Type, entityDimensions1: $EntityDimensions$$Type, callbackInfoReturnable2: $CallbackInfoReturnable$$Type<any>): void
public "handler$gao000$onIsStayingOnGroundSurface"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "handler$gao000$onJumpFromGround"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$gao000$onTryToStartFallFlying"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
