...
declare module "packages/net/minecraft/client/renderer/$ViewArea" {
...
import { $GameRendererAccessor } from "packages/com/github/exopandora/shouldersurfing/mixins/$GameRendererAccessor"
import { $LivingEntity$$Type } from "packages/net/minecraft/world/entity/$LivingEntity"
import { $GameRendererAccessor as $GameRendererAccessor$0 } from "packages/net/createmod/ponder/mixin/client/accessor/$GameRendererAccessor"
...
import { $GameRendererAccessor as $GameRendererAccessor$1 } from "packages/net/irisshaders/iris/mixin/$GameRendererAccessor"
...
import { $GameRendererAccess } from "packages/snownee/lychee/mixin/$GameRendererAccess"
import { $RenderBuffers, $RenderBuffers$$Type } from "packages/net/minecraft/client/renderer/$RenderBuffers"
import { $GameRendererAccessor as $GameRendererAccessor$2 } from "packages/waves/mixin/client/$GameRendererAccessor"
import { $CallbackInfo$$Type } from "packages/org/spongepowered/asm/mixin/injection/callback/$CallbackInfo"

export class $GameRenderer implements $AutoCloseable, $GameRendererAccessor$2, $GameRendererAccessor$1, $GameRendererAccessor, $GameRendererAccessor$0, $GameRendererAccess {
...
public "handler$geg000$lodestone$injectionResizeListener"(int0: integer, int1: integer, callbackInfo2: $CallbackInfo$$Type): void
...
public "redirect$cgm000$bobView"(optionInstance0: $OptionInstance$$Type<any>): any
...
public "handler$eip000$inject$shouldRender"(entity0: $Entity$$Type, frustum1: $Frustum$$Type, double2: double, double3: double, double4: double, callbackInfoReturnable5: $CallbackInfoReturnable$$Type<any>): void
...
public "getName"(): string
public "handler$bpl000$onRenderItem"(itemStack0: $ItemStack$$Type, itemDisplayContext1: $ItemDisplayContext$$Type, boolean2: boolean, poseStack3: $PoseStack$$Type, multiBufferSource4: $MultiBufferSource$$Type, int5: integer, int6: integer, bakedModel7: $BakedModel$$Type, callbackInfo8: $CallbackInfo$$Type): void
public "modifyExpressionValue$fgm000$renderQuads"(float0: float): float
public "onResourceManagerReload"(resourceManager0: $ResourceManager$$Type): void
public "reload"(preparationBarrier0: $PreparableReloadListener$PreparationBarrier$$Type, resourceManager1: $ResourceManager$$Type, profilerFiller2: $ProfilerFiller$$Type, profilerFiller3: $ProfilerFiller$$Type, executor4: $Executor$$Type, executor5: $Executor$$Type): $CompletableFuture<void>
...
public "handler$dbo000$adastra$shouldRender"(entity: $Entity$$Type, frustum: $Frustum$$Type, x: double, y: double, z: double, cir: $CallbackInfoReturnable$$Type<any>): void
...
export class $LevelRenderer implements $ResourceManagerReloadListener, $AutoCloseable, $WorldRendererAccessor, $LevelRendererAccessor, $LevelRendererAccessor$0, $CullingDataCache, $LevelRendererAccessor$4, $LevelRendererAccessor$3, $LevelRendererAccessor$2, $AccessorLevelRenderer, $WorldRendererAccess, $LevelRendererAccessor$1, $WorldRendererExtended {
...
public "handler$cgp000$postRender"(entity0: $Entity$$Type, double1: double, double2: double, double3: double, float4: float, poseStack5: $PoseStack$$Type, multiBufferSource6: $MultiBufferSource$$Type, callbackInfo7: $CallbackInfo$$Type): void
public "handler$cgp000$preRender"(entity0: $Entity$$Type, double1: double, double2: double, double3: double, float4: float, poseStack5: $PoseStack$$Type, multiBufferSource6: $MultiBufferSource$$Type, callbackInfo7: $CallbackInfo$$Type): void
public "handler$coa000$renderBlockEntitiesInject"(matrixStack: $PoseStack$$Type, tickDelta: float, limitTime: long, renderBlockOutline: boolean, camera: $Camera$$Type, gameRenderer: $GameRenderer$$Type, lightmapTextureManager: $LightTexture$$Type, positionMatrix: $Matrix4f$$Type, ci: $CallbackInfo$$Type): void
public "handler$dcb000$adastra$tickRain"(camera: $Camera$$Type, ci: $CallbackInfo$$Type): void
public "handler$eag000$onRender"(poseStack0: $PoseStack$$Type, float1: float, long2: long, boolean3: boolean, camera4: $Camera$$Type, gameRenderer5: $GameRenderer$$Type, lightTexture6: $LightTexture$$Type, matrix4f7: $Matrix4f$$Type, callbackInfo8: $CallbackInfo$$Type): void
public "handler$ejl000$inject$tick"(camera0: $Camera$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$elj000$renderClouds"(poseStack: $PoseStack$$Type, projectionMatrix: $Matrix4f$$Type, partialTicks: float, cameraX: double, cameraY: double, cameraZ: double, ci: $CallbackInfo$$Type): void
public "handler$emp000$afterTESRRender"(poseStack0: $PoseStack$$Type, float1: float, long2: long, boolean3: boolean, camera4: $Camera$$Type, gameRenderer5: $GameRenderer$$Type, lightTexture6: $LightTexture$$Type, matrix4f7: $Matrix4f$$Type, callbackInfo8: $CallbackInfo$$Type): void
public "handler$fgo000$playStreamingMusic"(soundEvent0: $SoundEvent$$Type, blockPos1: $BlockPos$$Type, recordItem2: $RecordItem$$Type, callbackInfo3: $CallbackInfo$$Type): void
public "handler$gbh000$endOpaque"(poseStack0: $PoseStack$$Type, float1: float, long2: long, boolean3: boolean, camera4: $Camera$$Type, gameRenderer5: $GameRenderer$$Type, lightTexture6: $LightTexture$$Type, matrix4f7: $Matrix4f$$Type, callbackInfo8: $CallbackInfo$$Type): void
public "handler$gbh000$endTranslucent"(poseStack0: $PoseStack$$Type, float1: float, long2: long, boolean3: boolean, camera4: $Camera$$Type, gameRenderer5: $GameRenderer$$Type, lightTexture6: $LightTexture$$Type, matrix4f7: $Matrix4f$$Type, callbackInfo8: $CallbackInfo$$Type): void
public "handler$gbh000$frameStart"(poseStack0: $PoseStack$$Type, float1: float, long2: long, boolean3: boolean, camera4: $Camera$$Type, gameRenderer5: $GameRenderer$$Type, lightTexture6: $LightTexture$$Type, matrix4f7: $Matrix4f$$Type, callbackInfo8: $CallbackInfo$$Type): void
public "handler$gbh000$lightUpdated"(poseStack0: $PoseStack$$Type, float1: float, long2: long, boolean3: boolean, camera4: $Camera$$Type, gameRenderer5: $GameRenderer$$Type, lightTexture6: $LightTexture$$Type, matrix4f7: $Matrix4f$$Type, callbackInfo8: $CallbackInfo$$Type): void
public "handler$gbh000$preOpaque"(poseStack0: $PoseStack$$Type, float1: float, long2: long, boolean3: boolean, camera4: $Camera$$Type, gameRenderer5: $GameRenderer$$Type, lightTexture6: $LightTexture$$Type, matrix4f7: $Matrix4f$$Type, callbackInfo8: $CallbackInfo$$Type): void
public "handler$gbh000$preTerrainSetup"(poseStack0: $PoseStack$$Type, float1: float, long2: long, boolean3: boolean, camera4: $Camera$$Type, gameRenderer5: $GameRenderer$$Type, lightTexture6: $LightTexture$$Type, matrix4f7: $Matrix4f$$Type, callbackInfo8: $CallbackInfo$$Type): void
public "handler$gbh000$setSectionDirty"(int0: integer, int1: integer, int2: integer, boolean3: boolean, callbackInfo4: $CallbackInfo$$Type): void
public "handler$gej000$lodestone$injectionBeforeTransparencyChainProcess"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$zop000$renderCloudsFast"(poseStack0: $PoseStack$$Type, matrix4f1: $Matrix4f$$Type, float2: float, double3: double, double4: double, double5: double, callbackInfo6: $CallbackInfo$$Type): void
...
set "cullingFrustum"(value: $Frustum$$Type)
...
public "getName"(): string
public "handler$emh000$renderByItem"(itemStack: $ItemStack$$Type, itemDisplayContext: $ItemDisplayContext$$Type, poseStack: $PoseStack$$Type, multiBufferSource: $MultiBufferSource$$Type, i: integer, j: integer, info: $CallbackInfo$$Type): void
public "onResourceManagerReload"(resourceManager0: $ResourceManager$$Type): void
public "reload"(preparationBarrier0: $PreparableReloadListener$PreparationBarrier$$Type, resourceManager1: $ResourceManager$$Type, profilerFiller2: $ProfilerFiller$$Type, profilerFiller3: $ProfilerFiller$$Type, executor4: $Executor$$Type, executor5: $Executor$$Type): $CompletableFuture<void>
...
public "close"(): void
public "handler$zpf000$assignParent"(spriteContents0: $SpriteContents$$Type, animatedTexture1: $SpriteContents$AnimatedTexture$$Type, interpolationData2: $SpriteContents$InterpolationData$$Type, callbackInfo3: $CallbackInfo$$Type): void
...
public "redirect$bib000$iris$redirectBindAttributeLocation"(i: integer, j: integer, charSequence: charseq): void
public "redirect$bib000$iris$setupGeometryShader"(reader: $Reader$$Type, resourceProvider: $ResourceProvider$$Type, name: $ResourceLocation$$Type, vertexFormat: $VertexFormat$$Type): $JsonObject
...
public "handler$eja000$render"(blockEntity0: $BlockEntity$$Type, float1: float, poseStack2: $PoseStack$$Type, multiBufferSource3: $MultiBufferSource$$Type, callbackInfo4: $CallbackInfo$$Type): void
public "onResourceManagerReload"(resourceManager0: $ResourceManager$$Type): void
...
public "handler$cga000$renderColliderDebug"(matrices: $PoseStack$$Type, vertexConsumers: $MultiBufferSource$BufferSource$$Type, cameraX: double, cameraY: double, cameraZ: double, ci: $CallbackInfo$$Type): void
...
public "handler$dco000$renderArmWithItem"(abstractClientPlayer0: $AbstractClientPlayer$$Type, float1: float, float2: float, interactionHand3: $InteractionHand$$Type, float4: float, itemStack5: $ItemStack$$Type, float6: float, poseStack7: $PoseStack$$Type, multiBufferSource8: $MultiBufferSource$$Type, int9: integer, callbackInfo10: $CallbackInfo$$Type): void
public "handler$epe000$moonlight$animateItem"(player: $AbstractClientPlayer$$Type, partialTicks: float, pitch: float, hand: $InteractionHand$$Type, swingProgress: float, stack: $ItemStack$$Type, handHeight: float, poseStack: $PoseStack$$Type, buffer: $MultiBufferSource$$Type, combinedLight: integer, ci: $CallbackInfo$$Type): void
public "handler$epe000$moonlight$renderSpecial"(player: $AbstractClientPlayer$$Type, partialTicks: float, pitch: float, hand: $InteractionHand$$Type, swingProgress: float, stack: $ItemStack$$Type, equippedProgress: float, poseStack: $PoseStack$$Type, buffer: $MultiBufferSource$$Type, combinedLight: integer, ci: $CallbackInfo$$Type, arm: $HumanoidArm$$Type): void
...
public "close"(): void
public "handler$bbe000$assignParent"(spriteContents0: $SpriteContents$$Type, callbackInfo1: $CallbackInfo$$Type): void
}
}
...
public "getTextureLocation"(t0: T): $ResourceLocation
public "handler$dcp001$render"(livingEntity0: $LivingEntity$$Type, float1: float, float2: float, poseStack3: $PoseStack$$Type, multiBufferSource4: $MultiBufferSource$$Type, int5: integer, callbackInfo6: $CallbackInfo$$Type): void
...
public "handler$emf000$setModelProperties"(abstractClientPlayer: $AbstractClientPlayer$$Type, info: $CallbackInfo$$Type): void
...
public "wrapOperation$flg000$supplementaries$modifyLumiseneHeight"(instance: $Fluid$$Type, above: $Fluid$$Type, original: $Operation$$Type<any>): boolean
public "wrapOperation$flg000$supplementaries$modifyLumiseneLight"(level: $BlockAndTintGetter$$Type, pos: $BlockPos$$Type, original: $Operation$$Type<any>): integer
}
}
...
public "handler$ekc000$inject$init"(gameRenderer0: $GameRenderer$$Type, minecraft1: $Minecraft$$Type, callbackInfo2: $CallbackInfo$$Type): void
public "handler$elk000$updateLightTexture"(partialTicks: float, ci: $CallbackInfo$$Type): void
public static "pack"(int0: integer, int1: integer): integer
...
public "upload"(): void
public "wrapOperation$epc000$forceMipMap"(instance: $NativeImage$$Type, a: integer, b: integer, c: integer, autoClose: boolean, op: $Operation$$Type<any>): void
public "wrapOperation$epc000$forceMipMap"(a: integer, b: integer, c: integer, op: $Operation$$Type<any>): void
