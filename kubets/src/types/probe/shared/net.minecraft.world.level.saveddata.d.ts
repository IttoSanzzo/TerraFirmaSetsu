...
public "handler$enn000$checkLocked"(mapId: integer, cir: $CallbackInfoReturnable$$Type<any>): void
public "handler$enn000$initializeDirty"(mapItemSavedData: $MapItemSavedData$$Type, player: $Player$$Type, ci: $CallbackInfo$$Type): void
public "handler$enn000$lockData"(x: integer, z: integer, ci: $CallbackInfo$$Type): void
public "handler$enn000$sanityCheck"(x: integer, z: integer, ci: $CallbackInfo$$Type): void
public "modifyReturnValue$enn000$addExtraPacketData"(packet: $Packet$$Type<any>, mapId: integer): $Packet<any>
...
public "handler$eoc000$checkCustomDeco"(world: $BlockGetter$$Type, x: integer, z: integer, ci: $CallbackInfo$$Type): void
public "handler$eoc000$initCustomData"(i: integer, j: integer, b: byte, bl: boolean, bl2: boolean, bl3: boolean, resourceKey: $ResourceKey$$Type<any>, ci: $CallbackInfo$$Type): void
public "handler$eoc000$locked"(cir: $CallbackInfoReturnable$$Type<any>): void
public "handler$eoc000$save"(tag: $CompoundTag$$Type, cir: $CallbackInfoReturnable$$Type<any>): void
public "handler$eoc000$scaled"(cir: $CallbackInfoReturnable$$Type<any>): void
public "handler$eoc000$tickCarriedBy"(player: $Player$$Type, stack: $ItemStack$$Type, ci: $CallbackInfo$$Type): void
public "handler$ggc000$create$onCheckBanners"(blockGetter0: $BlockGetter$$Type, int1: integer, int2: integer, callbackInfo3: $CallbackInfo$$Type): void
public "handler$ggc000$create$onSave"(compoundTag0: $CompoundTag$$Type, callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>): void
