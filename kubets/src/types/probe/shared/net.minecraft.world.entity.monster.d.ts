...
public "getTotalMovementSpeed"(): double
public "getType"(): string
public "handler$fke001$addAdditionalSaveData"(compound: $CompoundTag$$Type, ci: $CallbackInfo$$Type): void
public "handler$fke001$readAdditionalSaveData"(compound: $CompoundTag$$Type, ci: $CallbackInfo$$Type): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
public "isAmbientCreature"(): boolean
public "isAnimal"(): boolean
public "isDynamicLightEnabledH"(): boolean
...
public "handler$fij000$supp$addPartyCreeperData"(compound: $CompoundTag$$Type, ci: $CallbackInfo$$Type): void
public "handler$fij000$supp$readPartyCreeperData"(compound: $CompoundTag$$Type, ci: $CallbackInfo$$Type): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
public "ignite"(): void
...
public "tell"(message: $Component$$Type): void
public static "tickEntity"(entity: $LivingEntity$$Type): void
public "wrapWithCondition$fij000$supp$checkPartyCreeper"(instance: $Level$$Type, source: $Entity$$Type, x: double, y: double, z: double, radius: float, explosionInteraction: $Level$ExplosionInteraction$$Type): boolean
get "block"(): $BlockContainerJS
get "chestArmorItem"(): $ItemStack
get "defaultMovementSpeed"(): double
get "displayName"(): $Component
...
public "getTotalMovementSpeed"(): double
public "getType"(): string
public "handler$fib000$supp$consumeQuiverArrow"(target: $LivingEntity$$Type, velocity: float, ci: $CallbackInfo$$Type, arrow: $ItemStack$$Type): void
public "handler$fib000$supp$finalizeSpawn"(level: $ServerLevelAccessor$$Type, difficulty: $DifficultyInstance$$Type, reason: $MobSpawnType$$Type, spawnData: $SpawnGroupData$$Type, dataTag: $CompoundTag$$Type, cir: $CallbackInfoReturnable$$Type<any>): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
public "isAmbientCreature"(): boolean
public "isAnimal"(): boolean
public "isDynamicLightEnabledH"(): boolean
...
public "getTotalMovementSpeed"(): double
public "getType"(): string
public "handler$fkg000$supp$applySlimedEffect"(livingEntity: $LivingEntity$$Type, ci: $CallbackInfo$$Type): void
...
public "mergeNbt"(tag: $CompoundTag$$Type): $Entity
public "modifyAttribute"(attribute: $Attribute$$Type, identifier: string, d: double, operation: $AttributeModifier$Operation$$Type): void
public "modifyExpressionValue$ffe000$getRealType"(entityType0: $EntityType$$Type<any>): $EntityType<any>
public "moveInFluid"(fluidState0: $FluidState$$Type, vec31: $Vec3$$Type, double2: double): boolean
public "playSound"(id: $SoundEvent$$Type, volume: float, pitch: float): void
public "playSound"(id: $SoundEvent$$Type): void
public "rayTrace"(): $RayTraceResultJS
