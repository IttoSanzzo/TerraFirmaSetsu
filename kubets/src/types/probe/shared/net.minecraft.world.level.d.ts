...
public "handler$fip000$explode"(ci: $CallbackInfo$$Type): void
public "handler$fnk000$amendments$addBlockSideEffects"(ci: $CallbackInfo$$Type, pos: $BlockPos$$Type, state: $BlockState$$Type, set: $Set$$Type<any>): void
public "interactsWithBlocks"(): boolean
public "wrapOperation$fnk000$amendments$HurtWithContext"(entity: $Entity$$Type, source: $DamageSource$$Type, amount: float, original: $Operation$$Type<any>): boolean
public "wrapWithCondition$fnk000$amendments$cancelKnockback"(instance: $Entity$$Type, deltaMovement: $Vec3$$Type): boolean
public "wrapWithCondition$fnk000$amendments$changeSound"(instance: $Level$$Type, x: double, y: double, z: double, sound: $SoundEvent$$Type, category: $SoundSource$$Type, volume: float, pitch: float, distanceDelay: boolean): boolean
