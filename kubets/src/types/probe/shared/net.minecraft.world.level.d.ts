...
public "handler$bnk000$apoth_flightAttribModifier"(abilities0: $Abilities$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$bnk000$apoth_recordOldFlyingAttribs"(abilities0: $Abilities$$Type, callbackInfo1: $CallbackInfo$$Type): void
...
public "handler$ffb000$explode"(ci: $CallbackInfo$$Type): void
public "handler$fjk000$amendments$addBlockSideEffects"(ci: $CallbackInfo$$Type, pos: $BlockPos$$Type, state: $BlockState$$Type, set: $Set$$Type<any>): void
public "interactsWithBlocks"(): boolean
public "wrapOperation$fjk000$amendments$HurtWithContext"(entity: $Entity$$Type, source: $DamageSource$$Type, amount: float, original: $Operation$$Type<any>): boolean
public "wrapWithCondition$fjk000$amendments$cancelKnockback"(instance: $Entity$$Type, deltaMovement: $Vec3$$Type): boolean
public "wrapWithCondition$fjk000$amendments$changeSound"(instance: $Level$$Type, x: double, y: double, z: double, sound: $SoundEvent$$Type, category: $SoundSource$$Type, volume: float, pitch: float, distanceDelay: boolean): boolean
