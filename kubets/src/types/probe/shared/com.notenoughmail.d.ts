 ...
 */
public "full"(gen: $BiConsumer$$Type<$ChunkData$$Type, $ChunkAccess$$Type>): void
 ...
 * For a full explanation, see the wiki.
 */
public "partial"(gen: $BiConsumer$$Type<$ChunkData$$Type, $ChunkAccess$$Type>): void
/**
...
import { $BiConsumer$$Type } from "packages/java/util/function/$BiConsumer"
import { $TFCLeavesBlockBuilder, $TFCLeavesBlockBuilder$$Type } from "packages/com/notenoughmail/kubejs_tfc/block/$TFCLeavesBlockBuilder"
import { $BlockBehaviour$Properties } from "packages/net/minecraft/world/level/block/state/$BlockBehaviour$Properties"
...
export class $ItemStackProviderJS extends $Record implements $OutputReplacement, $ReplacementMatch, $IFirmaLifeISPExtensions {
