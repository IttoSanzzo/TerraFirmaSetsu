...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$AqueductBlockBuilder$AqueductModelPart" {
	...
	export class $AqueductBlockBuilder$AqueductModelPart extends $Enum<$AqueductBlockBuilder$AqueductModelPart> {
		...
		public static valueOf(
			name: string
		): $AqueductBlockBuilder$AqueductModelPart;
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/internal/$AbstractCropBlockBuilder" {
	...
	export class $AbstractCropBlockBuilder extends $ExtendedPropertiesBlockBuilder {
		...
		public deadBlock(
			deadCrop: $Consumer$$Type<$DeadCropBlockBuilder$$Type>
		): $AbstractCropBlockBuilder;
		/** Sets the crop's 'product' item to be an existing item */
		public existingProductItem(
			productItem: $ResourceLocation$$Type
		): $AbstractCropBlockBuilder;
		...
		public expiryModifierSupplier(
			mod: $Supplier$$Type<double>
		): $AbstractCropBlockBuilder;
		...
		public nutrient(
			nutrient: $FarmlandBlockEntity$NutrientType$$Type
		): $AbstractCropBlockBuilder;
		/** Modifies the crop's 'product' item */
		public productItem(
			productItem: $Consumer$$Type<$ItemBuilder$$Type>
		): $AbstractCropBlockBuilder;
		/** Modifies the crop's seed item */
		public seedItem(
			seedItem: $Consumer$$Type<$SeedItemBuilder$$Type>
		): $AbstractCropBlockBuilder;
		/** Sets the model for a specific growth stage */
		public setModel(
			stage: integer,
			gen: $Consumer$$Type<$ModelGenerator$$Type>
		): $AbstractCropBlockBuilder;
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$ISupportExtendedProperties$MapColorFunction" {
	...
	import {
		$MapColor,
		$MapColor$$Type,
	} from "packages/net/minecraft/world/level/material/$MapColor";
	import {
		$BlockState,
		$BlockState$$Type,
	} from "packages/net/minecraft/world/level/block/state/$BlockState";

	export interface $ISupportExtendedProperties$MapColorFunction extends $Function<
		$BlockState,
		$MapColor
	> {
		"andThen"<V>(
			function0: $Function$$Type<$MapColor$$Type, V>
		): $Function<$BlockState, V>;
		"apply"(state: $BlockState$$Type): $MapColor;
		"compose"<V>(
			function0: $Function$$Type<V, $BlockState>
		): $Function<V, $MapColor>;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$WildCropBlockBuilder" {
	...
	export class $WildCropBlockBuilder extends $ExtendedPropertiesBlockBuilder {
		 ...
		 */
		public doubleDeadModels(
			topModel: string,
			bottomModel: string
		): $WildCropBlockBuilder;
...
declare module "packages/com/notenoughmail/kubejs_tfc/recipe/js/$TFCProviderRecipeJS" {
	...
	export class $TFCProviderRecipeJS
		extends $TFCRecipeJS
		implements $ISupportProviderOutput
	{
		constructor();
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$RegisterFoodTraitEventJS" {
	...
	export class $RegisterFoodTraitEventJS extends $StartupEventJS {
		 ...
		 * @param id - The registry id of the food trait
		 */
		public registerTraitWithTooltip(
			decayModifier: float,
			id: $ResourceLocation$$Type
		): void;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$RegisterItemStackModifierEventJS" {
	...
	export class $RegisterItemStackModifierEventJS extends $EventJS {
		...
		public simple(
			id: $ResourceLocation$$Type,
			applicator: $KubeJSItemStackModifier$SimpleApplicator$$Type
		): void;
		/**
		...
		public withInput(
			id: $ResourceLocation$$Type,
			applicator: $KubeJSItemStackModifier$ModifierApplicator$$Type
		): void;
		/**
		...
		public withInventory(
			id: $ResourceLocation$$Type,
			applicator: $KubeJSItemStackModifier$WithInventoryApplicator$$Type
		): void;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$GroundCoverBlockBuilder" {
	...
	export class $GroundCoverBlockBuilder extends $ExtendedPropertiesBlockBuilder {
		...
		/** Rotates the default models by 45 degrees */
		...
		public withPreexistingItem(
			item: $ResourceLocation$$Type
		): $GroundCoverBlockBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$AxleBlockBuilder" {
	...
	export class $AxleBlockBuilder extends $ExtendedPropertiesBlockBuilder {
		...
		public bladedAxle(
			bladed: $Consumer$$Type<$BladedAxleBlockBuilder$$Type>
		): $AxleBlockBuilder;
		/** Creates and sets the properties of the axle's clutch block */
		public clutch(
			clutch: $Consumer$$Type<$ClutchBlockBuilder$$Type>
		): $AxleBlockBuilder;
		public createObject(): $Block;
		public createProperties(): $BlockBehaviour$Properties;
		/** Creates and sets the properties of the axle's gear box block */
		public gearBox(
			gearBox: $Consumer$$Type<$GearBoxBlockBuilder$$Type>
		): $AxleBlockBuilder;
		/** Creates and sets the properties of the axle's water wheel block */
		public waterWheel(
			waterWheel: $Consumer$$Type<$WaterWheelBlockBuilder$$Type>
		): $AxleBlockBuilder;
		/** Sets the properties of the axle's windmill block */
		public windmill(
			windmill: $Consumer$$Type<$WindmillBlockBuilder$$Type>
		): $AxleBlockBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$LogBlockBuilder$UnStripped" {
	...
	import {
		$LogBlockBuilder,
		$LogBlockBuilder$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/block/$LogBlockBuilder";
	import { $ResourceLocation$$Type } from "packages/net/minecraft/resources/$ResourceLocation";
	...
	export class $LogBlockBuilder$UnStripped extends $LogBlockBuilder {
		...
		public stripped(
			builder: $Consumer$$Type<$LogBlockBuilder$$Type>
		): $LogBlockBuilder$UnStripped;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/sub/$DeadTorchBuilder" {
	...
	export class $DeadTorchBuilder extends $BlockBuilder {
		constructor(
			i: $ResourceLocation$$Type,
			parent: $TFCTorchBlockBuilder$$Type
		);
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/sub/$ConnectedGrassBlockBuilder" {
	...
	export class $ConnectedGrassBlockBuilder extends $MultipartShapedBlockBuilder {
		 ...
		 */
		public models(
			models: $BiConsumer$$Type<
				$ConnectedGrassBlockBuilder$GrassModelPart$$Type,
				$ModelGenerator$$Type
			>
		): $ConnectedGrassBlockBuilder;
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/worldgen/$BuildVeinProperties$Cluster" {
	...
	export class $BuildVeinProperties$Cluster extends $BuildVeinProperties {
		constructor(
			blocks: $WorldGenUtils$BlockToWeightedBlockStateMapEntry$$Type[],
			rarity: integer,
			density: float,
			minY: integer,
			maxY: integer,
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$TFCDataEventJS" {
	...
	export class $TFCDataEventJS
		extends $EventJS
		implements
			$IDataConstructor,
			$IBeneathDataExtension,
			$IFirmaLifeDataExtension
	{
		 ...
		 */
		public beneathLostPage(
			cost: $Ingredient$$Type,
			reward: $Item$$Type,
			costs: integer[],
			rewards: integer[],
			punishments: $LostPage$Punishment$$Type[],
			langKey: string,
			name: $ResourceLocation$$Type
		): void;
		/**
		 * Defines a new lost page
		 *
		 ...
		 */
		public beneathNetherFertilizer(
		 ...
		 */
		public climateRange(
			climateRange: $Consumer$$Type<$BuildClimateRangeData$$Type>,
			name: $ResourceLocation$$Type
		): void;
		/**
		 ...
		 */
		public drinkable(
			fluidIngredient: $FluidIngredient$$Type,
			drinkableData: $Consumer$$Type<$BuildDrinkableData$$Type>,
			name: $ResourceLocation$$Type
		): void;
		/**
		 * Defines that a fluid is directly drinkable
		 ...
		 */
		public fauna(
			climate: $Consumer$$Type<$PlacedFeatureProperties$Climate$$Type>,
			fauna: $Consumer$$Type<$BuildFaunaData$$Type>,
			name: $ResourceLocation$$Type
		): void;
		/**
		 ...
		 */
		public firmalifeGreenhouseType(
			ingredient: $BlockIngredient$$Type,
			tier: integer,
			name: $ResourceLocation$$Type
		): void;
		/**
		 ...
		 */
		public firmalifePlantable(
			ingredient: $Ingredient$$Type,
			planterType: $PlanterType$$Type,
			tier: integer,
			stages: integer,
			extraSeedChance: float,
			seed: $ItemStack$$Type,
			crop: $ItemStack$$Type,
			nutrient: $FarmlandBlockEntity$NutrientType$$Type,
			textures: string[],
		...
		public foodItem(
			ingredient: $Ingredient$$Type,
			foodItemData: $Consumer$$Type<$BuildFoodItemData$$Type>
		): void;
		/**
		 * Adds a food definition to the specified ingredient
		 *
		...
		public itemHeat(
			ingredient: $Ingredient$$Type,
			heatCapacity: float,
			forgingTemperature: float,
			weldingTemperature: float,
			name: $ResourceLocation$$Type
		): void;
		/**
		 * Adds a heat definition to the specified ingredient
		...
		public knappingType(
			...
			amountToConsume: integer,
			clickSound: $ResourceLocation$$Type,
			consumeAfterComplete: boolean,
			useDisabledTexture: boolean,
			spawnsParticles: boolean,
			jeiIconItem: $ItemStack$$Type,
			name: $ResourceLocation$$Type
		): void;
		/**
		 * Defines a lamp fuel
		...
		public lampFuel(
			fluidIngredient: $FluidIngredient$$Type,
			blockIngredient: $BlockIngredient$$Type,
			burnRate: integer,
			name: $ResourceLocation$$Type
		): void;
		/**
		...
		public metal(
			fluid: $Fluid$$Type,
			meltTemperature: float,
			heatCapacity: float,
			ingot: $Ingredient$$Type,
			doubleIngot: $Ingredient$$Type,
			sheet: $Ingredient$$Type,
			tier: integer
		): void;
		/**
		 * Defines a metal
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$ISupportExtendedProperties" {
	...
	export interface $ISupportExtendedProperties {
		...
		"extendedProperties"(
			extendedProperties: $Consumer$$Type<$ISupportExtendedProperties$ExtendedPropertiesJS$$Type>
		): $BlockBuilder;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/custom/climate/$KubeJSClimateModel$Builder" {
	...
	import {
		$KubeJSClimateModel$LevelPosLong2FloatCallback,
		$KubeJSClimateModel$LevelPosLong2FloatCallback$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/implementation/custom/climate/$KubeJSClimateModel$LevelPosLong2FloatCallback";
	import { $Vec2 } from "packages/net/minecraft/world/phys/$Vec2";
	import {
		$KubeJSClimateModel$WindVectorCallback,
		$KubeJSClimateModel$WindVectorCallback$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/implementation/custom/climate/$KubeJSClimateModel$WindVectorCallback";
	import { $Noise2D } from "packages/net/dries007/tfc/world/noise/$Noise2D";
	import { $ResourceLocation$$Type } from "packages/net/minecraft/resources/$ResourceLocation";
	import {
		$KubeJSClimateModel$LevelPos2FloatCallback,
		$KubeJSClimateModel$LevelPos2FloatCallback$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/implementation/custom/climate/$KubeJSClimateModel$LevelPos2FloatCallback";
	import {
		$KubeJSClimateModel$OnChunkLoadCallback,
		$KubeJSClimateModel$OnChunkLoadCallback$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/implementation/custom/climate/$KubeJSClimateModel$OnChunkLoadCallback";
	import { $LevelReader$$Type } from "packages/net/minecraft/world/level/$LevelReader";
	import { $Function$$Type } from "packages/java/util/function/$Function";
	import { $Consumer$$Type } from "packages/java/util/function/$Consumer";
	import {
		$KubeJSClimateModel$TemperatureCallback,
		$KubeJSClimateModel$TemperatureCallback$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/implementation/custom/climate/$KubeJSClimateModel$TemperatureCallback";
	...
	export class $KubeJSClimateModel$Builder {
		...
		public newNoise(
			builder: $Function$$Type<$OpenSimplex2D$$Type, $Noise2D>
		): integer;
		...
		public setAirFog(
			callback: $KubeJSClimateModel$LevelPosLong2FloatCallback$$Type
		): void;
		/** Sets how the model will determine the average rainfall at a given position */
		public setAverageRainfallCalculation(
			callback: $KubeJSClimateModel$LevelPos2FloatCallback$$Type
		): void;
		/** Sets how the model will determine the average temperature at a given position */
		public setAverageTemperatureCalculation(
			callback: $KubeJSClimateModel$LevelPos2FloatCallback$$Type
		): void;
		/** Sets how the model will determine the current temperature at a given position and time */
		public setCurrentTemperatureCalculation(
			callback: $KubeJSClimateModel$TemperatureCallback$$Type
		): void;
		/** Sets the model's behavior on chunk load */
		public setOnChunkLoad(
			callback: $KubeJSClimateModel$OnChunkLoadCallback$$Type
		): void;
		...
		public setWindVector(
			callback: $KubeJSClimateModel$WindVectorCallback$$Type
		): void;
		...
		set averageRainfallCalculation(
			value: $KubeJSClimateModel$LevelPos2FloatCallback$$Type
		);
		set averageTemperatureCalculation(
			value: $KubeJSClimateModel$LevelPos2FloatCallback$$Type
		);
		set currentTemperatureCalculation(
			value: $KubeJSClimateModel$TemperatureCallback$$Type
		);
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/bindings/$MiscBindings" {
	...
	import {
		$BlockPos,
		$BlockPos$$Type,
	} from "packages/net/minecraft/core/$BlockPos";
	...
	import {
		$FoodTrait,
		$FoodTrait$$Type,
	} from "packages/net/dries007/tfc/common/capabilities/food/$FoodTrait";
	...
	export class $MiscBindings extends $Enum<$MiscBindings> {
		 ...
		 */
		public applyFoodTrait(
			stack: $ItemStack$$Type,
			trait: $ResourceLocation$$Type
		): void;
		/**
		 ...
		 */
		public canStartCollapse(
			level: $LevelAccessor$$Type,
			pos: $BlockPos$$Type
		): boolean;
		/**
		 ...
		 */
		public findUnsupportedPositions(
			level: $BlockGetter$$Type,
			from: $BlockPos$$Type,
			to: $BlockPos$$Type
		): $Set<$BlockPos>;
		/**
		...
		public getLampFuel(
			fluid: $Fluid$$Type,
			state: $BlockState$$Type
		): $LampFuel;
		/** Returns an iterable of all positions that could possibly be supported around the min and max points */
		public getMaximumSupportedAreaAround(
			minPoint: $BlockPos$$Type,
			maxPoint: $BlockPos$$Type
		): $Iterable<$BlockPos>;
		...
		/** A map associating the name of a wood to its `NamedRegistryWood`, includes AFC woods if it is present */
		 ...
		 */
		public newMetaballs2D(
			random: $RandomSource$$Type,
			minBalls: integer,
			maxBalls: integer,
			minSize: double,
			maxSize: double,
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/bindings/$TFCIngredientBindings" {
	...
	export class $TFCIngredientBindings extends $Enum<$TFCIngredientBindings> {
		 ...
		 */
		public fluid(
			delegate: $Ingredient$$Type,
			fluid: $FluidStackIngredient$$Type
		): $Ingredient;
		/**
		 * Creates an ingredient of type 'tfc:fluid_item'
		 *
...
declare module "packages/com/notenoughmail/kubejs_tfc/item/$GlassBottleItemBuilder" {
	...
	export class $GlassBottleItemBuilder extends $ItemBuilder {
		...
		public breakChanceSupplier(
			chance: $Supplier$$Type<double>
		): $GlassBottleItemBuilder;
		...
		public capacitySupplier(
			capacity: $Supplier$$Type<integer>
		): $GlassBottleItemBuilder;
		...
		public fluidTagAccept(
			tag: $ResourceLocation$$Type
		): $GlassBottleItemBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/bindings/$CalendarBindings" {
	...
	import {
		$Month,
		$Month$$Type,
	} from "packages/net/dries007/tfc/util/calendar/$Month";
	import { $Enum } from "packages/java/lang/$Enum";
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$TFCSaplingBlockBuilder" {
	...
	export class $TFCSaplingBlockBuilder extends $ExtendedPropertiesBlockBuilder {
		...
		public features(
			normal: $ResourceLocation$$Type,
			oldGrowth: $ResourceLocation$$Type
		): $TFCSaplingBlockBuilder;
		...
		public growthDaysSupplier(
			days: $Supplier$$Type<integer>
		): $TFCSaplingBlockBuilder;
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$CreateChunkDataProviderEventJS$AquiferMaker" {
	...
	import {
		$Aquifer,
		$Aquifer$$Type,
	} from "packages/net/minecraft/world/level/levelgen/$Aquifer";
	import {
		$ChunkAccess,
		$ChunkAccess$$Type,
	} from "packages/net/minecraft/world/level/chunk/$ChunkAccess";

	export interface $CreateChunkDataProviderEventJS$AquiferMaker extends $Function<
		$ChunkAccess,
		$Aquifer
	> {
		"andThen"<V>(
			function0: $Function$$Type<$Aquifer$$Type, V>
		): $Function<$ChunkAccess, V>;
		"apply"(access: $ChunkAccess$$Type): $Aquifer;
		"compose"<V>(
			function0: $Function$$Type<V, $ChunkAccess>
		): $Function<V, $Aquifer>;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/sub/$SpreadingCaneBlockBuilder" {
	...
	export class $SpreadingCaneBlockBuilder extends $BlockBuilder {
		constructor(
			i: $ResourceLocation$$Type,
			bush: $SpreadingBushBlockBuilder$$Type
		);
		 ...
		 */
		public allModels(
			modelsCreator: $StationaryBerryBushBlockBuilder$BushModelsCreator$$Type
		): $SpreadingCaneBlockBuilder;
		public createObject(): $Block;
		/** Sets the model for the given lifecycle and stage */
		public model(
			lifecycle: $Lifecycle$$Type,
			stage: integer,
			modelGenerator: $Consumer$$Type<$ModelGenerator$$Type>
		): $SpreadingCaneBlockBuilder;
		/**
		 ...
		 */
		public models(
			models: $StationaryBerryBushBlockBuilder$ModelFunc$$Type
		): $SpreadingCaneBlockBuilder;
...
declare module "packages/com/notenoughmail/kubejs_tfc/item/$GlassworkingToolItemBuilder" {
	...
	export class $GlassworkingToolItemBuilder extends $ToolItemBuilder {
		...
		public operation(
			operation: $GlassOperation$$Type
		): $GlassworkingToolItemBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/data/$BuildDrinkableData" {
	...
	export class $BuildDrinkableData {
		...
		public effect(
			effect: string,
			effectData: $Consumer$$Type<$BuildEffectData$$Type>
		): $BuildDrinkableData;
		/** Adds food data to the drinkable */
		public food(
			foodData: $Consumer$$Type<$BuildFoodItemData$$Type>
		): $BuildDrinkableData;
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$BlockToBlockStateMapEntry" {
	...
	export class $WorldGenUtils$BlockToBlockStateMapEntry extends $Record {
		...
		public static toJson(
			obj: $JsonObject$$Type,
			key: string,
			entries: $WorldGenUtils$BlockToBlockStateMapEntry$$Type[]
		): void;
		public toJson(): $JsonObject;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/$CustomGlassOperations$StackSupplier" {
	...
	export namespace $CustomGlassOperations$StackSupplier {
		function wrap(
			ctx: $Context$$Type,
			o: any
		): $CustomGlassOperations$StackSupplier;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$RegisterFaunasEventJS" {
	...
	export class $RegisterFaunasEventJS extends $EventJS {
		 ...
		 */
		public and(
			entityType: $EntityType$$Type<$Entity$$Type>,
			suffix: string,
			placementType: $SpawnPlacements$Type$$Type,
			heightmap: $Heightmap$Types$$Type
		): void;
		/**
		 * Registers a new fauna definition for the given entity type, does not set the fauna values, use the `TFCEvents.data` server event to do so. ANDs any spawn conditions the entity previously had with the fauna restrictions
		 *
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$CreateChunkDataProviderEventJS" {
	...
	export class $CreateChunkDataProviderEventJS extends $EventJS {
		constructor(seed: long, rs: $RandomState$$Type);
		 ...
		 */
		public erosionalAquifer(
			maker: $CreateChunkDataProviderEventJS$AquiferMaker$$Type
		): void;
		/**
		 ...
		 */
		public full(
			gen: $BiConsumer$$Type<$ChunkData$$Type, $ChunkAccess$$Type>
		): void;
		 ...
		 */
		public rocks(
			rocksGetter: $CreateChunkDataProviderEventJS$RocksGetter$$Type
		): void;
		get worldSeed(): long;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/item/$MoldItemBuilder" {
	...
	export class $MoldItemBuilder
		extends $ItemBuilder
		implements $ITFCCCMoldItemBuilderExtensions
	{
		constructor(i: $ResourceLocation$$Type);
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/$MossGrowingCallback" {
	...
	export interface $MossGrowingCallback {
		"convertToMossy"(
			container: $BlockContainerJS$$Type,
			needsWater: boolean
		): boolean;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/internal/$ExtendedPropertiesMultipartShapedBlockBuilder" {
	...
	export class $ExtendedPropertiesMultipartShapedBlockBuilder
		extends $MultipartShapedBlockBuilder
		implements $ISupportExtendedProperties
	{
		constructor(i: $ResourceLocation$$Type);
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/moss/$MossGrowingSlabBlockBuilder" {
	...
	import {
		$MossGrowingCallback,
		$MossGrowingCallback$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/implementation/$MossGrowingCallback";
	import {
		$ResourceLocation,
		$ResourceLocation$$Type,
	} from "packages/net/minecraft/resources/$ResourceLocation";
	...
	export class $MossGrowingSlabBlockBuilder extends $SlabBlockBuilder {
		...
		public mossyConversion(
			callback: $MossGrowingCallback$$Type
		): $MossGrowingSlabBlockBuilder;
		public mossyConversionFull(
			callback: $MossGrowingCallback$$Type
		): $MossGrowingSlabBlockBuilder;
		public mossyConversionHalf(
			callback: $MossGrowingCallback$$Type
		): $MossGrowingSlabBlockBuilder;
		public mossySlab(
			block: $ResourceLocation$$Type
		): $MossGrowingSlabBlockBuilder;
...
declare module "packages/com/notenoughmail/kubejs_tfc/addons/firmalife/recipe/js/$MixingBowlRecipeJS" {
	...
	export class $MixingBowlRecipeJS extends $TFCRecipeJS {
		...
		public fluidIngredient(
			fluidIngredient: $FluidStackIngredient$$Type
		): $MixingBowlRecipeJS;
		public getMod(): string;
		public ingredients(
			ingredients: $InputItem$$Type[],
			fluidIngredient: $FluidStackIngredient$$Type
		): $MixingBowlRecipeJS;
		...
		public outputs(
			outputItem: $OutputItem$$Type,
			outputFluid: $OutputFluid$$Type
		): $MixingBowlRecipeJS;
		get mod(): string;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$LampBlockBuilder" {
	...
	export class $LampBlockBuilder extends $ExtendedPropertiesBlockBuilder {
		...
		public models(
			models: $BiConsumer$$Type<
				$LampBlockBuilder$LampModelType$$Type,
				$ModelGenerator$$Type
			>
		): $LampBlockBuilder;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/recipe/component/$AlloyPartComponent$AlloyPart" {
	...
	export class $AlloyPartComponent$AlloyPart extends $Record {
		constructor(metal: string, min: double, max: double);

		public static fromJson(
			json: $JsonObject$$Type
		): $AlloyPartComponent$AlloyPart;
		public max(): double;
		public metal(): string;
		public min(): double;
		public toJson(): $JsonObject;
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/custom/world/$WrappedChunkGenerator" {
	...
	import {
		$ChunkGenerator,
		$ChunkGenerator$$Type,
	} from "packages/net/minecraft/world/level/chunk/$ChunkGenerator";
	...
	import {
		$Settings,
		$Settings$$Type,
	} from "packages/net/dries007/tfc/world/settings/$Settings";
	...
	export class $WrappedChunkGenerator
		...
		implements $ChunkGeneratorExtension
	{
		...
		public findSpawnBiome(randomSource0: $RandomSource$$Type): $BlockPos;
		public static getFromStructureState(
			chunkGeneratorStructureState0: $ChunkGeneratorStructureState$$Type
		): $ChunkGeneratorExtension;
		...
		public initRandomState(
			chunkMap: $ChunkMap$$Type,
			level: $ServerLevel$$Type
		): void;
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$ForestTypesMapEntry" {
	...
	import {
		$ForestType,
		$ForestType$$Type,
	} from "packages/net/dries007/tfc/world/chunkdata/$ForestType";
	import {
		$IntProvider,
		$IntProvider$$Type,
	} from "packages/net/minecraft/util/valueproviders/$IntProvider";

	export class $WorldGenUtils$ForestTypesMapEntry extends $Record {
		constructor(
			type: $ForestType$$Type,
			treeCount: $IntProvider$$Type,
			groundcoverCount: $IntProvider$$Type,
			perChunkChance: float,
			bushCount: $IntProvider$$Type,
			hasSpoilerOldGrowth: boolean,
			allowsOldGrowth: boolean,
			leafPileCount: $IntProvider$$Type
		);
...
declare module "packages/com/notenoughmail/kubejs_tfc/addons/firmalife/block/$CheeseWheelBlockBuilder" {
	...
	export class $CheeseWheelBlockBuilder extends $ExtendedPropertiesShapedBlockBuilder {
		constructor(i: $ResourceLocation$$Type);
		...
		public sliceItem(
			slice: $Consumer$$Type<$ItemBuilder$$Type>
		): $CheeseWheelBlockBuilder;
...
declare module "packages/com/notenoughmail/kubejs_tfc/fluid/$HotWaterFluidBuilder" {
	...
	export class $HotWaterFluidBuilder extends $FluidBuilder {
		...
		public bubbleParticle(
			particle: $ResourceLocation$$Type
		): $HotWaterFluidBuilder;
		/**
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/sub/$DeadCropBlockBuilder" {
	...
	export class $DeadCropBlockBuilder extends $ExtendedPropertiesBlockBuilder {
		constructor(
			i: $ResourceLocation$$Type,
			alive: $AbstractCropBlockBuilder$$Type
		);
		...
		public models(
			models: $BiConsumer$$Type<
				$DeadCropBlockBuilder$DeadModelVariant$$Type,
				$ModelGenerator$$Type
			>
		): $DeadCropBlockBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$RockSpikeBlockBuilder" {
	...
	export class $RockSpikeBlockBuilder extends $BlockBuilder {
		...
		public models(
			models: $BiConsumer$$Type<
				$RockSpikeBlockBuilder$SpikeModelType$$Type,
				$ModelGenerator$$Type
			>
		): $RockSpikeBlockBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$DoubleCropBlockBuilder" {
	...
	export class $DoubleCropBlockBuilder extends $AbstractCropBlockBuilder {
		...
		public setStickModel(
			stage: integer,
			gen: $Consumer$$Type<$ModelGenerator$$Type>
		): $DoubleCropBlockBuilder;
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/sub/$GearBoxBlockBuilder" {
	...
	export class $GearBoxBlockBuilder extends $ExtendedPropertiesMultipartShapedBlockBuilder {
		...
		public models(
			models: $BiConsumer$$Type<
				$GearBoxBlockBuilder$GearBoxModelType$$Type,
				$ModelGenerator$$Type
			>
		): $GearBoxBlockBuilder;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$TreePlacement" {
	import { $JsonObject } from "packages/com/google/gson/$JsonObject";
	import {
		$TreePlacementConfig$GroundType,
		$TreePlacementConfig$GroundType$$Type,
	} from "packages/net/dries007/tfc/world/feature/tree/$TreePlacementConfig$GroundType";
	import { $Record } from "packages/java/lang/$Record";
	...
	export class $WorldGenUtils$TreePlacement extends $Record {
		constructor(
			width: integer,
			height: integer,
			groundType: $TreePlacementConfig$GroundType$$Type
		);
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/sub/$FallenLeavesBlockBuilder" {
	import { $BiConsumer$$Type } from "packages/java/util/function/$BiConsumer";
	import {
		$TFCLeavesBlockBuilder,
		$TFCLeavesBlockBuilder$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/block/$TFCLeavesBlockBuilder";
	import { $BlockBehaviour$Properties } from "packages/net/minecraft/world/level/block/state/$BlockBehaviour$Properties";
	...
	export class $FallenLeavesBlockBuilder
		extends $ExtendedPropertiesBlockBuilder
		implements $ILeafBuilder
	{
		readonly "parent": $TFCLeavesBlockBuilder;

		constructor(
			i: $ResourceLocation$$Type,
			parent: $TFCLeavesBlockBuilder$$Type
		);
		...
		public models(
			models: $BiConsumer$$Type<
				$FallenLeavesBlockBuilder$FallenLeafModelType$$Type,
				$ModelGenerator$$Type
			>
		): $FallenLeavesBlockBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/internal/$ExtendedPropertiesBlockBuilder" {
	...
	export class $ExtendedPropertiesBlockBuilder
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$BlockToBlockStatesMapEntry" {
	...
	export class $WorldGenUtils$BlockToBlockStatesMapEntry extends $Record {
		...
		public static toJson(
			...
			key: string,
			blockKey: string,
			entries: $WorldGenUtils$BlockToBlockStatesMapEntry$$Type[]
		): void;
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$StationaryBerryBushBlockBuilder" {
	...
	import {
		$Lifecycle,
		$Lifecycle$$Type,
	} from "packages/net/dries007/tfc/common/blocks/plant/fruit/$Lifecycle";
	import { $ResourceLocation$$Type } from "packages/net/minecraft/resources/$ResourceLocation";
	import { $Block } from "packages/net/minecraft/world/level/block/$Block";
	...
	export class $StationaryBerryBushBlockBuilder extends $ExtendedPropertiesBlockBuilder {
		...
		public allModels(
			modelsCreator: $StationaryBerryBushBlockBuilder$BushModelsCreator$$Type
		): $StationaryBerryBushBlockBuilder;
		public createObject(): $Block;
		public createProperties(): $BlockBehaviour$Properties;
		/**
		...
		public productItem(
			productId: $ResourceLocation$$Type
		): $StationaryBerryBushBlockBuilder;
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/$ItemStackProviderJS" {
	...
	import {
		$CompoundTag,
		$CompoundTag$$Type,
	} from "packages/net/minecraft/nbt/$CompoundTag";
	...
	import {
		$JsonArray,
		$JsonArray$$Type,
	} from "packages/com/google/gson/$JsonArray";
	import { $BuildFoodItemData$$Type } from "packages/com/notenoughmail/kubejs_tfc/util/implementation/data/$BuildFoodItemData";
	...
	} from "packages/dev/latvian/mods/kubejs/recipe/$ReplacementMatch";
	...
	export class $ItemStackProviderJS
		extends $Record
		implements $OutputReplacement, $ReplacementMatch, $IFirmaLifeISPExtensions
	{
		 ...
		 */
		public meal(
			food: $Consumer$$Type<$BuildFoodItemData$$Type>,
			portions: $Consumer$$Type<$BuildPortionData$$Type>[]
		): $ItemStackProviderJS;
		/**
		 * Adds a 'tfc:meal' modifier to the ISP
		 *
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$SpreadingBushBlockBuilder" {
	...
	export class $SpreadingBushBlockBuilder extends $StationaryBerryBushBlockBuilder {
		...
		public cane(
			cane: $Consumer$$Type<$SpreadingCaneBlockBuilder$$Type>
		): $SpreadingBushBlockBuilder;
		public createProperties(): $BlockBehaviour$Properties;
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$Root" {
	import { $JsonObject } from "packages/com/google/gson/$JsonObject";
	import {
		$WorldGenUtils$BlockToWeightedBlockStateMapEntry,
		$WorldGenUtils$BlockToWeightedBlockStateMapEntry$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$BlockToWeightedBlockStateMapEntry";
	import { $Record } from "packages/java/lang/$Record";
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$RegisterInteractionsEventJS" {
	...
	import {
		$Block,
		$Block$$Type,
	} from "packages/net/minecraft/world/level/block/$Block";
	...
	export class $RegisterInteractionsEventJS extends $EventJS {
		...
		public static addBlockItemPlacement(
			item: $Supplier$$Type<$Item>,
			block: $Supplier$$Type<$Block>
		): void;
		/**
		...
		public interaction(
			ingredient: $Ingredient$$Type,
			action: $InteractionManager$OnItemUseAction$$Type
		): void;
		/**
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/custom/climate/$KubeJSClimateModel$OnChunkLoadCallback" {
	...
	export interface $KubeJSClimateModel$OnChunkLoadCallback {
		 ...
		 */
		"apply"(
			level: $WorldGenLevel$$Type,
			chunk: $ChunkAccess$$Type,
			chunkData: $ChunkData$$Type
		): void;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$PickableCropBlockBuilder" {
	...
	export class $PickableCropBlockBuilder extends $AbstractCropBlockBuilder {
		...
		public matureFruit(
			matureFruit: $ResourceLocation$$Type
		): $PickableCropBlockBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$ModifyDefaultWorldGenSettingsEventJS" {
	...
	import {
		$RockSettings,
		$RockSettings$$Type,
	} from "packages/net/dries007/tfc/world/settings/$RockSettings";
...
declare module "packages/com/notenoughmail/kubejs_tfc/recipe/js/$InstantBarrelRecipeJS" {
	...
	export class $InstantBarrelRecipeJS extends $BarrelRecipeJS {
		...
		public inputFluid(
			inputFluid: $FluidStackIngredient$$Type
		): $InstantBarrelRecipeJS;
		...
		public outputItem(
			outputItem: $ItemStackProviderJS$$Type
		): $InstantBarrelRecipeJS;
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/helpers/ducks/$IChunkGenWrapper" {
	import {
		...
		$WrappedChunkGenerator$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/implementation/custom/world/$WrappedChunkGenerator";
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$TFCTorchBlockBuilder" {
	...
	export class $TFCTorchBlockBuilder extends $ExtendedPropertiesShapedBlockBuilder {
		...
		public dead(
			dead: $Consumer$$Type<$DeadTorchBuilder$$Type>
		): $TFCTorchBlockBuilder;
		/** Sets the properties for the dead item, may be null to remove */
		public deadItem(
			item: $Consumer$$Type<$ItemBuilder$$Type>
		): $TFCTorchBlockBuilder;
		...
		public deadWall(
			deadWall: $Consumer$$Type<$DeadWallTorchBuilder$$Type>
		): $TFCTorchBlockBuilder;
		...
		public decayLengthSupplier(
			length: $Supplier$$Type<integer>
		): $TFCTorchBlockBuilder;
		/** Sets the torch's flame particle, may be null to not have one */
		public flameParticle(
			particle: $ResourceLocation$$Type
		): $TFCTorchBlockBuilder;
		public static randomTick(
			level: $ServerLevel$$Type,
			pos: $BlockPos$$Type,
			place: $BlockState$$Type,
			decayLength: $Supplier$$Type<integer>
		): void;
		...
		public wall(
			wall: $Consumer$$Type<$TFCWallTorchBuilder$$Type>
		): $TFCTorchBlockBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/sub/$FallenLeavesBlockBuilder$FallenLeafModelType" {
	...
	export class $FallenLeavesBlockBuilder$FallenLeafModelType extends $Enum<$FallenLeavesBlockBuilder$FallenLeafModelType> {
		...
		public static valueOf(
			name: string
		): $FallenLeavesBlockBuilder$FallenLeafModelType;
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$StationaryBerryBushBlockBuilder$ModelFunc" {
	...
	export interface $StationaryBerryBushBlockBuilder$ModelFunc {
		"andThen"(
			func: $StationaryBerryBushBlockBuilder$ModelFunc$$Type
		): $StationaryBerryBushBlockBuilder$ModelFunc;
		"apply"(
			lifecycle: $Lifecycle$$Type,
			stage: integer,
			generator: $ModelGenerator$$Type
		): void;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$SupportBlockBuilder" {
	...
	export class $SupportBlockBuilder extends $ExtendedPropertiesMultipartShapedBlockBuilder {
		...
		public horizontal(
			horizontalSupport: $Consumer$$Type<$HorizontalSupportBlockBuilder$$Type>
		): $SupportBlockBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/item/$JavelinItemBuilder" {
	...
	export class $JavelinItemBuilder extends $HandheldItemBuilder {
		 ...
		 */
		public modelAtPerspective(
			perspective: $ItemDisplayContext$$Type,
			model: string
		): $JavelinItemBuilder;
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$ISupportExtendedProperties$ExtendedPropertiesJS" {
	...
	export class $ISupportExtendedProperties$ExtendedPropertiesJS extends $Record {
		...
		public destroyTime(
			destroyTime: float
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public dropsLike(
			block: $ISupportExtendedProperties$BlockSupplier$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public dynamicShape(): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public emissiveRendering(
			emissiveRendering: $BlockBehaviour$StatePredicate$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		/**
		 ...
		 */
		public enchantPowerFunction(
			function_: $ToDoubleFunction$$Type<$BlockState$$Type>
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		 ...
		 */
		public flammable(
			flammability: integer,
			fireSpreadSpeed: integer
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		...
		public hasPostProcess(
			hasPostProcess: $BlockBehaviour$StatePredicate$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		...
		public instrument(
			inst: $NoteBlockInstrument$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public isRedstoneConductor(
			isRedstoneConductor: $BlockBehaviour$StatePredicate$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public isSuffocating(
			isSuffocating: $BlockBehaviour$StatePredicate$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public isValidSpawn(
			isValidSpawn: $BlockBehaviour$StateArgumentPredicate$$Type<
				$EntityType$$Type<any>
			>
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public isViewBlocking(
			isViewBlocking: $BlockBehaviour$StatePredicate$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public jumpFactor(
			jumpFactor: float
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public lightLevel(
			lightLevel: $ToIntFunction$$Type<$BlockState$$Type>
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public mapColor(
			mapColor: $ISupportExtendedProperties$MapColorFunction$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public mapColor(
			color: $MapColor$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		...
		public offsetType(
			type: $BlockBehaviour$OffsetType$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		/**
		 ...
		 */
		public pathType(
			pathType: $BlockPathTypes$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
		public pushReaction(
			reaction: $PushReaction$$Type
		): $ISupportExtendedProperties$ExtendedPropertiesJS;
...
declare module "packages/com/notenoughmail/kubejs_tfc/addons/firmalife/recipe/js/$VatRecipeJS" {
	...
	export class $VatRecipeJS extends $TFCProviderRecipeJS {
		...
		public outputs(
			itemOutput: $ItemStackProviderJS$$Type,
			outputFluid: $OutputFluid$$Type
		): $VatRecipeJS;
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$AnimalProductEventJS" {
	...
	import {
		$FluidStackJS,
		$FluidStackJS$$Type,
	} from "packages/dev/latvian/mods/kubejs/fluid/$FluidStackJS";
...
declare module "packages/com/notenoughmail/kubejs_tfc/item/$ToolItemBuilder" {
	...
	export class $ToolItemBuilder extends $HandheldItemBuilder {
		...
		public mineableBlocksTag(
			blockTag: $ResourceLocation$$Type
		): $ToolItemBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$CreateGlassOperationsEventJS" {
	...
	export class $CreateGlassOperationsEventJS extends $EventJS {
		constructor(
			...
			invoker: $BiFunction$$Type<string, integer, $GlassOperation>
		);
		...
		public create(
			name: string,
			displayStack: $CustomGlassOperations$StackSupplier$$Type,
			customSound: $ResourceLocation$$Type
		): void;
		/**
		 * Creates a new glass operation
		 *
		 ...
		 */
		public createPowder(
			powderItemId: $ResourceLocation$$Type,
			name: string,
			customSound: $ResourceLocation$$Type,
			minHeat: float
		): void;
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/$NamedRegistryWood" {
	...
	} from "packages/net/minecraft/util/$StringRepresentable";
	import { $Function$$Type } from "packages/java/util/function/$Function";
	...
	import {
		$RegistryWood,
		$RegistryWood$$Type,
	} from "packages/net/dries007/tfc/util/registry/$RegistryWood";
	import {
		$Supplier,
		$Supplier$$Type,
	...
	export class $NamedRegistryWood implements $RegistryWood {
		...
		public static fromEnum<E extends $Enum<E> & $StringRepresentable>(
			supplier0: $Supplier$$Type<E[]>
		): $StringRepresentable$EnumCodec<E>;
		public static fromEnumWithMapping<
			E extends $Enum<E> & $StringRepresentable,
		>(
			supplier0: $Supplier$$Type<E[]>,
			function1: $Function$$Type<string, string>
		): $StringRepresentable$EnumCodec<E>;
		...
		public static keys(
			stringRepresentable0s: $StringRepresentable$$Type[]
		): $Keyable;
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/worldgen/$PlacedFeatureProperties" {
	...
	import { $Heightmap$Types$$Type } from "packages/net/minecraft/world/level/levelgen/$Heightmap$Types";
	import {
		$PlacedFeatureProperties$Climate,
		$PlacedFeatureProperties$Climate$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/implementation/worldgen/$PlacedFeatureProperties$Climate";
	...
	export class $PlacedFeatureProperties {
		...
		public static buildClimate(
			c: $Consumer$$Type<$PlacedFeatureProperties$Climate$$Type>
		): $PlacedFeatureProperties$Climate;
		/**
		 ...
		 */
		public flatEnough(
			flatness: $Consumer$$Type<$PlacedFeatureProperties$Flatness$$Type>
		): $PlacedFeatureProperties;
		/**
...
declare module "packages/com/notenoughmail/kubejs_tfc/addons/precpros/item/$ProspectorItemBuilder" {
	...
	export class $ProspectorItemBuilder extends $HandheldItemBuilder {
		...
		public displacement(
			supplier: $Supplier$$Type<integer>
		): $ProspectorItemBuilder;
		public primaryRadius(
			supplier: $Supplier$$Type<integer>
		): $ProspectorItemBuilder;
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/$KubeJSItemStackModifier$WithInventoryApplicator" {
	...
	export interface $KubeJSItemStackModifier$WithInventoryApplicator extends $KubeJSItemStackModifier$ModifierApplicator {
		...
		"apply"(
			stack: $ItemStack$$Type,
			input: $ItemStack$$Type,
			inventory: $Iterable$$Type<$ItemStack$$Type>
		): $ItemStack;
...
declare module "packages/com/notenoughmail/kubejs_tfc/recipe/js/$SimplePotRecipeJS" {
	...
	export class $SimplePotRecipeJS
		extends $PotRecipeJS
		implements $ISupportProviderOutput
	{
		constructor();
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$TFCLeavesBlockBuilder" {
	...
	export class $TFCLeavesBlockBuilder
		extends $ExtendedPropertiesBlockBuilder
		implements $ILeafBuilder
	{
		constructor(i: $ResourceLocation$$Type);
		...
		public fallenLeaves(
			fallenLeaves: $Consumer$$Type<$FallenLeavesBlockBuilder$$Type>
		): $TFCLeavesBlockBuilder;
		public get(): $Block;
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$BlockToWeightedBlockStateMapEntry" {
	...
	export class $WorldGenUtils$BlockToWeightedBlockStateMapEntry extends $Record {
		...
		public static toJson(
			obj: $JsonObject$$Type,
			key: string,
			entries: $WorldGenUtils$BlockToWeightedBlockStateMapEntry$$Type[]
		): void;
		public toJson(): $JsonObject;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/sub/$ClutchBlockBuilder" {
	...
	export class $ClutchBlockBuilder extends $ExtendedPropertiesBlockBuilder {
		...
		public models(
			models: $BiConsumer$$Type<
				$ClutchBlockBuilder$ClutchModelType$$Type,
				$ModelGenerator$$Type
			>
		): $ClutchBlockBuilder;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/recipe/js/$SealedBarrelRecipeJS" {
	...
	export class $SealedBarrelRecipeJS extends $BarrelRecipeJS {
		 ...
		 */
		public onUnseal(
			onUnseal: $ItemStackProviderJS$$Type
		): $SealedBarrelRecipeJS;
		/** Sets the recipe's output fluid */
		...
		public seal(
			onSeal: $ItemStackProviderJS$$Type,
			onUnseal: $ItemStackProviderJS$$Type
		): $SealedBarrelRecipeJS;
		/**
		 * Sets the sound event the barrel will play when the recipe finishes
...
declare module "packages/com/notenoughmail/kubejs_tfc/recipe/js/$HeatingRecipeJS" {
	...
	export class $HeatingRecipeJS extends $TFCProviderRecipeJS {
		...
		/** Sets the recipe's output ItemStackProvider and fluid */
		public results(
			resultItem: $ItemStackProviderJS$$Type,
			resultFluid: $OutputFluid$$Type
		): $HeatingRecipeJS;
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$AqueductBlockBuilder" {
	...
	export class $AqueductBlockBuilder extends $MultipartShapedBlockBuilder {
		 ...
		 */
		public allowedFluids(
			fluids: $ResourceLocation$$Type[]
		): $AqueductBlockBuilder;
		public createObject(): $Block;
		/**
		...
		public models(
			models: $BiConsumer$$Type<
				$AqueductBlockBuilder$AqueductModelPart$$Type,
				$ModelGenerator$$Type
			>
		): $AqueductBlockBuilder;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/sub/$ConnectedGrassBlockBuilder$GrassModelPart" {
	...
	export class $ConnectedGrassBlockBuilder$GrassModelPart extends $Enum<$ConnectedGrassBlockBuilder$GrassModelPart> {
		...
		public static valueOf(
			name: string
		): $ConnectedGrassBlockBuilder$GrassModelPart;
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$RockSettingsEventJS" {
	...
	export class $RockSettingsEventJS extends $StartupEventJS {
		...
		public defineRock(
			...
			cobble: $Block$$Type,
			sand: $Block$$Type,
			sandstone: $Block$$Type,
			spike: $Block$$Type,
			loose: $Block$$Type,
			mossyLoose: $Block$$Type
		): $RockSettings;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/$TFCDirtBlockBuilder" {
	...
	import {
		$BlockBuilder,
		$BlockBuilder$$Type,
	} from "packages/dev/latvian/mods/kubejs/block/$BlockBuilder";
	import { $Consumer$$Type } from "packages/java/util/function/$Consumer";
	...
	export class $TFCDirtBlockBuilder extends $BlockBuilder {
		...
		public farmland(
			farmland: $Consumer$$Type<$TFCFarmlandBlockBuilder$$Type>
		): $TFCDirtBlockBuilder;
		/** Sets the properties of the dirt's grass block */
		public grass(
			grass: $Consumer$$Type<$ConnectedGrassBlockBuilder$$Type>
		): $TFCDirtBlockBuilder;
		...
		public path(
			path: $Consumer$$Type<$TFCPathBlockBuilder$$Type>
		): $TFCDirtBlockBuilder;
		/** Creates and sets the properties of the dirt's rooted dirt block */
		public rooted(
			rooted: $Consumer$$Type<$TFCRootedDirtBlockBuilder$$Type>
		): $TFCDirtBlockBuilder;
	}
}
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$CreateChunkDataProviderEventJS$RocksGetter" {
	...
	export interface $CreateChunkDataProviderEventJS$RocksGetter {
		...
		"generate"(
			...
			z: integer,
			surfaceY: integer,
			cache: $ChunkRockDataCache$$Type,
			rockLayers: $RockLayerSettings$$Type
		): $RockSettings;
	}
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$SelectClimateModelEventJS" {
	import {
		$ClimateModel,
		$ClimateModel$$Type,
	} from "packages/net/dries007/tfc/util/climate/$ClimateModel";
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$TFCWorldgenDataEventJS" {
	import {
		$WorldGenUtils$BlockToBlockStatesMapEntry,
		$WorldGenUtils$BlockToBlockStatesMapEntry$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$BlockToBlockStatesMapEntry";
	import { $JsonObject$$Type } from "packages/com/google/gson/$JsonObject";
	import {
		$WorldGenUtils$ForestTypesMapEntry,
		$WorldGenUtils$ForestTypesMapEntry$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$ForestTypesMapEntry";
	import {
		$WorldGenUtils$TreeLayer,
		$WorldGenUtils$TreeLayer$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$TreeLayer";
	import {
		$WorldGenUtils$BlockToBlockStateMapEntry,
		$WorldGenUtils$BlockToBlockStateMapEntry$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$BlockToBlockStateMapEntry";
	import {
		$WorldGenUtils$FissureDecoration,
		$WorldGenUtils$FissureDecoration$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$FissureDecoration";
	...
	import {
		$WorldGenUtils$TreePlacement,
		$WorldGenUtils$TreePlacement$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$TreePlacement";
	import {
		$WorldGenUtils$Root,
		$WorldGenUtils$Root$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$Root";
	import { $IDataConstructor } from "packages/com/notenoughmail/kubejs_tfc/util/helpers/ducks/extensions/$IDataConstructor";
	...
	import {
		$WorldGenUtils$Trunk,
		$WorldGenUtils$Trunk$$Type,
	} from "packages/com/notenoughmail/kubejs_tfc/util/$WorldGenUtils$Trunk";
	import { $DataPackEventJS$$Type } from "packages/dev/latvian/mods/kubejs/script/data/$DataPackEventJS";
	import { $PlacedFeatureProperties$Climate$$Type } from "packages/com/notenoughmail/kubejs_tfc/util/implementation/worldgen/$PlacedFeatureProperties$Climate";
	...
	export class $TFCWorldgenDataEventJS
		extends $EventJS
		implements $IDataConstructor
	{
		constructor(wrapped: $DataPackEventJS$$Type);
		...
		public babyBoulder(
			name: string,
			states: $WorldGenUtils$BlockToBlockStatesMapEntry$$Type[],
			placement: $Consumer$$Type<$PlacedFeatureProperties$$Type>
		): void;
		/**
		 ...
		 */
		public blockToWeightedBlockState(
			blocks: string[],
			blockStates: string[]
		): $WorldGenUtils$BlockToWeightedBlockStateMapEntry;
		/**
		...
		public clusterVein(
			name: string,
			replacementMap: $WorldGenUtils$BlockToWeightedBlockStateMapEntry$$Type[],
			rarity: integer,
			density: float,
			minY: integer,
			maxY: integer,
			size: integer,
			optionals: $Consumer$$Type<$BuildVeinProperties$Cluster$$Type>,
			placement: $Consumer$$Type<$PlacedFeatureProperties$$Type>
		): void;
		/**
		 * Creates a 'tfc:cluster_vein' configured feature and the matching placed feature
		...
		public discVein(
			...
			size: integer,
			height: integer,
			optionals: $Consumer$$Type<$BuildVeinProperties$Disc$$Type>,
			placement: $Consumer$$Type<$PlacedFeatureProperties$$Type>
		): void;
		/**
		...
		public fissure(
			...
			count: integer,
			radius: integer,
			minDepth: $JsonObject$$Type,
			minPieces: integer,
			maxPieces: integer,
			maxPieceLength: integer,
			fissureDecoration: $WorldGenUtils$FissureDecoration$$Type,
			placement: $Consumer$$Type<$PlacedFeatureProperties$$Type>
		): void;
		/**
		...
		public forest(
			name: string,
			entriesTag: string,
			types: $WorldGenUtils$ForestTypesMapEntry$$Type[],
			useWeirdness: boolean,
			placement: $Consumer$$Type<$PlacedFeatureProperties$$Type>
		): void;
		/**
		...
		public forestEntry(
			...
			oldGrowthTreeFeature: string,
			krummholzFeature: string,
			oldGrowthChance: integer,
			spoilerOldGrowthChance: integer,
			fallenTreeChance: integer,
			deadChance: integer,
			floating: boolean,
			placement: $Consumer$$Type<$PlacedFeatureProperties$$Type>
		): void;
		...
		public hotSpring(
			...
			replacesOnFluidContact: $WorldGenUtils$BlockToWeightedBlockStateMapEntry$$Type[],
			decoration: $WorldGenUtils$FissureDecoration$$Type,
			placement: $Consumer$$Type<$PlacedFeatureProperties$$Type>
		): void;
		/**
		...
		public krummholz(
			name: string,
			block: string,
			height: $IntProvider$$Type,
			spawnsOnStone: boolean,
			spawnsOnGravel: boolean,
			placement: $Consumer$$Type<$PlacedFeatureProperties$$Type>
		): void;
		/**
		...
		public overlayTree(
			...
			trunk: $WorldGenUtils$Trunk$$Type,
			overlayIntegrity: float,
			treePlacement: $WorldGenUtils$TreePlacement$$Type,
			rootSystem: $WorldGenUtils$Root$$Type,
			placement: $Consumer$$Type<$PlacedFeatureProperties$$Type>
		): void;
		/**
		...
		public pipeVein(
			...
			maxSlant: integer,
			sign: float,
			optionals: $Consumer$$Type<$BuildVeinProperties$Pipe$$Type>,
			placement: $Consumer$$Type<$PlacedFeatureProperties$$Type>
		): void;
		/**
		...
		public soilDisc(
			name: string,
			replacementMap: $WorldGenUtils$BlockToBlockStateMapEntry$$Type[],
			minRadius: integer,
			maxRadius: integer,
			height: integer,
			integrity: float,
		...
		public stackedTree(
			name: string,
			layers: $WorldGenUtils$TreeLayer$$Type[],
			trunk: $WorldGenUtils$Trunk$$Type,
			treePlacement: $WorldGenUtils$TreePlacement$$Type,
			rootSystem: $WorldGenUtils$Root$$Type,
			placement: $Consumer$$Type<$PlacedFeatureProperties$$Type>
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$LoggingEventJS" {
	...
	import {
		$Level,
		$Level$$Type,
	} from "packages/net/minecraft/world/level/$Level";
	import { $ItemStack } from "packages/net/minecraft/world/item/$ItemStack";
	import { $BlockContainerJS } from "packages/dev/latvian/mods/kubejs/level/$BlockContainerJS";
	import { $BlockPos } from "packages/net/minecraft/core/$BlockPos";
...
declare module "packages/com/notenoughmail/kubejs_tfc/block/internal/$ExtendedPropertiesShapedBlockBuilder" {
	...
	export class $ExtendedPropertiesShapedBlockBuilder
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$ContainerLimiterEventJS" {
	...
	export class $ContainerLimiterEventJS extends $EventJS {
		constructor(
			slotsToLimit: $List$$Type<$Slot$$Type>,
			level: $Level$$Type,
			spawnPos: $BlockPos$$Type
		);
...
declare module "packages/com/notenoughmail/kubejs_tfc/util/implementation/bindings/$TFCBindings" {
	...
	import {
		$BlockIngredient,
		$BlockIngredient$$Type,
	} from "packages/net/dries007/tfc/common/recipes/ingredients/$BlockIngredient";
	import {
		$FluidIngredient,
		$FluidIngredient$$Type,
	} from "packages/net/dries007/tfc/common/recipes/ingredients/$FluidIngredient";
	...
	import {
		...
		$FluidStackIngredient$$Type,
	} from "packages/net/dries007/tfc/common/recipes/ingredients/$FluidStackIngredient";
	...
	export class $TFCBindings {
		...
		public static alloyPart(
			metal: string,
			min: double,
			max: double
		): $AlloyPartComponent$AlloyPart;
		/** Explicitly creates a block ingredient */
		public static blockIngredient(
			blockIngredient: $BlockIngredient$$Type
		): $BlockIngredient;
		/** Explicitly creates a fluid ingredient */
		public static fluidIngredient(
			fluidIngredient: $FluidIngredient$$Type
		): $FluidIngredient;
		/** Explicitly creates a fluid stack ingredient */
		public static fluidStackIngredient(
			fluidStackIngredient: $FluidStackIngredient$$Type
		): $FluidStackIngredient;
		/** Explicitly creates a fluid stack ingredient */
		public static fluidStackIngredient(
			fluidIngredient: $FluidIngredient$$Type,
...
declare module "packages/com/notenoughmail/kubejs_tfc/event/$RegisterClimateModelEventJS" {
	...
	export class $RegisterClimateModelEventJS extends $StartupEventJS {
		...
		public register(
			name: $ResourceLocation$$Type,
			model: $Consumer$$Type<$KubeJSClimateModel$Builder$$Type>
		): void;
	}
}
