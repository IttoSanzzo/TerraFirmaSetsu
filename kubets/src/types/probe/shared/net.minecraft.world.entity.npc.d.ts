...
public "handler$fkj000$registerGoals"(ci: $CallbackInfo$$Type): void
...
public "handler$fbn000$replaceRandom"(merchantOffers0: $MerchantOffers$$Type, itemListing1s: $VillagerTrades$ItemListing$$Type[], int2: integer, callbackInfo3: $CallbackInfo$$Type, localRef4: $LocalRef$$Type<any>): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
public "isAmbientCreature"(): boolean
public "isAnimal"(): boolean
...
public "mergeNbt"(tag: $CompoundTag$$Type): $Entity
public "modifyAttribute"(attribute: $Attribute$$Type, identifier: string, d: double, operation: $AttributeModifier$Operation$$Type): void
public "modifyExpressionValue$fbn000$replaceRandom"(randomSource0: $RandomSource$$Type, merchantOffers1: $MerchantOffers$$Type, localRef2: $LocalRef$$Type<any>): $RandomSource
public "modifyExpressionValue$fbn000$setTierForOffer"(merchantOffer0: $MerchantOffer$$Type): $MerchantOffer
public "moveInFluid"(fluidState0: $FluidState$$Type, vec31: $Vec3$$Type, double2: double): boolean
...
public "handler$ffl000$resetRestocks"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$ffl000$restock"(callbackInfo0: $CallbackInfo$$Type): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
