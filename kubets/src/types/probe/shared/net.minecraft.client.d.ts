...
public "handler$deb000$onRunTickStart"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$eak000$inject$pause"(boolean0: boolean, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ebd000$handleInputEvents"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$fbd000$injectRunTick"(boolean0: boolean, callbackInfo1: $CallbackInfo$$Type): void
public "handler$gbi000$stop"(callbackInfo0: $CallbackInfo$$Type): void
...
public "modify$deb000$onRenderCall"(boolean0: boolean): boolean
...
public "redirect$fbm000$fixUpdateURLs"(renderTarget0: $RenderTarget$$Type, boolean1: boolean): void
...
public "handler$gbd000$onGetCameraType"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
...
public "handler$dbn000$adastra$update"(area: $BlockGetter$$Type, focusedEntity: $Entity$$Type, thirdPerson: boolean, inverseView: boolean, tickDelta: float, ci: $CallbackInfo$$Type): void
public "handler$fkn000$supplementaries$setupCannonCamera"(level: $BlockGetter$$Type, entity: $Entity$$Type, detached: boolean, thirdPersonReverse: boolean, partialTick: float, ci: $CallbackInfo$$Type): void
...
public "handler$eim000$redirect$handleFullScreenToggle"(long0: long, int1: integer, int2: integer, int3: integer, int4: integer, callbackInfo5: $CallbackInfo$$Type): void
...
public "handler$dda000$turnPlayer"(callbackInfo0: $CallbackInfo$$Type): void
