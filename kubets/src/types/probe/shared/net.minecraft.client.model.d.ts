...
public "handler$emj000$render"(poseStack: $PoseStack$$Type, vertexConsumer: $VertexConsumer$$Type, light: integer, overlay: integer, red: float, green: float, blue: float, alpha: float, ci: $CallbackInfo$$Type): void
...
public "handler$ddd000$poseLeftArm"(livingEntity0: $LivingEntity$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ddd000$poseRightArm"(livingEntity0: $LivingEntity$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ddd000$setupAnim"(livingEntity0: $LivingEntity$$Type, float1: float, float2: float, float3: float, float4: float, float5: float, callbackInfo6: $CallbackInfo$$Type): void
public "handler$ddk001$poseLeftArm"(livingEntity0: $LivingEntity$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ddk001$poseRightArm"(livingEntity0: $LivingEntity$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$emo000$rotationAngleCallback"(livingEntity0: $LivingEntity$$Type, float1: float, float2: float, float3: float, float4: float, float5: float, callbackInfo6: $CallbackInfo$$Type): void
public "handler$epj002$poseLeftArm"(entity: $LivingEntity$$Type, ci: $CallbackInfo$$Type): void
public "handler$epj002$poseRightArm"(entity: $LivingEntity$$Type, ci: $CallbackInfo$$Type): void
public "handler$epj002$setupAnim"(entity: $LivingEntity$$Type, limbSwing: float, limbSwingAmount: float, ageInTicks: float, netHeadYaw: float, headPitch: float, ci: $CallbackInfo$$Type): void
public "prepareMobModel"(t0: T, float1: float, float2: float, float3: float): void
...
public "handler$elp001$setupAnim"(livingEntity0: $LivingEntity$$Type, float1: float, float2: float, float3: float, float4: float, float5: float, callbackInfo6: $CallbackInfo$$Type): void
