...
public "redirect$gbk000$getNeighborFromFastMap"(table0: $Table$$Type<any, any, any>, object1: any, object2: any): any
...
public "handler$fch000$quark$tick"(blockState0: $BlockState$$Type, serverLevel1: $ServerLevel$$Type, blockPos2: $BlockPos$$Type, randomSource3: $RandomSource$$Type, callbackInfo4: $CallbackInfo$$Type): void
/** @deprecated */
...
public "handler$eml000$onBlockCollision"(level0: $Level$$Type, blockPos1: $BlockPos$$Type, entity2: $Entity$$Type, callbackInfo3: $CallbackInfo$$Type): void
public "handler$gbo000$cacheStateHead"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$gbo000$cacheStateTail"(callbackInfo0: $CallbackInfo$$Type): void
...
public "modifyReturnValue$fkl000$supp$modifyPlanterOffset"(original: $Vec3$$Type, level: $BlockGetter$$Type, pos: $BlockPos$$Type): $Vec3
/** @deprecated */
