...
declare module "packages/dev/latvian/mods/kubejs/server/$ServerEventJS" {
	...
	import {
		$MinecraftServer,
		$MinecraftServer$$Type,
	} from "packages/net/minecraft/server/$MinecraftServer";
...
declare module "packages/dev/latvian/mods/kubejs/server/tag/$TagWrapper" {
	import {
		$TagEventJS,
		$TagEventJS$$Type,
	} from "packages/dev/latvian/mods/kubejs/server/tag/$TagEventJS";
	...
	import {
		...
		$TagLoader$EntryWithSource$$Type,
	} from "packages/net/minecraft/tags/$TagLoader$EntryWithSource";
	...
	export class $TagWrapper {
		...
		constructor(
			...
			t: $List$$Type<$TagLoader$EntryWithSource$$Type>
		);
...
declare module "packages/dev/latvian/mods/kubejs/server/$CommandEventJS" {
	...
	import {
		$CommandSourceStack,
		$CommandSourceStack$$Type,
	} from "packages/net/minecraft/commands/$CommandSourceStack";
	...
	import {
		$ParseResults,
		$ParseResults$$Type,
	} from "packages/com/mojang/brigadier/$ParseResults";
	...
	export class $CommandEventJS extends $ServerEventJS {
		...
		public setParseResults(
			parse: $ParseResults$$Type<$CommandSourceStack$$Type>
		): void;
...
declare module "packages/dev/latvian/mods/kubejs/server/tag/$TagEventJS" {
	...
	import {
		$Registry,
		$Registry$$Type,
	} from "packages/net/minecraft/core/$Registry";
	import {
		$RegistryInfo,
		$RegistryInfo$$Type,
