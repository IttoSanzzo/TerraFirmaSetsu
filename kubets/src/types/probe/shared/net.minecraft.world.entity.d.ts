...
public "handler$ebi000$addAdditionalSaveData"(compoundTag0: $CompoundTag$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ebi000$clumps$repairPlayerItems"(player0: $Player$$Type, int1: integer, callbackInfoReturnable2: $CallbackInfoReturnable$$Type<any>): void
public "handler$ebi000$merge"(experienceOrb0: $ExperienceOrb$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ebi000$playerTouch"(player0: $Player$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$ebi000$readAdditionalSaveData"(compoundTag0: $CompoundTag$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
public "isAmbientCreature"(): boolean
public "isAnimal"(): boolean
public "isDynamicLightEnabledH"(): boolean
...
public "isPushedByFluid"(fluidType0: $FluidType$$Type): boolean
public "isWaterCreature"(): boolean
public "localvar$ebi000$clumps$captureCurrentEntry"(entry0: $Map$Entry$$Type<any, any>): $Map$Entry<any, any>
public "mergeNbt"(tag: $CompoundTag$$Type): $Entity
public "playSound"(id: $SoundEvent$$Type): void
public "playSound"(id: $SoundEvent$$Type, volume: float, pitch: float): void
public "rayTrace"(distance: double, fluids: boolean): $RayTraceResultJS
...
public "getTeamId"(): string
public "getType"(): string
public "handler$dmf000$handleLightning"(ci: $CallbackInfo$$Type, list: $List$$Type<any>): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
public "isAmbientCreature"(): boolean
public "isAnimal"(): boolean
public "isDynamicLightEnabledH"(): boolean
...
public "handler$bcc000$curio$canFreeze"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "handler$bka000$apoth_onEffectUpdateAddAttribute"(mobEffectInstance0: $MobEffectInstance$$Type, boolean1: boolean, entity2: $Entity$$Type, callbackInfo3: $CallbackInfo$$Type): void
public "handler$bka000$apoth_onEffectUpdateRemoveAttribute"(mobEffectInstance0: $MobEffectInstance$$Type, boolean1: boolean, entity2: $Entity$$Type, callbackInfo3: $CallbackInfo$$Type): void
public "handler$bka000$apoth_ownedAttrMap"(entityType0: $EntityType$$Type<any>, level1: $Level$$Type, callbackInfo2: $CallbackInfo$$Type): void
public "handler$can000$shield"(damageSource0: $DamageSource$$Type, callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>): void
public "handler$cbf000$getAttributeValue_Inject"(attribute: $Attribute$$Type, cir: $CallbackInfoReturnable$$Type<any>): void
public "handler$cja000$mna$canStandOnFluid"(fluidState0: $FluidState$$Type, callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>): void
public "handler$cja000$mna$isAffectedByFluids"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "handler$cja000$mna$jumpInLiquid"(tagKey0: $TagKey$$Type<any>, callbackInfo1: $CallbackInfo$$Type): void
public "handler$cjb000$mna$onClimbable"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "handler$ckn000$adastra$hurt"(source: $DamageSource$$Type, amount: float, cir: $CallbackInfoReturnable$$Type<any>): void
public "handler$ckn000$adastra$tick"(ci: $CallbackInfo$$Type): void
public "handler$ckn000$adastra$travel"(travelVector: $Vec3$$Type, ci: $CallbackInfo$$Type): void
public "handler$cnb003$tick"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$fgk000$onClimbable"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "handler$fgk000$onSetSprinting"(boolean0: boolean, callbackInfo1: $CallbackInfo$$Type): void
public "handler$zoh000$injectOnClimbableWhileClimbingMasts"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
...
public "localvar$cbf000$takeKnockback_HEAD_changeStrength"(knockbackStrength: double): double
public "mergeNbt"(tag: $CompoundTag$$Type): $Entity
public "modifyAttribute"(attribute: $Attribute$$Type, identifier: string, d: double, operation: $AttributeModifier$Operation$$Type): void
public "modifyExpressionValue$cje000$eytraValidOverride"(boolean0: boolean): boolean
public "modifyExpressionValue$cje002$elytraOverride"(boolean0: boolean): boolean
public "moveInFluid"(fluidState0: $FluidState$$Type, vec31: $Vec3$$Type, double2: double): boolean
...
public "rayTrace"(distance: double): $RayTraceResultJS
public "readAdditionalSaveData"(compoundTag0: $CompoundTag$$Type): void
public "redirect$bka000$apoth_applyArmorPen"(float0: float, float1: float, float2: float, damageSource3: $DamageSource$$Type, float4: float): float
public "redirect$bka000$apoth_applyProtPen"(float0: float, float1: float, damageSource2: $DamageSource$$Type, float3: float): float
public "redirect$bka000$apoth_sunderingApplyEffect"(float0: float, float1: float, damageSource2: $DamageSource$$Type, float3: float): float
public "redirect$bka000$apoth_sunderingGetAmplifier"(mobEffectInstance0: $MobEffectInstance$$Type): integer
public "redirect$bka000$apoth_sunderingHasEffect"(livingEntity0: $LivingEntity$$Type, mobEffect1: $MobEffect$$Type): boolean
...
public "wrapOperation$fce000$onTravel"(instance: $LivingEntity$$Type, state: $FluidState$$Type, original: $Operation$$Type<any>): boolean
...
public "getTotalMovementSpeed"(): double
public "getType"(): string
public "handler$cko000$adastra$checkSpawnObstruction"(levelReader: $LevelReader$$Type, cir: $CallbackInfoReturnable$$Type<any>): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
...
public "rayTrace"(distance: double, fluids: boolean): $RayTraceResultJS
public "rayTrace"(distance: double): $RayTraceResultJS
public "redirect$edn000$fixSpawnAnimX"(instance: $Mob$$Type, v: double): double
...
public "handler$cjg000$mna$canEnterPose"(pose0: $Pose$$Type, callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>): void
public "handler$cjg000$mna$playSound"(soundEvent0: $SoundEvent$$Type, float1: float, float2: float, callbackInfo3: $CallbackInfo$$Type): void
public "handler$cna001$load"(compoundTag0: $CompoundTag$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$cna001$saveWithoutId"(compoundTag0: $CompoundTag$$Type, callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>): void
...
public "handler$ffa000$create$onFireImmune"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "handler$fgj000$onGetEyeHeight"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "handler$fgj000$onIsInWall"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
...
public "localvar$bjn000$apoth_checkFallDamageWithGravity"(double0: double): double
...
public "modifyExpressionValue$fkg000$create$playerHidingAsBoxIsCrouchingNotSwimming"(boolean0: boolean, pose1: $Pose$$Type): boolean
public "modifyReturnValue$fkg000$create$onFireImmune"(boolean0: boolean): boolean
