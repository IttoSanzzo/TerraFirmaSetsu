...
public "handler$egl000$addAdditionalSaveData"(compoundTag0: $CompoundTag$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$egl000$clumps$repairPlayerItems"(player0: $Player$$Type, int1: integer, callbackInfoReturnable2: $CallbackInfoReturnable$$Type<any>): void
public "handler$egl000$merge"(experienceOrb0: $ExperienceOrb$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$egl000$playerTouch"(player0: $Player$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$egl000$readAdditionalSaveData"(compoundTag0: $CompoundTag$$Type, callbackInfo1: $CallbackInfo$$Type): void
...
public "isPushedByFluid"(fluidType0: $FluidType$$Type): boolean
public "isWaterCreature"(): boolean
public "localvar$egl000$clumps$captureCurrentEntry"(entry0: $Map$Entry$$Type<any, any>): $Map$Entry<any, any>
public "mergeNbt"(tag: $CompoundTag$$Type): $Entity
public "playSound"(id: $SoundEvent$$Type): void
public "playSound"(id: $SoundEvent$$Type, volume: float, pitch: float): void
public "rayTrace"(distance: double, fluids: boolean): $RayTraceResultJS
...
public "getTeamId"(): string
public "getType"(): string
public "handler$ebd000$handleLightning"(ci: $CallbackInfo$$Type, list: $List$$Type<any>): void
public "hasCustomOutlineRendering"(player0: $Player$$Type): boolean
public "isAmbientCreature"(): boolean
public "isAnimal"(): boolean
public "isDynamicLightEnabledH"(): boolean
...
public "handler$cpo000$adastra$hurt"(source: $DamageSource$$Type, amount: float, cir: $CallbackInfoReturnable$$Type<any>): void
public "handler$cpo000$adastra$tick"(ci: $CallbackInfo$$Type): void
public "handler$cpo000$adastra$travel"(travelVector: $Vec3$$Type, ci: $CallbackInfo$$Type): void
public "handler$dcc003$tick"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$fmn000$onClimbable"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "handler$fmn000$onSetSprinting"(boolean0: boolean, callbackInfo1: $CallbackInfo$$Type): void
...
public "modifyReturnValue$eio000$isCurrentlyGlowing"(boolean0: boolean): boolean
public "moveInFluid"(fluidState0: $FluidState$$Type, vec31: $Vec3$$Type, double2: double): boolean
...
public "wrapOperation$fih000$onTravel"(instance: $LivingEntity$$Type, state: $FluidState$$Type, original: $Operation$$Type<any>): boolean
...
public "getTotalMovementSpeed"(): double
public "getType"(): string
public "handler$cpp000$adastra$checkSpawnObstruction"(levelReader: $LevelReader$$Type, cir: $CallbackInfoReturnable$$Type<any>): void
...
public "rayTrace"(distance: double, fluids: boolean): $RayTraceResultJS
public "rayTrace"(distance: double): $RayTraceResultJS
public "redirect$ejo000$fixSpawnAnimX"(instance: $Mob$$Type, v: double): double
...
public "handler$dcb001$load"(compoundTag0: $CompoundTag$$Type, callbackInfo1: $CallbackInfo$$Type): void
public "handler$dcb001$saveWithoutId"(compoundTag0: $CompoundTag$$Type, callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>): void
public "handler$dda000$onRemove"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$dda000$removed"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$dda004$onTick"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$dnp001$onRemove"(ci: $CallbackInfo$$Type): void
public "handler$dnp006$onTick"(ci: $CallbackInfo$$Type): void
public "handler$eel000$baseTick"(callbackInfo0: $CallbackInfo$$Type): void
public "handler$fld000$create$onFireImmune"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "handler$fmm000$onGetEyeHeight"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
public "handler$fmm000$onIsInWall"(callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>): void
...
public "modifyExpressionValue$gbp000$create$playerHidingAsBoxIsCrouchingNotSwimming"(boolean0: boolean, pose1: $Pose$$Type): boolean
public "modifyReturnValue$gbp000$create$onFireImmune"(boolean0: boolean): boolean
