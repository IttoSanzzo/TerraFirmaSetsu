declare module "packages/net/minecraft/world/entity/$SpawnPlacements$Type" {
	...
	export class $SpawnPlacements$Type
		...
		implements $IExtensibleEnum
	{
		...
		public canSpawnAt(
			levelReader0: $LevelReader$$Type,
			blockPos1: $BlockPos$$Type,
			entityType2: $EntityType$$Type<any>
		): boolean;
		public static create(
			string0: string,
			triPredicate1: $TriPredicate$$Type<
				$LevelReader$$Type,
				$BlockPos$$Type,
				$EntityType$$Type<$Mob$$Type>
			>
		): $SpawnPlacements$Type;
		public static createCodecForExtensibleEnum<
			E extends $Enum<E> & $StringRepresentable,
		>(
			supplier0: $Supplier$$Type<E[]>,
			function1: $Function$$Type<string, E>
		): $Codec<E>;
		/** @deprecated */
		public init(): void;
...
declare module "packages/net/minecraft/world/entity/$Display$ItemDisplay" {
	import {
		$SoundEvent,
		$SoundEvent$$Type,
	} from "packages/net/minecraft/sounds/$SoundEvent";
	import {
		$CompoundTag,
		$CompoundTag$$Type,
	...
	import {
		$Component,
		$Component$$Type,
	} from "packages/net/minecraft/network/chat/$Component";
	import { $Direction } from "packages/net/minecraft/core/$Direction";
	import {
		$BlockContainerJS,
		$BlockContainerJS$$Type,
	} from "packages/dev/latvian/mods/kubejs/level/$BlockContainerJS";
	...
	import {
		$Entity,
		$Entity$$Type,
	} from "packages/net/minecraft/world/entity/$Entity";
	...
	export class $Display$ItemDisplay extends $Display {
		...
		public canBeRiddenUnderFluidType(
			fluidType0: $FluidType$$Type,
			entity1: $Entity$$Type
		): boolean;
		...
		/** @deprecated */
		public getEyeHeightForge(
			pose0: $Pose$$Type,
			entityDimensions1: $EntityDimensions$$Type
		): float;
		...
		public getSoundFromFluidType(
			fluidType0: $FluidType$$Type,
			soundAction1: $SoundAction$$Type
		): $SoundEvent;
		...
		public isInFluidType(
			biPredicate0: $BiPredicate$$Type<$FluidType$$Type, double>
		): boolean;
		...
		public shouldUpdateFluidWhileBoating(
			fluidState0: $FluidState$$Type,
			boat1: $Boat$$Type
		): boolean;
		public spawn(): void;
		public teleportTo(
			dimension: $ResourceLocation$$Type,
			x: double,
			y: double,
			z: double,
			yaw: float,
...
declare module "packages/net/minecraft/world/entity/$Display$TextDisplay$TextRenderState" {
	...
	import {
		...
		$Display$IntInterpolator$$Type,
	} from "packages/net/minecraft/world/entity/$Display$IntInterpolator";

	export class $Display$TextDisplay$TextRenderState extends $Record {
		constructor(
			component0: $Component$$Type,
			int1: integer,
			intInterpolator2: $Display$IntInterpolator$$Type,
			intInterpolator3: $Display$IntInterpolator$$Type,
			byte4: byte
		);
...
declare module "packages/net/minecraft/world/entity/$ExperienceOrb" {
	...
	export class $ExperienceOrb
		extends $Entity
		implements $ExperienceOrbAccessor, $ExperienceOrbAccess, $IClumpedOrb
	{
		constructor(
			level0: $Level$$Type,
			double1: double,
		...
		constructor(
			entityType0: $EntityType$$Type<$ExperienceOrb$$Type>,
			level1: $Level$$Type
		);
		...
		public handler$ebi000$addAdditionalSaveData(
			compoundTag0: $CompoundTag$$Type,
			callbackInfo1: $CallbackInfo$$Type
		): void;
		public handler$ebi000$clumps$repairPlayerItems(
			player0: $Player$$Type,
			int1: integer,
			callbackInfoReturnable2: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$ebi000$merge(
			experienceOrb0: $ExperienceOrb$$Type,
			callbackInfo1: $CallbackInfo$$Type
		): void;
		public handler$ebi000$playerTouch(
			player0: $Player$$Type,
			callbackInfo1: $CallbackInfo$$Type
		): void;
		public handler$ebi000$readAdditionalSaveData(
			compoundTag0: $CompoundTag$$Type,
			callbackInfo1: $CallbackInfo$$Type
		): void;
		public hasCustomOutlineRendering(player0: $Player$$Type): boolean;
		...
		public isPushedByFluid(fluidType0: $FluidType$$Type): boolean;
		public isWaterCreature(): boolean;
		public localvar$ebi000$clumps$captureCurrentEntry(
			entry0: $Map$Entry$$Type<any, any>
		): $Map$Entry<any, any>;
		public mergeNbt(tag: $CompoundTag$$Type): $Entity;
		public playSound(id: $SoundEvent$$Type): void;
		public playSound(id: $SoundEvent$$Type, volume: float, pitch: float): void;
		...
		public tell(message: $Component$$Type): void;
		public static tryMergeToExisting(
			serverLevel0: $ServerLevel$$Type,
			vec31: $Vec3$$Type,
			int2: integer
		): boolean;
...
declare module "packages/net/minecraft/world/entity/$NeutralMob" {
	...
	import {
		$LivingEntity,
		$LivingEntity$$Type,
	} from "packages/net/minecraft/world/entity/$LivingEntity";
...
declare module "packages/net/minecraft/world/entity/$EntityType$EntityFactory" {
	...
	export abstract class $EntityType$EntityFactory$$Static<
		T extends $Entity,
	> implements $EntityType$EntityFactory<T> {}
}
...
declare module "packages/net/minecraft/world/entity/$ReputationEventHandler" {
	...
	export interface $ReputationEventHandler {
		"onReputationEventFrom"(
			reputationEventType0: $ReputationEventType$$Type,
			entity1: $Entity$$Type
		): void;
	}
...
declare module "packages/net/minecraft/world/entity/$VariantHolder" {
	...
	export abstract class $VariantHolder$$Static<
		T,
	> implements $VariantHolder<T> {}
}
...
declare module "packages/net/minecraft/world/entity/$AgeableMob" {
	...
	export class $AgeableMob extends $PathfinderMob {
		...
		public damageEquipment(
			...
			amount: integer,
			onBroken: $Consumer$$Type<$ItemStack$$Type>
		): void;
		public damageHeldItem(
			hand: $InteractionHand$$Type,
			amount: integer,
			onBroken: $Consumer$$Type<$ItemStack$$Type>
		): void;
		...
		public getBlock(): $BlockContainerJS;
		public getBreedOffspring(
			serverLevel0: $ServerLevel$$Type,
			ageableMob1: $AgeableMob$$Type
		): $AgeableMob;
		public getCapability<T>(
			capability0: $Capability$$Type<T>
		): $LazyOptional<T>;
		...
		public modifyAttribute(
			...
			identifier: string,
			d: double,
			operation: $AttributeModifier$Operation$$Type
		): void;
		public moveInFluid(
			fluidState0: $FluidState$$Type,
			vec31: $Vec3$$Type,
		...
		public sodiumdynamiclights$scheduleTrackedChunksRebuild(
			levelRenderer0: $LevelRenderer$$Type
		): void;
		public sodiumdynamiclights$updateDynamicLight(
			levelRenderer0: $LevelRenderer$$Type
		): boolean;
		public spawn(): void;
		public swing(): void;
...
declare module "packages/net/minecraft/world/entity/$Display$TextDisplay" {
	...
	export class $Display$TextDisplay extends $Display {
		...
		public attack(hp: float): void;
		public cacheDisplay(
			lineSplitter0: $Display$TextDisplay$LineSplitter$$Type
...
declare module "packages/net/minecraft/world/entity/$TamableAnimal" {
	...
	export class $TamableAnimal extends $Animal implements $OwnableEntity {
		...
		public tell(message: $Component$$Type): void;
		public static tickEntity(entity: $LivingEntity$$Type): void;
		public wantsToAttack(
			livingEntity0: $LivingEntity$$Type,
			livingEntity1: $LivingEntity$$Type
		): boolean;
		get block(): $BlockContainerJS;
		get chestArmorItem(): $ItemStack;
		get defaultMovementSpeed(): double;
...
declare module "packages/net/minecraft/world/entity/$LightningBolt" {
	...
	import {
		$ServerPlayer,
		$ServerPlayer$$Type,
	} from "packages/net/minecraft/server/level/$ServerPlayer";
	import { $RayTraceResultJS } from "packages/dev/latvian/mods/kubejs/entity/$RayTraceResultJS";
	import { $SoundAction$$Type } from "packages/net/minecraftforge/common/$SoundAction";
	import { $ScriptType } from "packages/dev/latvian/mods/kubejs/script/$ScriptType";
	import {
	...
	export class $LightningBolt extends $Entity {
		constructor(
			entityType0: $EntityType$$Type<$LightningBolt$$Type>,
			level1: $Level$$Type
		);
		...
		public getTeamId(): string;
		public getType(): string;
		public handler$dmf000$handleLightning(
			ci: $CallbackInfo$$Type,
			list: $List$$Type<any>
		): void;
		public hasCustomOutlineRendering(player0: $Player$$Type): boolean;
		public isAmbientCreature(): boolean;
...
declare module "packages/net/minecraft/world/entity/$Display$ItemDisplay$ItemRenderState" {
	...
	} from "packages/net/minecraft/world/item/$ItemDisplayContext";
	import { $Record } from "packages/java/lang/$Record";
	import {
		$ItemStack,
		$ItemStack$$Type,
	...
	export class $Display$ItemDisplay$ItemRenderState extends $Record {
		constructor(
			...
			itemDisplayContext1: $ItemDisplayContext$$Type
		);
...
declare module "packages/net/minecraft/world/entity/$AreaEffectCloud" {
	...
	import {
		$Potion,
		$Potion$$Type,
	} from "packages/net/minecraft/world/item/alchemy/$Potion";
	import { $FluidState$$Type } from "packages/net/minecraft/world/level/material/$FluidState";
	...
	} from "packages/net/minecraft/core/particles/$ParticleOptions";
	import {
		$Entity,
		$Entity$$Type,
	} from "packages/net/minecraft/world/entity/$Entity";
	...
	} from "packages/net/minecraft/world/effect/$MobEffectInstance";
	import {
		$Level,
		$Level$$Type,
	} from "packages/net/minecraft/world/level/$Level";
	...
	export class $AreaEffectCloud extends $Entity implements $TraceableEntity {
		...
		constructor(
			entityType0: $EntityType$$Type<$AreaEffectCloud$$Type>,
			level1: $Level$$Type
		);
		constructor(
			level0: $Level$$Type,
...
declare module "packages/net/minecraft/world/entity/$LivingEntity" {
	...
	import {
		$DamageSource,
		$DamageSource$$Type,
	} from "packages/net/minecraft/world/damagesource/$DamageSource";
	...
	import {
		$AttributeMap,
		$AttributeMap$$Type,
	} from "packages/net/minecraft/world/entity/ai/attributes/$AttributeMap";
	import { $EntityType$$Type } from "packages/net/minecraft/world/entity/$EntityType";
	import { $Consumer$$Type } from "packages/java/util/function/$Consumer";
	import {
		$Player,
		$Player$$Type,
	} from "packages/net/minecraft/world/entity/player/$Player";
	...
	import {
		$EquipmentSlot,
		$EquipmentSlot$$Type,
	} from "packages/net/minecraft/world/entity/$EquipmentSlot";
	import {
		$Level,
		$Level$$Type,
	} from "packages/net/minecraft/world/level/$Level";
	...
	import {
		$Pose,
		$Pose$$Type,
	} from "packages/net/minecraft/world/entity/$Pose";
	...
	import {
		$Direction,
		$Direction$$Type,
	} from "packages/net/minecraft/core/$Direction";
	import {
		$BlockContainerJS,
		$BlockContainerJS$$Type,
	} from "packages/dev/latvian/mods/kubejs/level/$BlockContainerJS";
	...
	import {
		$MobEffect,
		$MobEffect$$Type,
	} from "packages/net/minecraft/world/effect/$MobEffect";
	...
	import {
		$Collection,
		$Collection$$Type,
	} from "packages/java/util/$Collection";
	...
	} from "packages/net/minecraft/world/$InteractionHand";
	import { $CallbackInfo$$Type } from "packages/org/spongepowered/asm/mixin/injection/callback/$CallbackInfo";
	import { $Attribute$$Type } from "packages/net/minecraft/world/entity/ai/attributes/$Attribute";
	import { $EntityDimensions$$Type } from "packages/net/minecraft/world/entity/$EntityDimensions";
	...
	export class $LivingEntity
		...
		implements
			...
			$IForgeLivingEntity,
			$LivingEntityInvoker,
			$LivingEntityAccessor$0,
			$LivingEntityAccessor$1,
			...
			$LivingEntityAccessor$4,
			$ISlimeable,
			$LivingEntityAccessor$3,
			$LivingEntityAccessor$2
	{
		...
		public addEffect(
			mobEffectInstance0: $MobEffectInstance$$Type,
			entity1: $Entity$$Type
		): boolean;
		public aiStep(): void;
		public alwaysAccepts(): boolean;
		public static areAllEffectsAmbient(
			collection0: $Collection$$Type<$MobEffectInstance$$Type>
		): boolean;
		public attack(hp: float): void;
		...
		public canAttack(
			livingEntity0: $LivingEntity$$Type,
			targetingConditions1: $TargetingConditions$$Type
		): boolean;
		...
		public equipmentHasChanged(
			itemStack0: $ItemStack$$Type,
			itemStack1: $ItemStack$$Type
		): boolean;
		public foodEaten(is: $ItemStack$$Type): void;
		public forceAddEffect(
			mobEffectInstance0: $MobEffectInstance$$Type,
			entity1: $Entity$$Type
		): void;
		...
		public getAttributeBaseValue(
			holder0: $Holder$$Type<$Attribute$$Type>
		): double;
		public getAttributeBaseValue(attribute: $Attribute$$Type): double;
		public getAttributeTotalValue(attribute: $Attribute$$Type): double;
		...
		public getEquipment(slot: $EquipmentSlot$$Type): $ItemStack;
		public static getEquipmentSlotForItem(
			itemStack0: $ItemStack$$Type
		): $EquipmentSlot;
		...
		public getFeetArmorItem(): $ItemStack;
		public getFluidFallDistanceModifier(fluidType0: $FluidType$$Type): float;
		public getFluidFallingAdjustedMovement(
			double0: double,
			boolean1: boolean,
			vec32: $Vec3$$Type
		): $Vec3;
		...
		public handleRelativeFrictionAndCalculateMovement(
			vec30: $Vec3$$Type,
			float1: float
		): $Vec3;
		public handler$bcc000$curio$canFreeze(
			callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$bka000$apoth_onEffectUpdateAddAttribute(
			mobEffectInstance0: $MobEffectInstance$$Type,
			boolean1: boolean,
			entity2: $Entity$$Type,
			callbackInfo3: $CallbackInfo$$Type
		): void;
		public handler$bka000$apoth_onEffectUpdateRemoveAttribute(
			mobEffectInstance0: $MobEffectInstance$$Type,
			boolean1: boolean,
			entity2: $Entity$$Type,
			callbackInfo3: $CallbackInfo$$Type
		): void;
		public handler$bka000$apoth_ownedAttrMap(
			entityType0: $EntityType$$Type<any>,
			level1: $Level$$Type,
			callbackInfo2: $CallbackInfo$$Type
		): void;
		public handler$can000$shield(
			damageSource0: $DamageSource$$Type,
			callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$cbf000$getAttributeValue_Inject(
			attribute: $Attribute$$Type,
			cir: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$cja000$mna$canStandOnFluid(
			fluidState0: $FluidState$$Type,
			callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$cja000$mna$isAffectedByFluids(
			callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$cja000$mna$jumpInLiquid(
			tagKey0: $TagKey$$Type<any>,
			callbackInfo1: $CallbackInfo$$Type
		): void;
		public handler$cjb000$mna$onClimbable(
			callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$ckn000$adastra$hurt(
			source: $DamageSource$$Type,
			amount: float,
			cir: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$ckn000$adastra$tick(ci: $CallbackInfo$$Type): void;
		public handler$ckn000$adastra$travel(
			travelVector: $Vec3$$Type,
			ci: $CallbackInfo$$Type
		): void;
		public handler$cnb003$tick(callbackInfo0: $CallbackInfo$$Type): void;
		public handler$fgk000$onClimbable(
			callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$fgk000$onSetSprinting(
			boolean0: boolean,
			callbackInfo1: $CallbackInfo$$Type
		): void;
		public handler$zoh000$injectOnClimbableWhileClimbingMasts(
			callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>
		): void;
		public hasCustomOutlineRendering(player0: $Player$$Type): boolean;
		...
		public localvar$cbf000$takeKnockback_HEAD_changeStrength(
		...
		public modifyExpressionValue$cje000$eytraValidOverride(
			boolean0: boolean
		): boolean;
		public modifyExpressionValue$cje002$elytraOverride(
			boolean0: boolean
		): boolean;
		public moveInFluid(
			fluidState0: $FluidState$$Type,
		...
		public onEquipItem(
			equipmentSlot0: $EquipmentSlot$$Type,
			itemStack1: $ItemStack$$Type,
			itemStack2: $ItemStack$$Type
		): void;
		public onItemPickup(itemEntity0: $ItemEntity$$Type): void;
		public onLeaveCombat(): void;
		public parCool$isLivingOnCustomLadder(
			blockState0: $BlockState$$Type,
			level1: $Level$$Type,
			blockPos2: $BlockPos$$Type,
			livingEntity3: $LivingEntity$$Type
		): boolean;
		public playSound(id: $SoundEvent$$Type): void;
		public playSound(id: $SoundEvent$$Type, volume: float, pitch: float): void;
		...
		public rayTrace(distance: double): $RayTraceResultJS;
		public readAdditionalSaveData(compoundTag0: $CompoundTag$$Type): void;
		public redirect$bka000$apoth_applyArmorPen(
			float0: float,
			float1: float,
			float2: float,
			damageSource3: $DamageSource$$Type,
			float4: float
		): float;
		public redirect$bka000$apoth_applyProtPen(
			float0: float,
			float1: float,
			damageSource2: $DamageSource$$Type,
			float3: float
		): float;
		public redirect$bka000$apoth_sunderingApplyEffect(
			float0: float,
			float1: float,
			damageSource2: $DamageSource$$Type,
			float3: float
		): float;
		public redirect$bka000$apoth_sunderingGetAmplifier(
			mobEffectInstance0: $MobEffectInstance$$Type
		): integer;
		public redirect$bka000$apoth_sunderingHasEffect(
			livingEntity0: $LivingEntity$$Type,
			mobEffect1: $MobEffect$$Type
		): boolean;
		...
		public removeEffectNoUpdate(
			mobEffect0: $MobEffect$$Type
		): $MobEffectInstance;
		public removeEffectParticles(): void;
		public static resetForwardDirectionOfRelativePortalPosition(
			vec30: $Vec3$$Type
		): $Vec3;
		public runCommand(command: string): integer;
		public runCommandSilent(command: string): integer;
		...
		public setItemInHand(
			interactionHand0: $InteractionHand$$Type,
			itemStack1: $ItemStack$$Type
		): void;
		...
		public setRecordPlayingNearby(
			blockPos0: $BlockPos$$Type,
			boolean1: boolean
		): void;
		public setRotation(yaw: float, pitch: float): void;
		...
		public wrapOperation$fce000$onTravel(
			instance: $LivingEntity$$Type,
			state: $FluidState$$Type,
			original: $Operation$$Type<any>
		): boolean;
...
declare module "packages/net/minecraft/world/entity/$SlotAccess" {
	...
	export namespace $SlotAccess {
		...
		function forContainer(
			container0: $Container$$Type,
			int1: integer,
			predicate2: $Predicate$$Type<$ItemStack$$Type>
		): $SlotAccess;
		function forContainer(
			container0: $Container$$Type,
			int1: integer
		): $SlotAccess;
		function forEquipmentSlot(
			livingEntity0: $LivingEntity$$Type,
			equipmentSlot1: $EquipmentSlot$$Type,
			predicate2: $Predicate$$Type<$ItemStack$$Type>
		): $SlotAccess;
		function forEquipmentSlot(
			livingEntity0: $LivingEntity$$Type,
...
declare module "packages/net/minecraft/world/entity/$PathfinderMob" {
	...
	export class $PathfinderMob extends $Mob {
		...
		public getWalkTargetValue(
			blockPos0: $BlockPos$$Type,
			levelReader1: $LevelReader$$Type
		): float;
		public hasCustomOutlineRendering(player0: $Player$$Type): boolean;
		public isAmbientCreature(): boolean;
		public isAnimal(): boolean;
...
declare module "packages/net/minecraft/world/entity/$Display$TextDisplay$CachedInfo" {
	import {
		...
		$Display$TextDisplay$CachedLine$$Type,
	} from "packages/net/minecraft/world/entity/$Display$TextDisplay$CachedLine";
	import { $Record } from "packages/java/lang/$Record";
	import { $List, $List$$Type } from "packages/java/util/$List";

	export class $Display$TextDisplay$CachedInfo extends $Record {
		constructor(
			list0: $List$$Type<$Display$TextDisplay$CachedLine$$Type>,
			int1: integer
		);
...
declare module "packages/net/minecraft/world/entity/$EquipmentSlot" {
	...
	} from "packages/net/minecraft/world/entity/$EquipmentSlot$Type";
	...
	export class $EquipmentSlot extends $Enum<$EquipmentSlot> {
		...
		public static byTypeAndIndex(
			type0: $EquipmentSlot$Type$$Type,
			int1: integer
		): $EquipmentSlot;
...
declare module "packages/net/minecraft/world/entity/$Display$TextDisplay$CachedLine" {
	import {
		...
		$FormattedCharSequence$$Type,
	} from "packages/net/minecraft/util/$FormattedCharSequence";
	import { $Record } from "packages/java/lang/$Record";

	export class $Display$TextDisplay$CachedLine extends $Record {
		constructor(
			formattedCharSequence0: $FormattedCharSequence$$Type,
			int1: integer
		);
...
declare module "packages/net/minecraft/world/entity/$Display$TextDisplay$Align" {
	...
	export class $Display$TextDisplay$Align
		extends $Enum<$Display$TextDisplay$Align>
...
declare module "packages/net/minecraft/world/entity/$EntityType$Builder" {
	...
	export class $EntityType$Builder<T extends $Entity> {
		...
		public static createNothing<T extends $Entity>(
			mobCategory0: $MobCategory$$Type
		...
		public static of<T extends $Entity>(
			entityFactory0: $EntityType$EntityFactory$$Type<T>,
			mobCategory1: $MobCategory$$Type
		): $EntityType$Builder<T>;
		public requiredFeatures(
			...featureFlag0s: $FeatureFlag$$Type[]
		): $EntityType$Builder<T>;
		public setCustomClientFactory(
			biFunction0: $BiFunction$$Type<
				$PlayMessages$SpawnEntity$$Type,
				$Level$$Type,
				T
			>
		): $EntityType$Builder<T>;
		public setShouldReceiveVelocityUpdates(
			boolean0: boolean
		): $EntityType$Builder<T>;
		...
		set customClientFactory(
			value: $BiFunction$$Type<$PlayMessages$SpawnEntity$$Type, $Level$$Type, T>
		);
...
declare module "packages/net/minecraft/world/entity/$Mob" {
	...
	import {
		$MobSpawnType,
		$MobSpawnType$$Type,
	} from "packages/net/minecraft/world/entity/$MobSpawnType";
	import { $Direction } from "packages/net/minecraft/core/$Direction";
	...
	import {
		$SpawnGroupData,
		$SpawnGroupData$$Type,
	} from "packages/net/minecraft/world/entity/$SpawnGroupData";
	import { $HitResult$$Type } from "packages/net/minecraft/world/phys/$HitResult";
	import { $InteractionHand$$Type } from "packages/net/minecraft/world/$InteractionHand";
	import { $Attribute$$Type } from "packages/net/minecraft/world/entity/ai/attributes/$Attribute";
	import { $EntityDimensions$$Type } from "packages/net/minecraft/world/entity/$EntityDimensions";
	...
	export class $Mob
		...
		implements $Targeting, $MobAccessor, $MobAccessor$0
	{
		...
		public canDrownInFluidType(fluidType0: $FluidType$$Type): boolean;
		public canEntityBeSeen(entity: $LivingEntity$$Type): boolean;
		public canFireProjectileWeapon(
			projectileWeaponItem0: $ProjectileWeaponItem$$Type
		): boolean;
		public canFluidExtinguish(fluidType0: $FluidType$$Type): boolean;
		public canHoldItem(itemStack0: $ItemStack$$Type): boolean;
		public canHydrateInFluidType(fluidType0: $FluidType$$Type): boolean;
		public canPickUpLoot(): boolean;
		public canReplaceEqualItem(
			itemStack0: $ItemStack$$Type,
			itemStack1: $ItemStack$$Type
		): boolean;
		public canRiderInteract(): boolean;
		public canStartSwimming(): boolean;
		public canSwimInFluidType(fluidType0: $FluidType$$Type): boolean;
		public static checkMobSpawnRules(
			entityType0: $EntityType$$Type<$Mob$$Type>,
			levelAccessor1: $LevelAccessor$$Type,
			mobSpawnType2: $MobSpawnType$$Type,
			blockPos3: $BlockPos$$Type,
			randomSource4: $RandomSource$$Type
		): boolean;
		public checkSpawnObstruction(levelReader0: $LevelReader$$Type): boolean;
		public checkSpawnRules(
			levelAccessor0: $LevelAccessor$$Type,
			mobSpawnType1: $MobSpawnType$$Type
		): boolean;
		public clearRestriction(): void;
		public convertTo<T extends $Mob>(
			entityType0: $EntityType$$Type<T>,
			boolean1: boolean
		): T;
		...
		public finalizeSpawn(
			serverLevelAccessor0: $ServerLevelAccessor$$Type,
			difficultyInstance1: $DifficultyInstance$$Type,
			mobSpawnType2: $MobSpawnType$$Type,
			spawnGroupData3: $SpawnGroupData$$Type,
			compoundTag4: $CompoundTag$$Type
		): $SpawnGroupData;
		public foodEaten(is: $ItemStack$$Type): void;
		public static getAlpha(le: $LivingEntity$$Type, partialTicks: float): float;
		...
		public getDistanceSq(pos: $BlockPos$$Type): double;
		public getEquipment(slot: $EquipmentSlot$$Type): $ItemStack;
		public static getEquipmentForSlot(
			equipmentSlot0: $EquipmentSlot$$Type,
			int1: integer
		): $Item;
		/** @deprecated */
		...
		public getPerceivedTargetDistanceSquareForMeleeAttack(
			livingEntity0: $LivingEntity$$Type
		): double;
		public getPickedResult(hitResult0: $HitResult$$Type): $ItemStack;
		public getPotionEffects(): $EntityPotionEffectsJS;
		...
		public getTotalMovementSpeed(): double;
		public getType(): string;
		public handler$cko000$adastra$checkSpawnObstruction(
			levelReader: $LevelReader$$Type,
			cir: $CallbackInfoReturnable$$Type<any>
		): void;
		public hasCustomOutlineRendering(player0: $Player$$Type): boolean;
		...
		public isUndead(): boolean;
		public isWaterCreature(): boolean;
		public isWithinMeleeAttackRange(
			livingEntity0: $LivingEntity$$Type
		): boolean;
		...
		public rayTrace(distance: double, fluids: boolean): $RayTraceResultJS;
		public rayTrace(distance: double): $RayTraceResultJS;
		public redirect$edn000$fixSpawnAnimX(
			instance: $Mob$$Type,
			v: double
		): double;
		...
		public setOffHandItem(item: $ItemStack$$Type): void;
		public setPathfindingMalus(
			blockPathTypes0: $BlockPathTypes$$Type,
			float1: float
		): void;
...
declare module "packages/net/minecraft/world/entity/$SpawnPlacements$SpawnPredicate" {
	...
	export interface $SpawnPlacements$SpawnPredicate<T extends $Entity> {
		"test"(
			entityType0: $EntityType$$Type<T>,
			serverLevelAccessor1: $ServerLevelAccessor$$Type,
			mobSpawnType2: $MobSpawnType$$Type,
			blockPos3: $BlockPos$$Type,
			randomSource4: $RandomSource$$Type
		): boolean;
	...
	export abstract class $SpawnPlacements$SpawnPredicate$$Static<
		T extends $Entity,
...
declare module "packages/net/minecraft/world/entity/$Display$RenderState" {
	...
	import {
		...
		$Display$BillboardConstraints$$Type,
	} from "packages/net/minecraft/world/entity/$Display$BillboardConstraints";
	import { $Transformation } from "packages/com/mojang/math/$Transformation";
	import {
		$Display$FloatInterpolator,
		$Display$FloatInterpolator$$Type,
	} from "packages/net/minecraft/world/entity/$Display$FloatInterpolator";
	import {
		$Display$GenericInterpolator,
		$Display$GenericInterpolator$$Type,
	} from "packages/net/minecraft/world/entity/$Display$GenericInterpolator";

	export class $Display$RenderState extends $Record {
		constructor(
			genericInterpolator0: $Display$GenericInterpolator$$Type<$Transformation>,
			billboardConstraints1: $Display$BillboardConstraints$$Type,
			int2: integer,
			floatInterpolator3: $Display$FloatInterpolator$$Type,
			floatInterpolator4: $Display$FloatInterpolator$$Type,
			int5: integer
		);
...
declare module "packages/net/minecraft/world/entity/$GlowSquid" {
	...
	export class $GlowSquid extends $Squid {
		constructor(
			entityType0: $EntityType$$Type<$GlowSquid$$Type>,
			level1: $Level$$Type
		);
		...
		public canStartSwimming(): boolean;
		public canSwimInFluidType(fluidType0: $FluidType$$Type): boolean;
		public static checkGlowSquideSpawnRules(
			entityType0: $EntityType$$Type<$LivingEntity$$Type>,
			serverLevelAccessor1: $ServerLevelAccessor$$Type,
			mobSpawnType2: $MobSpawnType$$Type,
			blockPos3: $BlockPos$$Type,
			randomSource4: $RandomSource$$Type
...
declare module "packages/net/minecraft/world/entity/$Display$GenericInterpolator" {
	...
	export abstract class $Display$GenericInterpolator$$Static<
		T,
	> implements $Display$GenericInterpolator<T> {
...
declare module "packages/net/minecraft/world/entity/$Entity" {
	...
	import {
		$FluidType,
		$FluidType$$Type,
	} from "packages/net/minecraftforge/fluids/$FluidType";
	import { $AABB, $AABB$$Type } from "packages/net/minecraft/world/phys/$AABB";
	...
	import {
		$ItemEntity,
		$ItemEntity$$Type,
	} from "packages/net/minecraft/world/entity/item/$ItemEntity";
	import { $PartEntity } from "packages/net/minecraftforge/entity/$PartEntity";
	import { $DynamicLightSource } from "packages/toni/sodiumdynamiclights/$DynamicLightSource";
	import { $LazyOptional } from "packages/net/minecraftforge/common/util/$LazyOptional";
	...
	import {
		$HitResult,
		$HitResult$$Type,
	} from "packages/net/minecraft/world/phys/$HitResult";
	...
	import {
		$EntityType,
		$EntityType$$Type,
	} from "packages/net/minecraft/world/entity/$EntityType";
	import {
		$Entity$RemovalReason,
		$Entity$RemovalReason$$Type,
	} from "packages/net/minecraft/world/entity/$Entity$RemovalReason";
	...
	import {
		$Team,
		$Team$$Type,
	} from "packages/net/minecraft/world/scores/$Team";
	import {
		$Level,
		$Level$$Type,
	} from "packages/net/minecraft/world/level/$Level";
	...
	import {
		$EntityDimensions,
		$EntityDimensions$$Type,
	} from "packages/net/minecraft/world/entity/$EntityDimensions";
	...
	export class $Entity
		...
		implements
			...
			$EntityAccessor,
			$ICustomDataHolder,
			$EntityProofDurationAccessor,
			$LambHexereiDynamicLight,
			$AccessorEntity$0,
			$DynamicLightSource,
			$EntityKJS
	{
		...
		public ad_astra_giselle_addon$getProofDuration(
			proofAbstractUtils0: $ProofAbstractUtils$$Type
		): integer;
		public ad_astra_giselle_addon$setProofDuration(
			proofAbstractUtils0: $ProofAbstractUtils$$Type,
			int1: integer
		): void;
		...
		public captureDrops(
			collection0: $Collection$$Type<$ItemEntity$$Type>
		): $Collection<$ItemEntity>;
		public captureDrops(): $Collection<$ItemEntity>;
		public causeFallDamage(
			float0: float,
			float1: float,
			damageSource2: $DamageSource$$Type
		): boolean;
		...
		public static collideBoundingBox(
			entity0: $Entity$$Type,
			vec31: $Vec3$$Type,
			aABB2: $AABB$$Type,
			level3: $Level$$Type,
			list4: $List$$Type<$VoxelShape$$Type>
		): $Vec3;
		...
		public fillCrashReportCategory(
			crashReportCategory0: $CrashReportCategory$$Type
		): void;
		public fireImmune(): boolean;
		public gameEvent(gameEvent0: $GameEvent$$Type): void;
		public gameEvent(
			gameEvent0: $GameEvent$$Type,
			entity1: $Entity$$Type
		): void;
		...
		public getBlock(): $BlockContainerJS;
		public getBlockExplosionResistance(
			explosion0: $Explosion$$Type,
			blockGetter1: $BlockGetter$$Type,
			blockPos2: $BlockPos$$Type,
			blockState3: $BlockState$$Type,
			fluidState4: $FluidState$$Type,
			float5: float
		): float;
		...
		public getDismountLocationForPassenger(
			livingEntity0: $LivingEntity$$Type
		): $Vec3;
		public getDisplayName(): $Component;
		public getDisplayName(): $Component;
		...
		public handler$bmb000$baseTick(callbackInfo0: $CallbackInfo$$Type): void;
		public handler$cjg000$mna$canEnterPose(
			pose0: $Pose$$Type,
			callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$cjg000$mna$playSound(
			soundEvent0: $SoundEvent$$Type,
			float1: float,
			float2: float,
			callbackInfo3: $CallbackInfo$$Type
		): void;
		public handler$cna001$load(
			compoundTag0: $CompoundTag$$Type,
			callbackInfo1: $CallbackInfo$$Type
		): void;
		public handler$cna001$saveWithoutId(
			compoundTag0: $CompoundTag$$Type,
			callbackInfoReturnable1: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$cnp000$onRemove(callbackInfo0: $CallbackInfo$$Type): void;
		public handler$cnp000$removed(callbackInfo0: $CallbackInfo$$Type): void;
		public handler$cnp003$onTick(callbackInfo0: $CallbackInfo$$Type): void;
		public handler$djb001$onRemove(ci: $CallbackInfo$$Type): void;
		public handler$djb005$onTick(ci: $CallbackInfo$$Type): void;
		public handler$ffa000$create$onFireImmune(
			callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$fgj000$onGetEyeHeight(
			callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>
		): void;
		public handler$fgj000$onIsInWall(
			callbackInfoReturnable0: $CallbackInfoReturnable$$Type<any>
		): void;
		...
		public interact(
			player0: $Player$$Type,
			interactionHand1: $InteractionHand$$Type
		): $InteractionResult;
		public interactAt(
			player0: $Player$$Type,
			vec31: $Vec3$$Type,
			interactionHand2: $InteractionHand$$Type
		): $InteractionResult;
		...
		public lambdynlights$scheduleTrackedChunksRebuildH(
			levelRenderer0: $LevelRenderer$$Type
		): void;
		public lambdynlights$updateDynamicLightH(
			levelRenderer0: $LevelRenderer$$Type
		): boolean;
		...
		public localvar$bjn000$apoth_checkFallDamageWithGravity(
			double0: double
		): double;
		public lookAt(
			anchor0: $EntityAnchorArgument$Anchor$$Type,
			vec31: $Vec3$$Type
		): void;
		public makeStuckInBlock(
			blockState0: $BlockState$$Type,
			vec31: $Vec3$$Type
		): void;
		/** @deprecated */
		...
		public modifyExpressionValue$fkg000$create$playerHidingAsBoxIsCrouchingNotSwimming(
			boolean0: boolean,
			pose1: $Pose$$Type
		): boolean;
		public modifyReturnValue$fkg000$create$onFireImmune(
			boolean0: boolean
		): boolean;
		...
		public onSyncedDataUpdated(
			entityDataAccessor0: $EntityDataAccessor$$Type<any>
		): void;
		public onSyncedDataUpdated(
			list0: $List$$Type<$SynchedEntityData$DataValue$$Type<any>>
		): void;
		...
		public rayTrace(distance: double, fluids: boolean): $RayTraceResultJS;
		public rayTrace(distance: double): $RayTraceResultJS;
		public recreateFromPacket(
			clientboundAddEntityPacket0: $ClientboundAddEntityPacket$$Type
		): void;
		...
		public setLevelCallback(
			entityInLevelCallback0: $EntityInLevelCallback$$Type
		): void;
		...
		public setOnGroundWithKnownMovement(
			boolean0: boolean,
			vec31: $Vec3$$Type
		): void;
		...
		public spawnAtLocation(
			itemLike0: $ItemLike$$Type,
			int1: integer
		): $ItemEntity;
		public spawnAtLocation(
			itemStack0: $ItemStack$$Type,
		...
		public syncPacketPositionCodec(
			double0: double,
			double1: double,
			double2: double
		): void;
		public teleportRelative(
			double0: double,
			double1: double,
			double2: double
		): void;
		...
		public teleportTo(
			...
			double2: double,
			double3: double,
			set4: $Set$$Type<$RelativeMovement$$Type>,
			float5: float,
			float6: float
		): boolean;
		public teleportTo(
		...
		public thunderHit(
			serverLevel0: $ServerLevel$$Type,
			lightningBolt1: $LightningBolt$$Type
		): void;
		public tick(): void;
		...
		public unRide(): void;
		public updateDynamicGameEventListener(
			biConsumer0: $BiConsumer$$Type<
				$DynamicGameEventListener$$Type<any>,
				$ServerLevel$$Type
			>
		): void;
		/** @deprecated */
		public updateFluidHeightAndDoFluidPushing(): void;
		public updateFluidHeightAndDoFluidPushing(
			predicate0: $Predicate$$Type<$FluidState$$Type>
		): void;
		/** @deprecated */
		public updateFluidHeightAndDoFluidPushing(
			tagKey0: $TagKey$$Type<$Fluid$$Type>,
			double1: double
		): boolean;
...
declare module "packages/net/minecraft/world/entity/$Display$BillboardConstraints" {
	...
	export class $Display$BillboardConstraints
		extends $Enum<$Display$BillboardConstraints>
		implements $StringRepresentable
	{
