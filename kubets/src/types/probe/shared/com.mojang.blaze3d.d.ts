...
public "getX"(): integer
public "getY"(): integer
public "handler$gbg000$startQuartz"(windowEventHandler0: $WindowEventHandler$$Type, screenManager1: $ScreenManager$$Type, displayData2: $DisplayData$$Type, string3: string, string4: string, callbackInfo5: $CallbackInfo$$Type): void
