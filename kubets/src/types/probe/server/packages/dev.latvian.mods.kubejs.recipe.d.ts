...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $RecipeOptional$$Type<T> = ($RecipeOptional<T> | ((arg0: $RecipeSchemaType) => T));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
export type $RecipeComponentWithParent$$Type<T> = ($RecipeComponentWithParent<T> | (() => $RecipeComponent$$Type<T>));
/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
declare global {
...
import { DocumentedRecipes, DocumentedRecipes$$Type } from "packages/zzzank/probejs/generated/DocumentedRecipes"
...
public "handler$bmg000$injectRecipes"(recipeManager0: $RecipeManager$$Type, map1: $Map$$Type<any, any>, callbackInfo2: $CallbackInfo$$Type): void
