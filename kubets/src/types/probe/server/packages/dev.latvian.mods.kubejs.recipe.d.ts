...
declare module "packages/dev/latvian/mods/kubejs/recipe/$OutputReplacementTransformer$Replacement" {
	...
	export type $OutputReplacementTransformer$Replacement$$Type =
		$OutputReplacementTransformer$Replacement;
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $OutputReplacementTransformer$Replacement_ =
			$OutputReplacementTransformer$Replacement$$Type;
	}
}
...
declare module "packages/dev/latvian/mods/kubejs/recipe/$OutputReplacementTransformer" {
	...
	import { $OutputReplacement } from "packages/dev/latvian/mods/kubejs/recipe/$OutputReplacement";

	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $OutputReplacementTransformer$$Type =
		| $OutputReplacementTransformer
		| ((
				arg0: $RecipeKJS,
				arg1: $ReplacementMatch,
				arg2: $OutputReplacement,
				arg3: $OutputReplacement
		  ) => any);
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $OutputReplacementTransformer_ =
...
declare module "packages/dev/latvian/mods/kubejs/recipe/$RecipeSchemaRegistryEventJS" {
	...
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $RecipeSchemaRegistryEventJS_ =
			$RecipeSchemaRegistryEventJS$$Type;
	}
}

declare module "packages/dev/latvian/mods/kubejs/recipe/$InputReplacementTransformer" {
	import { $InputReplacement } from "packages/dev/latvian/mods/kubejs/recipe/$InputReplacement";
	import { $RecipeKJS } from "packages/dev/latvian/mods/kubejs/core/$RecipeKJS";
	import { $ReplacementMatch } from "packages/dev/latvian/mods/kubejs/recipe/$ReplacementMatch";

	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $InputReplacementTransformer$$Type =
		| $InputReplacementTransformer
		| ((
				arg0: $RecipeKJS,
				arg1: $ReplacementMatch,
				arg2: $InputReplacement,
				arg3: $InputReplacement
		  ) => any);
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $InputReplacementTransformer_ =
...
declare module "packages/dev/latvian/mods/kubejs/recipe/schema/minecraft/$ShapedRecipeSchema$ShapedRecipeJS" {
	export {}; // Mark the file as a module, do not remove unless there are other import/exports!
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $ShapedRecipeSchema$ShapedRecipeJS$$Type =
		$ShapedRecipeSchema$ShapedRecipeJS;
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $ShapedRecipeSchema$ShapedRecipeJS_ =
			$ShapedRecipeSchema$ShapedRecipeJS$$Type;
	}
}
...
declare module "packages/dev/latvian/mods/kubejs/recipe/ingredientaction/$CustomIngredientActionCallback" {
	...
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $CustomIngredientActionCallback$$Type =
		| $CustomIngredientActionCallback
		| ((
				arg0: $ItemStack,
				arg1: integer,
				arg2: $InventoryKJS
	...
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $CustomIngredientActionCallback_ =
			$CustomIngredientActionCallback$$Type;
	}
}
...
declare module "packages/dev/latvian/mods/kubejs/recipe/filter/$RecipeFilterParseEvent" {
	...
	import { $RecipeFilter } from "packages/dev/latvian/mods/kubejs/recipe/filter/$RecipeFilter";
	import { $Map } from "packages/java/util/$Map";

	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $RecipeFilterParseEvent$$Type =
		| $RecipeFilterParseEvent
		| ((
				arg0: $Context,
				arg1: $List<$RecipeFilter>,
				arg2: $Map<any, any>
		  ) => void);
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
...
declare module "packages/dev/latvian/mods/kubejs/recipe/filter/$RecipeFilter" {
	...
	export type $RecipeFilter$$Type =
		...
		| $RecipeFilter$$Type[]
		| {
				"or?": $RecipeFilter$$Type;
				"not?": $RecipeFilter$$Type;
				"id?": Special.RecipeId;
				"type?": Special.RecipeType;
				"group?": string;
				"mod?": Special.Mod;
				"input?": $InputItem$$Type;
				"output?": $OutputItem$$Type;
		  }
...
declare module "packages/dev/latvian/mods/kubejs/recipe/ingredientaction/$IngredientActionFilter" {
	...
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $IngredientActionFilter$$Type =
		| $IngredientActionFilter
		| integer
		| $Ingredient$$Type
		| { "item?": $Ingredient$$Type; "index?": integer };
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
...
declare module "packages/dev/latvian/mods/kubejs/recipe/$ReplacementMatch" {
	export {}; // Mark the file as a module, do not remove unless there are other import/exports!
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $ReplacementMatch$$Type = $ReplacementMatch;
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
...
declare module "packages/dev/latvian/mods/kubejs/recipe/component/$ComponentRole" {
	export {}; // Mark the file as a module, do not remove unless there are other import/exports!
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $ComponentRole$$Type =
		| $ComponentRole
		| ("input" | "output" | "other");
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
...
declare module "packages/dev/latvian/mods/kubejs/recipe/$ModifyRecipeResultCallback" {
	import { $ModifyRecipeCraftingGrid } from "packages/dev/latvian/mods/kubejs/recipe/$ModifyRecipeCraftingGrid";
	import {
		$ItemStack,
		$ItemStack$$Type,
	} from "packages/net/minecraft/world/item/$ItemStack";
	...
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $ModifyRecipeResultCallback$$Type =
		| $ModifyRecipeResultCallback
		| ((arg0: $ModifyRecipeCraftingGrid, arg1: $ItemStack) => $ItemStack$$Type);
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $ModifyRecipeResultCallback_ =
...
declare module "packages/dev/latvian/mods/kubejs/recipe/schema/$RecipeOptional" {
	import { $RecipeSchemaType } from "packages/dev/latvian/mods/kubejs/recipe/schema/$RecipeSchemaType";

	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $RecipeOptional$$Type<T> =
		| $RecipeOptional<T>
...
declare module "packages/dev/latvian/mods/kubejs/recipe/component/$SimpleMappingRecipeComponent" {
	export {}; // Mark the file as a module, do not remove unless there are other import/exports!
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $SimpleMappingRecipeComponent$$Type<T> =
		$SimpleMappingRecipeComponent<T>;
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $SimpleMappingRecipeComponent_<T> =
			$SimpleMappingRecipeComponent$$Type<T>;
	}
}

declare module "packages/dev/latvian/mods/kubejs/recipe/component/$RecipeComponentWithParent" {
	import { $RecipeComponent$$Type } from "packages/dev/latvian/mods/kubejs/recipe/component/$RecipeComponent";

	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $RecipeComponentWithParent$$Type<T> =
		| $RecipeComponentWithParent<T>
		| (() => $RecipeComponent$$Type<T>);
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $RecipeComponentWithParent_<T> =
			$RecipeComponentWithParent$$Type<T>;
	}
}
...
declare module "packages/dev/latvian/mods/kubejs/recipe/$RecipesEventJS" {
	...
	import { $RecipeTypeFunction } from "packages/dev/latvian/mods/kubejs/recipe/$RecipeTypeFunction";
	...
	import {
		$RecipeFilter,
		$RecipeFilter$$Type,
	} from "packages/dev/latvian/mods/kubejs/recipe/filter/$RecipeFilter";
	import { $Stream } from "packages/java/util/stream/$Stream";
	import {
		DocumentedRecipes,
		DocumentedRecipes$$Type,
	} from "packages/zzzank/probejs/generated/DocumentedRecipes";
	...
	export class $RecipesEventJS extends $EventJS {
		...
		public custom(
			json: {
				...
				[x: string]: any;
			} /* other recipe json elements are unknown to ProbeJS :( */
		): $RecipeJS;
		public customFilter(
			filter: $Predicate$$Type<$RecipeKJS$$Type>
		): $RecipeFilter;
		public findRecipeIds(
		...
		public forEachRecipe(
			filter: $RecipeFilter$$Type,
			consumer: $Consumer$$Type<$RecipeJS$$Type>
		): void;
		public getRecipeFunction(id: string): $RecipeTypeFunction;
		public getRecipes(): DocumentedRecipes;
		public handler$bmg000$injectRecipes(
			recipeManager0: $RecipeManager$$Type,
			map1: $Map$$Type<any, any>,
		...
		public replaceInput(
			filter: $RecipeFilter$$Type,
			match: $ReplacementMatch$$Type | OmniString,
			with_: $InputReplacement$$Type | OmniString
		): void;
...
declare module "packages/dev/latvian/mods/kubejs/recipe/$InputReplacementTransformer$Replacement" {
	export {}; // Mark the file as a module, do not remove unless there are other import/exports!
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $InputReplacementTransformer$Replacement$$Type =
		$InputReplacementTransformer$Replacement;
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $InputReplacementTransformer$Replacement_ =
			$InputReplacementTransformer$Replacement$$Type;
	}
}
...
declare module "packages/dev/latvian/mods/kubejs/recipe/schema/$RecipeComponentFactory" {
	...
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $RecipeComponentFactory$$Type =
		| $RecipeComponentFactory
		| ((
				arg0: $Context,
				arg1: $Scriptable,
				arg2: $Map<string, any>
		  ) => $RecipeComponent$$Type<any>);
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
...
declare module "packages/dev/latvian/mods/kubejs/recipe/schema/$RecipeConstructor$Factory" {
	import { $RecipeKey } from "packages/dev/latvian/mods/kubejs/recipe/$RecipeKey";
	import { $ComponentValueMap } from "packages/dev/latvian/mods/kubejs/recipe/component/$ComponentValueMap";
	import { $RecipeJS } from "packages/dev/latvian/mods/kubejs/recipe/$RecipeJS";
	import { $RecipeSchemaType } from "packages/dev/latvian/mods/kubejs/recipe/schema/$RecipeSchemaType";

	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $RecipeConstructor$Factory$$Type =
		| $RecipeConstructor$Factory
		| ((
				arg0: $RecipeJS,
				arg1: $RecipeSchemaType,
				arg2: $RecipeKey<any>[],
				arg3: $ComponentValueMap
		  ) => void);
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
...
declare module "packages/dev/latvian/mods/kubejs/recipe/schema/minecraft/$ShapelessRecipeSchema$ShapelessRecipeJS" {
	export {}; // Mark the file as a module, do not remove unless there are other import/exports!
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $ShapelessRecipeSchema$ShapelessRecipeJS$$Type =
		$ShapelessRecipeSchema$ShapelessRecipeJS;
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $ShapelessRecipeSchema$ShapelessRecipeJS_ =
			$ShapelessRecipeSchema$ShapelessRecipeJS$$Type;
	}
}
...
declare module "packages/dev/latvian/mods/kubejs/recipe/special/$SpecialRecipeSerializerManager" {
	export {}; // Mark the file as a module, do not remove unless there are other import/exports!
	/** Class-specific type exported by ProbeJS, use global `{Type}_` types for convenience unless there's a naming conflict. */
	export type $SpecialRecipeSerializerManager$$Type =
		$SpecialRecipeSerializerManager;
	/** Global type exported for convenience, use class-specific types if there's a naming conflict. */
	declare global {
		export type $SpecialRecipeSerializerManager_ =
			$SpecialRecipeSerializerManager$$Type;
	}
}
