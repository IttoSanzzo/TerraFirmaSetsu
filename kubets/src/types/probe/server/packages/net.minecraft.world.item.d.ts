...
public "handler$epn001$initializeClient"(consumer: $Consumer$$Type<any>, ci: $CallbackInfo$$Type): void
/** @deprecated */
...
public "modifyReturnValue$fea000$overrideOtherStackedOnMe"(boolean0: boolean, itemStack1: $ItemStack$$Type, itemStack2: $ItemStack$$Type, slot3: $Slot$$Type, clickAction4: $ClickAction$$Type, player5: $Player$$Type, slotAccess6: $SlotAccess$$Type): boolean
public "modifyReturnValue$fea000$overrideStackedOnOther"(boolean0: boolean, itemStack1: $ItemStack$$Type, slot2: $Slot$$Type, clickAction3: $ClickAction$$Type, player4: $Player$$Type): boolean
