...
function setRecipesSimplePlanes(event: $RecipesEventJS) {
	...
	event
		.shaped("2x simpleplanes:propeller", [" I ", "IMI", " I "], {
			I: "immersiveengineering:plate_iron",
			M: "rosia:motor",
		})
		.id("setsu:simpleplanes/propeller_high");
	event
		.shaped("simpleplanes:propeller", [" I ", "IMI", " I "], {
	...
	event
		.shaped("simpleplanes:plane_workbench", ["SIH", "LDL", "IBI"], {
			S: "#tfc:saws",
			I: "setsu:ingot/all_iron",
			H: "#tfc:metal/hammers",
			L: "#tfc:lumber",
	...
	event
		.shaped("simpleplanes:furnace_engine", ["ILB", "FSF", "III"], {
			I: "#setsu:ingot/all_iron",
			L: "minecraft:lever",
	...
	event
		.shaped("simpleplanes:liquid_engine", ["CLT", "PEP", "III"], {
	...
	event
		.shaped("simpleplanes:electric_engine", ["CBC", "EMA", "III"], {
			C: "immersiveengineering:plate_copper",
	...
	event
		.shaped("simpleplanes:armor", ["PIP", "IPI"], {
	...
	event.recipes.tfc
		.anvil("simpleplanes:wrench", "tfc:metal/ingot/wrought_iron", [
			"hit_last",
			"draw_second_last",
			"draw_third_last",
		])
		.tier(3)
		.id("setsu:simpleplanes/wrench");
}
