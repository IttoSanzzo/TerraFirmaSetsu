...
export function setRecipesOreWashing(event: $RecipesEventJS) {
				...
				sequence: [
					{
						...
						ingredients: [{ item: "tfc:rock/loose/andesite" }],
						results: [{ item: "tfc:rock/loose/andesite" }],
					},
					{
						type: "create:pressing",
						ingredients: [{ item: "tfc:rock/loose/andesite" }],
					...
					},
					{
						type: "create:pressing",
						ingredients: [{ item: "tfc:rock/loose/andesite" }],
						results: [{ item: `tfcorewashing:chunks_${rocky}` }],
					},
				],
				results: [
					{
	...
	newWashAllMechaBlock(
		"immersiveengineering:raw_block_",
		"uranium",
		"uraninite"
	);
	newWashAllMechaBlock(
