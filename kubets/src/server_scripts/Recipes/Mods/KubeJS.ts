...
export function setRecipesKubeJS(event: $RecipesEventJS) {
	...
	// event.recipes.tfc
	// 	.heating("kubejs:metal/ingot/purple_steel", 1549)
	// 	.resultFluid(Fluid.of("kubejs:metal/purple_steel", 100))
	// 	.id("setsu:metal/purple_steel_fluid/from_ingot");
	// event.recipes.tfc
	// 	.heating("kubejs:metal/double_ingot/purple_steel", 1549)
	// 	.resultFluid(Fluid.of("kubejs:metal/purple_steel", 200))
	...
	// 		6
	// 	)
	// 	.id("setsu:metal/double_ingot/purple_steel");
	// event.recipes.tfc
	// 	.casting(
	...
	// 		0.1
	// 	)
	// 	.id("setsu:casting/high_carbon_purple_steel_ingot");
	// event.recipes.tfc
	// 	.casting(
	// 		"kubejs:metal/ingot/high_carbon_purple_steel",
	...
	// 		0.0
	// 	)
	// 	.id("setsu:casting/high_carbon_purple_steel_fire_ingot");
	// event.recipes.tfc
	// 	.casting(
	// 		"kubejs:metal/ingot/purple_steel",
	// 		"tfc:ceramic/ingot_mold",
	...
	// 		0.1
	// 	)
	// 	.id("setsu:casting/purple_steel_ingot");
	// event.recipes.tfc
	// 	.casting(
	// 		"kubejs:metal/ingot/purple_steel",
	// 		"tfc:ceramic/fire_ingot_mold",
	...
	// 		0.0
	// 	)
	// 	.id("setsu:casting/purple_steel_fire_ingot");
	// event.recipes.tfc
	// 	.alloy("kubejs:metal/high_carbon_purple_steel_metal", [
	...
	// event.recipes.tfc
	// 	.blast_furnace(
	// 		Fluid.of("kubejs:metal/purple_steel", 1),
	// 		"tfc:powder/graphite",
	// 		Fluid.of("kubejs:metal/high_carbon_purple_steel", 1)
	// 	)
	// 	.id("setsu:blast_furnace/purple_steel");
	// event
