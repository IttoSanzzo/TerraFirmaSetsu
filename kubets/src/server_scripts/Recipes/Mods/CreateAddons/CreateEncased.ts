...
export function setRecipesCreateEncased(event: $RecipesEventJS) {
	...
	reCreateShaft.forEach((type) => {
		...
		event
			.shaped(`3x createcasing:${type}_shaft`, ["L ", "LW", "L "], {
				W: "firmalife:beeswax",
				L: `#tfc:lumber`,
			})
		...
		event
			.shapeless(`createcasing:${type}_cogwheel`, [
		...
		event
			.shapeless(`createcasing:${type}_large_cogwheel`, [
				"create:andesite_alloy",
	...
	event
		.shaped(`3x createcasing:spruce_shaft`, ["L ", "LW", "L "], {
			W: "firmalife:beeswax",
			L: `#tfc:lumber`,
		})
	...
	event
		.shaped(`6x createcasing:glass_shaft`, ["L ", "LW", "L "], {
			W: "firmalife:beeswax",
	...
	event
		.shaped(`4x createcasing:brass_shaft`, ["L ", "MW", "L "], {
			W: "firmalife:beeswax",
	...
	const reCasingPress = ["brass", "copper", "railway"];
