...
export function setRecipesFunctionalStorage(event: $RecipesEventJS) {
	...
	ItemCol.tfcWoodTypes.forEach((wood) => {
		...
		event
			.shaped(`functionalstorage:tfc_${wood}_1`, ["SSS", "NCN", "SSS"], {
		...
		event
			.shaped(`functionalstorage:tfc_${wood}_2`, ["SCS", "NSN", "SCS"], {
				N: "kubejs:bismuth_bronze_nugget",
				C: "#balm:wooden_chests",
				S: `tfc:wood/lumber/${wood}`,
			})
		...
		event
			.shaped(`functionalstorage:tfc_${wood}_4`, ["CSC", "NSN", "CSC"], {
				N: "kubejs:bismuth_bronze_nugget",
				C: "#balm:wooden_chests",
				S: `tfc:wood/lumber/${wood}`,
			})
	...
	event
		.shaped(`functionalstorage:framed_2`, ["NCN", "NNN", "NCN"], {
			N: "kubejs:bismuth_bronze_nugget",
			C: "#balm:wooden_chests",
		})
	...
	event
		.shaped(`functionalstorage:framed_4`, ["CNC", "NNN", "CNC"], {
			N: "kubejs:bismuth_bronze_nugget",
			C: "#balm:wooden_chests",
		})
	...
	event
		.shaped(`functionalstorage:fluid_1`, ["NNN", "NCN", "NNN"], {
			N: "kubejs:bismuth_bronze_nugget",
			C: "minecraft:bucket",
		})
	...
	event
		.shaped(`functionalstorage:fluid_2`, ["NCN", "NNN", "NCN"], {
			N: "kubejs:bismuth_bronze_nugget",
			C: "minecraft:bucket",
		})
	...
	event
		.shaped(`functionalstorage:fluid_4`, ["CNC", "NNN", "CNC"], {
			N: "kubejs:bismuth_bronze_nugget",
			C: "minecraft:bucket",
		})
