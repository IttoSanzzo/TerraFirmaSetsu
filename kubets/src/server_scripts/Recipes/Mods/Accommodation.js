...
function setRecipesAccommodation(event) {
	...
	event.shaped("accommodation_:shide", ["S S", "PSP", " P "], {
		P: "minecraft:paper",
		S: "#forge:string"
	}).id("setsu:accommodation_/shide");

	event.replaceInput({ id: "accommodation_:tea_set_recipe" }, "minecraft:potion", "tfc:empty_jar");
	event.replaceInput({ mod: "accommodation_" }, "minecraft:deepslate_tile_slab", "#setsu:tfc/cobblestone_slab");
	event.replaceInput({ mod: "accommodation_" }, "minecraft:deepslate_tile_slab", "#setsu:tfc/cobblestone_slab");
	[
		"oak",
		"birch",
		...
		event.replaceInput({ mod: "accommodation_" }, `minecraft:${wood}_slab`, "#minecraft:wooden_slabs");
	...
	event.shaped("accommodation_:shinai", ["SC ", "SC ", " I "], {
		S: "#forge:string",
		C: "farmersdelight:canvas",
		I: "tfc:metal/ingot/wrought_iron"
	}).id("setsu:accommodation_/shinai");

	event.shaped("6x accommodation_:shoji", ["LLL", "PPP", "LLL"], {
		L: "#tfc:lumber",
		P: "minecraft:paper"
	}).id("setsu:accommodation_/shoji");
	event.shaped("6x accommodation_:shoji_bottom", ["LLL", "PPP", "SSS"], {
		L: "#tfc:lumber",
		P: "minecraft:paper",
		S: "#minecraft:wooden_slabs"
	}).id("setsu:accommodation_/shoji_bottom");
	event.shaped("8x accommodation_:shoji_middle", ["LPL", "PPP", "LLL"], {
		L: "#tfc:lumber",
		P: "minecraft:paper"
	...
	function shojiWall(vanilla, tfc) {
		tfc.forEach((lumber) => {
			...
			event.shaped(`6x accommodation_:${vanilla}_shoji`, ["LLL", "PPP", "LLL"], {
				L: lumber,
				P: "minecraft:paper"
			}).id(`setsu:accommodation_/shoji/${id}`);
			event.shaped(`6x accommodation_:${vanilla}_shoji_bottom`, ["LLL", "PPP", "SSS"], {
				L: lumber,
				P: "minecraft:paper",
				S: "#minecraft:wooden_slabs"
			}).id(`setsu:accommodation_/shoji_bottom/${id}`);
			event.shaped(`8x accommodation_:${vanilla}_shoji_middle`, ["LPL", "PPP", "LLL"], {
				L: lumber,
				P: "minecraft:paper"
	...
	[
		...
		let lumberString = String(lumber);
		let id = lumberString.substring(lumberString.search("lumber/") + 7);
		event.shaped(`6x accommodation_:spruce_shoji`, ["LLL", "PPP", "LLL"], {
			L: lumber,
			P: "minecraft:paper"
		}).id(`setsu:accommodation_/shoji/${id}`);
		event.shaped(`6x accommodation_:spruce_shoji_bottom`, ["LLL", "PPP", "SSS"], {
			L: lumber,
			P: "minecraft:paper",
			S: "#minecraft:wooden_slabs"
		}).id(`setsu:accommodation_/shoji_bottom/${id}`);
		event.shaped(`8x accommodation_:spurce_shoji_middle`, ["LPL", "PPP", "LLL"], {
			L: lumber,
			P: "minecraft:paper"
		}).id(`setsu:accommodation_/shoji_middle/${String(id).substring()}`);
	})
