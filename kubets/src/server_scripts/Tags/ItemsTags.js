...
const setItemTags = (event) => {
	console.log("Setsu Tag Item Start!");
	// Metals & Mineral ////////////////////////////////////

	event.add("forge:ingots", ["kubejs:metal/ingot/purple_steel", "kubejs:metal/ingot/high_carbon_purple_steel"]);
	event.add("forge:double_ingots", "kubejs:metal/double_ingot/purple_steel");

	event.remove("forge:ingots/steel", ["immersiveengineering:ingot_steel", "ad_astra:steel_ingot"]);
	event.remove("c:steel_ingots", ["immersiveengineering:ingot_steel", "ad_astra:steel_ingot"]);
	event.remove("ad_astra:steel_ingots", ["immersiveengineering:ingot_steel", "ad_astra:steel_ingot"]);

	event.add("forge:ores", "#tfc:ore_pieces");
	event.add("setsu:ingot/all_iron", ["tfc:metal/ingot/wrought_iron", "tfc:metal/ingot/cast_iron"]);
	event.add("setsu:rod/all_iron", ["tfc:metal/rod/wrought_iron", "tfc:metal/rod/cast_iron"]);
	...
	event.add("forge:honeycombs", [
		"minecraft:honeycomb",
		"firmalife:raw_honey"
	])

	event.add("forge:seapickles", [
	...
	event.add("forge:cokesourcez", ["minecraft:coal", "tfc:ore/lignite", "tfc:ore/bituminous_coal"]);
	...
	event.get("apotheosis:boon_drops").removeAll()
		.add("#tfc:ore_pieces")
	...
	event.add("tfc:all_natural_stone", [
		"#tfc:rock/hardened",
		"#tfc:rock/raw"
	]);
	event.add("tfc:all_stone", [
		"#tfc:all_natural_stone",
		"#tfc:rock/smooth"
	])
	...
	event.add("forge:blue_orchids", ["minecraft:blue_orchid", "tfc:plant/blue_orchid"]);
	event.add("forge:allium", ["minecraft:allium", "tfc:plant/allium"]);
	event.add("forge:oxeye_daisy", ["minecraft:oxeye_daisy", "tfc:plant/oxeye_daisy"]);
	event.add("forge:orange_tulip", ["minecraft:orange_tulip", "tfc:plant/tulip_orange"]);
	event.add("forge:pink_tulip", ["minecraft:pink_tulip", "tfc:plant/tulip_pink"]);
	event.add("forge:white_tulip", ["minecraft:white_tulip", "tfc:plant/tulip_white"]);
	...
	event.add("forge:black_dye_material", ["minecraft:wither_rose", "minecraft:ink_sac"]);

	// Wood //////////////////////////////////////////////

	event.add("forge:treated_lumber", ["firmalife:treated_lumber", "#forge:treated_wood", "tfc_ie_addon:treated_wood_lumber"]);
	event.add("forge:treated_lumber",);
	event.add("setsu:treated_lumber", ["firmalife:treated_lumber", "tfc_ie_addon:treated_wood_lumber"]);
	...
	function newSetsuWoodTag(vanilla, tfc) {
		tfc.forEach((tfcWood) => {
			event.add(`setsu:tfc/vanilla_${vanilla}_lumber`, `tfc:wood/lumber/${tfcWood}`);
			event.add(`setsu:tfc/vanilla_${vanilla}_planks`, `tfc:wood/planks/${tfcWood}`);
			event.add(`setsu:tfc/vanilla_${vanilla}_log`, `tfc:wood/log/${tfcWood}`);
			event.add(`setsu:tfc/vanilla_${vanilla}_stripped_log`, `tfc:wood/stripped_log/${tfcWood}`);
			event.add(`setsu:tfc/vanilla_${vanilla}_stripped_wood`, `tfc:wood/stripped_wood/${tfcWood}`);
			event.add(`setsu:tfc/vanilla_${vanilla}_slab`, `tfc:wood/planks/${tfcWood}_slab`);
			event.add(`setsu:tfc/vanilla_${vanilla}_door`, `tfc:wood/planks/${tfcWood}_door`);
			event.add(`setsu:tfc/vanilla_${vanilla}_trapdoor`, `tfc:wood/planks/${tfcWood}_trapdoor`);
		})
	}
	...
	function chippedWoodTagAdd(type) {
		...
		event.add(`chipped:stripped_${type}_log`, [`#setsu:tfc/vanilla_${type}_stripped_log`]);
		event.add(`chipped:${type}_trapdoor`, [`#setsu:tfc/vanilla_${type}_trapdoor`]);
