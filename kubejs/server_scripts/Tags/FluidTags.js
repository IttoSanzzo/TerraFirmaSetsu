...
const setFluidTags = (event) => {
	...
	event.add("tfc:usable_in_ingot_mold", ["kubejs:metal/purple_steel", "kubejs:metal/high_carbon_purple_steel"]);
	event.add("tfc:usable_in_tool_head_mold", ["kubejs:metal/purple_steel", "kubejs:metal/high_carbon_purple_steel"]);
