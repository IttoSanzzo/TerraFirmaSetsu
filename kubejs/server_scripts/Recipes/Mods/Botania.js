...
function setRecipesBotania(event) {
	...
	event.shaped("botania:crafting_halo", [" R ", "MCM", " M "], {
	...
	event.shapeless("botania:redstone_root", ["minecraft:redstone", "#tfc:twigs"]).id("setsu:botania/redstone_twig");
