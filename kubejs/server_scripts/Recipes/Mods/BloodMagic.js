...
function setRecipesBloodMagic(event) {
	event.remove({ id: "bloodmagic:alchemicalreactionchamber" });
	event.shaped("bloodmagic:alchemicalreactionchamber", ["SSS", "IOI", "BFB"], {
		S: "#forge:stone",
	...
	event.shaped("bloodmagic:altar", ["S S", "SFS", "GGG"], {
		S: "#forge:stone",
		F: "tfc:crucible",
		G: "#forge:ingots/gold"
	}).id("setsu:bloodmagic/altar");

	event.replaceOutput({ mod: "bloodmagic" }, "minecraft:leather", "tfc:small_raw_hide");
