...
function setRecipesCreateStuffAndAdditions(event) {
	/**
	 * Removes
	 */
	const blazRose = [
	...
	event.shaped("create_sa:copper_magnet", ["M M", " R "], {
		M: "#tfc:magnetic_rocks",
		R: "tfc:metal/ingot/copper",
	}).id("setsu:create_sa/copper_magnet");
	event.replaceInput({ id: "create_sa:brass_drill_head_recipe" }, "create_sa:brass_pickaxe", "#immersiveengineering:drillheads");
	...
	event.shaped("create_sa:steam_engine", ["XEP", "LBL", "OSI"], {
	...
	event.shaped("create_sa:heat_engine", [" EP", "OAO", "OSI"], {
		P: "create:precision_mechanism",
		E: "#forge:electron_tube",
		O: "create:andesite_alloy",
	...
	event.shaped("create_sa:hydraulic_engine", [" EP", "LCL", "OSI"], {
		P: "create:precision_mechanism",
		E: "#forge:electron_tube",
