...
function setRecipesTomsStorage(event) {
	// Key Items ///////////////////////////////////////////

	event.remove({ output: "toms_storage:ts.inventory_connector" });
	event.shaped("toms_storage:ts.inventory_connector", ["BNB", "CTC", "BEB"], {
	...
	event.shaped("toms_storage:ts.storage_terminal", ["LPL", "SDS", "LBL"], {
	...
	event.shaped("toms_storage:ts.crafting_terminal", ["HBH", "HTH", "HCH"], {
	...
	event.shaped("3x toms_storage:ts.trim", ["NLN", "LCL", "NLN"], {
		L: "#setsu:treated_lumber",
	...
	event.shaped("6x toms_storage:ts.inventory_cable", ["ACA"], {
		A: "create:shaft",
		C: "#forge:chests/wooden",
	...
	event.shaped("toms_storage:ts.paint_kit", ["RGB", "AXL", "W  "], {
		X: "create:super_glue",
		L: "tfc:wool_cloth",
		R: "minecraft:red_dye",
	...
	event.shaped("toms_storage:ts.wireless_terminal", ["LCL", "SGP", "LBL"], {
		L: "#setsu:treated_lumber",
		C: "create:linked_controller",
	...
	event.shaped("toms_storage:ts.adv_wireless_terminal", ["TP", "BR"], {
