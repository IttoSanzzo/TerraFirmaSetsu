...
function setRecipesApotheosis(event) {
	...
	event.shaped("apotheosis:salvaging_table", ["CCC", "PSA", "DBD"], {
	...
	event.shaped("apotheosis:library", ["CVC", "VBV", "CVC"], {
	...
	event.shaped("apotheosis:reforging_table", [" N ", "DED", "BBB"], {
	...
	event.shaped("apotheosis:scrap_tome", ["BBB", "BAB", "BBB"], {
	...
	event.shapeless("minecraft:honeycomb_block",
		["9x firmalife:raw_honey"]
	).id("setsu:apotheosis/honeycomb_block_from_raw_honey");

	event.remove({ id: "apotheosis:melonshelf" });
	event.shaped("apotheosis:melonshelf", ["MMM", "SBS", "MMM"], {
		M: "#forge:melon",
		B: "#forge:bookshelves",
	...
	event.shaped("apotheosis:beeshelf", ["CVC", "HBH", "CVC"], {
	...
	event.replaceInput({ mod: "apotheosis" }, "minecraft:nautilus_shell", "firmalife:hollow_shell");
}
